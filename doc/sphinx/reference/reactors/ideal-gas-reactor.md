...
$\pi_T \equiv (\partial U / \partial V)_{T,m_k}$ is the internal pressure and
$(\partial U / \partial m_k)_{T,V,m_{j\ne k}} = \tilde{u}_k /W_k $ where $\tilde{u}_k$
are the partial molar internal energies at constant temperature and volume. This gives:
