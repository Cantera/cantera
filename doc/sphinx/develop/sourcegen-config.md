...
The folder `interfaces/sourcegen/sourcegen/headers` holds YAML configuration data for
...
The CLib header generator is located in the `interfaces/sourcegen/sourcegen/headers`
folder.
...
- **Type Cross-Walks:** These fields map C++ types to their CLib equivalents.
