...
KIN_SPARSE(fwdRopSpeciesDerivatives)
KIN_SPARSE(revRopSpeciesDerivatives)
KIN_SPARSE(netRopSpeciesDerivatives)

KIN_MAPPED(fwdRopTemperatureDerivatives)
KIN_MAPPED(revRopTemperatureDerivatives)
KIN_MAPPED(netRopTemperatureDerivatives)
...
KIN_SPARSE(creationRateSpeciesDerivatives)
KIN_SPARSE(destructionRateSpeciesDerivatives)
KIN_SPARSE(netProductionRateSpeciesDerivatives)

KIN_MAPPED(creationRateTemperatureDerivatives)
KIN_MAPPED(destructionRateTemperatureDerivatives)
KIN_MAPPED(netProductionRateTemperatureDerivatives)
