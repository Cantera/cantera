...
extern "C" {
    ...
    CANTERA_CAPI int mix_nElements(int i);
    CANTERA_CAPI int mix_elementIndex(int i, const char* name);
    CANTERA_CAPI int mix_speciesIndex(int i, int k, int p);
    CANTERA_CAPI int mix_nSpecies(int i);
    ...
    CANTERA_CAPI int mix_getChemPotentials(int i, int lenmu, double* mu);
    ...
    CANTERA_CAPI int mix_speciesPhaseIndex(int i, int k);
