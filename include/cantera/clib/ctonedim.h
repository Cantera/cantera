...
extern "C" {
    ...
    CANTERA_CAPI int domain_type(int i, int lennm, char* nm);
    CANTERA_CAPI int domain_index(int i);
    CANTERA_CAPI int domain_nComponents(int i);
    CANTERA_CAPI int domain_nPoints(int i);
    CANTERA_CAPI int domain_componentName(int i, int n, int sz, char* nameout);
    CANTERA_CAPI int domain_componentIndex(int i, const char* name);
    ...
    CANTERA_CAPI int domain_setupGrid(int i, int npts, const double* grid);
    ...
    CANTERA_CAPI int flow1D_setFixedTempProfile(int i, int n, const double* pos,
                                                int m, const double* temp);
    CANTERA_CAPI int flow1D_solveEnergyEqn(int i, int flag);

    CANTERA_CAPI int sim1D_new(int nd, const int* domains);
    CANTERA_CAPI int sim1D_del(int i);
    CANTERA_CAPI int sim1D_setValue(int i, int dom, int comp, int localPoint,
                                    double value);
    ...
    CANTERA_CAPI int sim1D_setTimeStep(int i, double stepsize,
                                       int ns, const int* nsteps);
