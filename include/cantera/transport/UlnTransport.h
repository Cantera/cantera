/**
 *  @file UlnTransport.h
 *    Headers for the UlnTransport object, which models transport properties
 *    in ideal gas solutions using a mixture averaged approximation
 *    (see \ref tranprops and \link Cantera::UlnTransport UlnTransport \endlink) .
 */
...
namespace Cantera
{
//! Class UlnTransport implements mixture-averaged transport properties for
//! ideal gas mixtures.
/*!
 ...
 * @ingroup tranprops
 */
class UlnTransport : public GasTransport
{
public:
    //! Default constructor.
    UlnTransport();

    UlnTransport(const UlnTransport& right);
    UlnTransport& operator=(const UlnTransport& right);
    ...
    virtual int model() const {
        warn_deprecated("UlnTransport::model",
