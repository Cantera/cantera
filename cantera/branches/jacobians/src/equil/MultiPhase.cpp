...
//====================================================================================================================
void MultiPhase::
addPhases(std::vector<thermo_t *>& phases, const vector_fp& phaseMoles)
{
...
//====================================================================================================================
void MultiPhase::
addPhase(thermo_t* p, doublereal moles)
{
    if (m_init) {
...
// mixture object.
thermo_t& MultiPhase::phase(size_t n)
{
    if (!m_init) {
        init();
    }
...
{
    const thermo_t* tptr = m_phase[iph];
    return tptr->id();
}
//====================================================================================================================
