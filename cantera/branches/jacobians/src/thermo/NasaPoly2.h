...
public:
     ...
     */
    NasaPoly2(const NasaPoly2<ValAndDerivType>& b) :
            m_lowT(b.m_lowT),
            m_midT(b.m_midT),
            m_highT(b.m_highT),
            m_Pref(b.m_Pref),
    ...
    NasaPoly2(const NasaPoly2<ValAndDerivType2>& b) :
            m_lowT(b.m_lowT),
            m_midT(b.m_midT),
            m_highT(b.m_highT),
            m_Pref(b.m_Pref),
     ...
     * @param b object to be copied.
     */
    NasaPoly2<ValAndDerivType>& operator=(const NasaPoly2<ValAndDerivType>& b)
    {
        if (&b != this) {
            m_lowT = b.m_lowT;
            m_midT = b.m_midT;
    ...
    {
        NasaPoly2<doublereal>* np = new NasaPoly2<doublereal>(*this);
...
protected:
    ...
    friend class NasaPoly2<doublereal> ;
    friend class NasaPoly2<doubleFAD> ;
