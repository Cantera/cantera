...
void printBulk(ostream& oooo,thermo_t_double* bulkPhaseTP, InterfaceKinetics* iKin_ptr, double* src)
{
    double x[MSSIZE];
    double C[MSSIZE];
    char buf[256];
...
void printSurf(ostream& oooo, thermo_t_double* surfPhaseTP,
