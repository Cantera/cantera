...
-  Please be considerate posting content generated by AI models. Make sure that the
  content is valuable, concise, and expresses the message you want to share.
...
the project. To preserve core developer capacity, we reserve the right to reject
