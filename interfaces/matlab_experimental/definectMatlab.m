...
"Description", "clib.ctMatlab.LogCallback    C++ function type LogCallback.");
...
"Description", "clib.ctMatlab.LogLevel    Representation of C++ enumeration LogLevel.");
...
"Description", "clib.ctMatlab.ct_appdelete Representation of C++ function ct_appdelete.");
...
"Description", "clib.ctMatlab.soln_newSolution Representation of C++ function soln_newSolution.");
...
"Description", "clib.ctMatlab.soln_newInterface Representation of C++ function soln_newInterface.");
...
defineArgument(soln_newInterfaceDefinition, "adjacent", "clib.array.ctMatlab.Int", "input", "na");
...
"Description", "clib.ctMatlab.soln_name Representation of C++ function soln_name.");
defineArgument(soln_nameDefinition, "n", "int32");
defineArgument(soln_nameDefinition, "buflen", "int32");
defineArgument(soln_nameDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "buflen");
...
"Description", "clib.ctMatlab.soln_thermo Representation of C++ function soln_thermo.");
...
"Description", "clib.ctMatlab.soln_kinetics Representation of C++ function soln_kinetics.");
...
"Description", "clib.ctMatlab.soln_transport Representation of C++ function soln_transport.");
...
"Description", "clib.ctMatlab.soln_setTransportModel Representation of C++ function soln_setTransportModel.");
...
"Description", "clib.ctMatlab.soln_nAdjacent Representation of C++ function soln_nAdjacent.");
...
"Description", "clib.ctMatlab.soln_adjacent Representation of C++ function soln_adjacent.");
...
"Description", "clib.ctMatlab.soln_adjacentName Representation of C++ function soln_adjacentName.");
...
defineArgument(soln_adjacentNameDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.thermo_parent Representation of C++ function thermo_parent.");
...
"Description", "clib.ctMatlab.thermo_size Representation of C++ function thermo_size.");
...
"Description", "clib.ctMatlab.thermo_nElements Representation of C++ function thermo_nElements.");
...
"Description", "clib.ctMatlab.thermo_nSpecies Representation of C++ function thermo_nSpecies.");
...
"Description", "clib.ctMatlab.thermo_temperature Representation of C++ function thermo_temperature.");
...
"Description", "clib.ctMatlab.thermo_setTemperature Representation of C++ function thermo_setTemperature.");
...
"Description", "clib.ctMatlab.thermo_density Representation of C++ function thermo_density.");
...
"Description", "clib.ctMatlab.thermo_setDensity Representation of C++ function thermo_setDensity.");
...
"Description", "clib.ctMatlab.thermo_molarDensity Representation of C++ function thermo_molarDensity.");
...
"Description", "clib.ctMatlab.thermo_meanMolecularWeight Representation of C++ function thermo_meanMolecularWeight.");
...
"Description", "clib.ctMatlab.thermo_moleFraction Representation of C++ function thermo_moleFraction.");
...
"Description", "clib.ctMatlab.thermo_massFraction Representation of C++ function thermo_massFraction.");
...
"Description", "clib.ctMatlab.thermo_getMoleFractions Representation of C++ function thermo_getMoleFractions.");
defineArgument(thermo_getMoleFractionsDefinition, "n", "int32");
defineArgument(thermo_getMoleFractionsDefinition, "lenx", "uint64");
defineArgument(thermo_getMoleFractionsDefinition, "x", "double", "output", "lenx");
...
"Description", "clib.ctMatlab.thermo_getMassFractions Representation of C++ function thermo_getMassFractions.");
defineArgument(thermo_getMassFractionsDefinition, "n", "int32");
defineArgument(thermo_getMassFractionsDefinition, "leny", "uint64");
defineArgument(thermo_getMassFractionsDefinition, "y", "double", "output", "leny");
...
"Description", "clib.ctMatlab.thermo_setMoleFractions Representation of C++ function thermo_setMoleFractions.");
defineArgument(thermo_setMoleFractionsDefinition, "n", "int32");
defineArgument(thermo_setMoleFractionsDefinition, "lenx", "uint64");
defineArgument(thermo_setMoleFractionsDefinition, "x", "double", "input", "lenx");
...
"Description", "clib.ctMatlab.thermo_setMassFractions Representation of C++ function thermo_setMassFractions.");
defineArgument(thermo_setMassFractionsDefinition, "n", "int32");
defineArgument(thermo_setMassFractionsDefinition, "leny", "uint64");
defineArgument(thermo_setMassFractionsDefinition, "y", "double", "input", "leny");
...
"Description", "clib.ctMatlab.thermo_setMoleFractionsByName Representation of C++ function thermo_setMoleFractionsByName.");
...
"Description", "clib.ctMatlab.thermo_setMassFractionsByName Representation of C++ function thermo_setMassFractionsByName.");
...
"Description", "clib.ctMatlab.thermo_getAtomicWeights Representation of C++ function thermo_getAtomicWeights.");
defineArgument(thermo_getAtomicWeightsDefinition, "n", "int32");
defineArgument(thermo_getAtomicWeightsDefinition, "lenm", "uint64");
defineArgument(thermo_getAtomicWeightsDefinition, "atw", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getMolecularWeights Representation of C++ function thermo_getMolecularWeights.");
...
defineArgument(thermo_getMolecularWeightsDefinition, "mw", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getCharges Representation of C++ function thermo_getCharges.");
defineArgument(thermo_getChargesDefinition, "n", "int32");
defineArgument(thermo_getChargesDefinition, "lenm", "uint64");
defineArgument(thermo_getChargesDefinition, "sc", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getElementName Representation of C++ function thermo_getElementName.");
...
defineArgument(thermo_getElementNameDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.thermo_getSpeciesName Representation of C++ function thermo_getSpeciesName.");
...
defineArgument(thermo_getSpeciesNameDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.thermo_getName Representation of C++ function thermo_getName.");
defineArgument(thermo_getNameDefinition, "n", "int32");
defineArgument(thermo_getNameDefinition, "lennm", "uint64");
defineArgument(thermo_getNameDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.thermo_setName Representation of C++ function thermo_setName.");
...
"Description", "clib.ctMatlab.thermo_elementIndex Representation of C++ function thermo_elementIndex.");
...
"Description", "clib.ctMatlab.thermo_speciesIndex Representation of C++ function thermo_speciesIndex.");
...
"Description", "clib.ctMatlab.thermo_report Representation of C++ function thermo_report.");
...
defineArgument(thermo_reportDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "ibuf");
...
"Description", "clib.ctMatlab.thermo_print Representation of C++ function thermo_print.");
...
"Description", "clib.ctMatlab.thermo_nAtoms Representation of C++ function thermo_nAtoms.");
...
"Description", "clib.ctMatlab.thermo_addElement Representation of C++ function thermo_addElement.");
...
"Description", "clib.ctMatlab.thermo_getEosType Representation of C++ function thermo_getEosType.");
defineArgument(thermo_getEosTypeDefinition, "n", "int32");
defineArgument(thermo_getEosTypeDefinition, "leneos", "uint64");
defineArgument(thermo_getEosTypeDefinition, "eos", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "leneos");
...
"Description", "clib.ctMatlab.thermo_refPressure Representation of C++ function thermo_refPressure.");
...
"Description", "clib.ctMatlab.thermo_minTemp Representation of C++ function thermo_minTemp.");
...
"Description", "clib.ctMatlab.thermo_maxTemp Representation of C++ function thermo_maxTemp.");
...
"Description", "clib.ctMatlab.thermo_enthalpy_mole Representation of C++ function thermo_enthalpy_mole.");
...
"Description", "clib.ctMatlab.thermo_intEnergy_mole Representation of C++ function thermo_intEnergy_mole.");
...
"Description", "clib.ctMatlab.thermo_entropy_mole Representation of C++ function thermo_entropy_mole.");
...
"Description", "clib.ctMatlab.thermo_gibbs_mole Representation of C++ function thermo_gibbs_mole.");
...
"Description", "clib.ctMatlab.thermo_cp_mole Representation of C++ function thermo_cp_mole.");
...
"Description", "clib.ctMatlab.thermo_cv_mole Representation of C++ function thermo_cv_mole.");
...
"Description", "clib.ctMatlab.thermo_pressure Representation of C++ function thermo_pressure.");
...
"Description", "clib.ctMatlab.thermo_setPressure Representation of C++ function thermo_setPressure.");
...
"Description", "clib.ctMatlab.thermo_enthalpy_mass Representation of C++ function thermo_enthalpy_mass.");
...
"Description", "clib.ctMatlab.thermo_intEnergy_mass Representation of C++ function thermo_intEnergy_mass.");
...
"Description", "clib.ctMatlab.thermo_entropy_mass Representation of C++ function thermo_entropy_mass.");
...
"Description", "clib.ctMatlab.thermo_gibbs_mass Representation of C++ function thermo_gibbs_mass.");
...
"Description", "clib.ctMatlab.thermo_cp_mass Representation of C++ function thermo_cp_mass.");
...
"Description", "clib.ctMatlab.thermo_cv_mass Representation of C++ function thermo_cv_mass.");
...
"Description", "clib.ctMatlab.thermo_electricPotential Representation of C++ function thermo_electricPotential.");
...
"Description", "clib.ctMatlab.thermo_thermalExpansionCoeff Representation of C++ function thermo_thermalExpansionCoeff.");
...
"Description", "clib.ctMatlab.thermo_isothermalCompressibility Representation of C++ function thermo_isothermalCompressibility.");
...
"Description", "clib.ctMatlab.thermo_chemPotentials Representation of C++ function thermo_chemPotentials.");
defineArgument(thermo_chemPotentialsDefinition, "n", "int32");
defineArgument(thermo_chemPotentialsDefinition, "lenm", "uint64");
defineArgument(thermo_chemPotentialsDefinition, "murt", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_electrochemPotentials Representation of C++ function thermo_electrochemPotentials.");
...
defineArgument(thermo_electrochemPotentialsDefinition, "emu", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getEnthalpies_RT Representation of C++ function thermo_getEnthalpies_RT.");
defineArgument(thermo_getEnthalpies_RTDefinition, "n", "int32");
defineArgument(thermo_getEnthalpies_RTDefinition, "lenm", "uint64");
defineArgument(thermo_getEnthalpies_RTDefinition, "h_rt", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getEntropies_R Representation of C++ function thermo_getEntropies_R.");
defineArgument(thermo_getEntropies_RDefinition, "n", "int32");
defineArgument(thermo_getEntropies_RDefinition, "lenm", "uint64");
defineArgument(thermo_getEntropies_RDefinition, "s_r", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getCp_R Representation of C++ function thermo_getCp_R.");
defineArgument(thermo_getCp_RDefinition, "n", "int32");
defineArgument(thermo_getCp_RDefinition, "lenm", "uint64");
defineArgument(thermo_getCp_RDefinition, "cp_r", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_setElectricPotential Representation of C++ function thermo_setElectricPotential.");
...
"Description", "clib.ctMatlab.thermo_getPartialMolarEnthalpies Representation of C++ function thermo_getPartialMolarEnthalpies.");
...
defineArgument(thermo_getPartialMolarEnthalpiesDefinition, "pmh", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getPartialMolarEntropies Representation of C++ function thermo_getPartialMolarEntropies.");
...
defineArgument(thermo_getPartialMolarEntropiesDefinition, "pms", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getPartialMolarIntEnergies Representation of C++ function thermo_getPartialMolarIntEnergies.");
...
defineArgument(thermo_getPartialMolarIntEnergiesDefinition, "pmu", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getPartialMolarCp Representation of C++ function thermo_getPartialMolarCp.");
defineArgument(thermo_getPartialMolarCpDefinition, "n", "int32");
defineArgument(thermo_getPartialMolarCpDefinition, "lenm", "uint64");
defineArgument(thermo_getPartialMolarCpDefinition, "pmcp", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_getPartialMolarVolumes Representation of C++ function thermo_getPartialMolarVolumes.");
...
defineArgument(thermo_getPartialMolarVolumesDefinition, "pmv", "double", "output", "lenm");
...
"Description", "clib.ctMatlab.thermo_set_TP Representation of C++ function thermo_set_TP.");
defineArgument(thermo_set_TPDefinition, "n", "int32");
defineArgument(thermo_set_TPDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_TD Representation of C++ function thermo_set_TD.");
defineArgument(thermo_set_TDDefinition, "n", "int32");
defineArgument(thermo_set_TDDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_DP Representation of C++ function thermo_set_DP.");
defineArgument(thermo_set_DPDefinition, "n", "int32");
defineArgument(thermo_set_DPDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_HP Representation of C++ function thermo_set_HP.");
defineArgument(thermo_set_HPDefinition, "n", "int32");
defineArgument(thermo_set_HPDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_UV Representation of C++ function thermo_set_UV.");
defineArgument(thermo_set_UVDefinition, "n", "int32");
defineArgument(thermo_set_UVDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_SV Representation of C++ function thermo_set_SV.");
defineArgument(thermo_set_SVDefinition, "n", "int32");
defineArgument(thermo_set_SVDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_SP Representation of C++ function thermo_set_SP.");
defineArgument(thermo_set_SPDefinition, "n", "int32");
defineArgument(thermo_set_SPDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_ST Representation of C++ function thermo_set_ST.");
defineArgument(thermo_set_STDefinition, "n", "int32");
defineArgument(thermo_set_STDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_TV Representation of C++ function thermo_set_TV.");
defineArgument(thermo_set_TVDefinition, "n", "int32");
defineArgument(thermo_set_TVDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_PV Representation of C++ function thermo_set_PV.");
defineArgument(thermo_set_PVDefinition, "n", "int32");
defineArgument(thermo_set_PVDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_UP Representation of C++ function thermo_set_UP.");
defineArgument(thermo_set_UPDefinition, "n", "int32");
defineArgument(thermo_set_UPDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_VH Representation of C++ function thermo_set_VH.");
defineArgument(thermo_set_VHDefinition, "n", "int32");
defineArgument(thermo_set_VHDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_TH Representation of C++ function thermo_set_TH.");
defineArgument(thermo_set_THDefinition, "n", "int32");
defineArgument(thermo_set_THDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_set_SH Representation of C++ function thermo_set_SH.");
defineArgument(thermo_set_SHDefinition, "n", "int32");
defineArgument(thermo_set_SHDefinition, "vals", "double", "input", 2);
...
"Description", "clib.ctMatlab.thermo_equilibrate Representation of C++ function thermo_equilibrate.");
...
"Description", "clib.ctMatlab.thermo_critTemperature Representation of C++ function thermo_critTemperature.");
...
"Description", "clib.ctMatlab.thermo_critPressure Representation of C++ function thermo_critPressure.");
...
"Description", "clib.ctMatlab.thermo_critDensity Representation of C++ function thermo_critDensity.");
...
"Description", "clib.ctMatlab.thermo_vaporFraction Representation of C++ function thermo_vaporFraction.");
...
"Description", "clib.ctMatlab.thermo_satTemperature Representation of C++ function thermo_satTemperature.");
...
"Description", "clib.ctMatlab.thermo_satPressure Representation of C++ function thermo_satPressure.");
...
"Description", "clib.ctMatlab.thermo_setState_Psat Representation of C++ function thermo_setState_Psat.");
...
"Description", "clib.ctMatlab.thermo_setState_Tsat Representation of C++ function thermo_setState_Tsat.");
...
"Description", "clib.ctMatlab.kin_parent Representation of C++ function kin_parent.");
...
"Description", "clib.ctMatlab.kin_nSpecies Representation of C++ function kin_nSpecies.");
...
"Description", "clib.ctMatlab.kin_nReactions Representation of C++ function kin_nReactions.");
...
"Description", "clib.ctMatlab.kin_nPhases Representation of C++ function kin_nPhases.");
...
"Description", "clib.ctMatlab.kin_phaseIndex Representation of C++ function kin_phaseIndex.");
...
"Description", "clib.ctMatlab.kin_reactantStoichCoeff Representation of C++ function kin_reactantStoichCoeff.");
...
"Description", "clib.ctMatlab.kin_productStoichCoeff Representation of C++ function kin_productStoichCoeff.");
...
"Description", "clib.ctMatlab.kin_getReactionType Representation of C++ function kin_getReactionType.");
...
defineArgument(kin_getReactionTypeDefinition, "name", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.kin_getFwdRatesOfProgress Representation of C++ function kin_getFwdRatesOfProgress.");
defineArgument(kin_getFwdRatesOfProgressDefinition, "n", "int32");
defineArgument(kin_getFwdRatesOfProgressDefinition, "len", "uint64");
defineArgument(kin_getFwdRatesOfProgressDefinition, "fwdROP", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getRevRatesOfProgress Representation of C++ function kin_getRevRatesOfProgress.");
defineArgument(kin_getRevRatesOfProgressDefinition, "n", "int32");
defineArgument(kin_getRevRatesOfProgressDefinition, "len", "uint64");
defineArgument(kin_getRevRatesOfProgressDefinition, "revROP", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getNetRatesOfProgress Representation of C++ function kin_getNetRatesOfProgress.");
defineArgument(kin_getNetRatesOfProgressDefinition, "n", "int32");
defineArgument(kin_getNetRatesOfProgressDefinition, "len", "uint64");
defineArgument(kin_getNetRatesOfProgressDefinition, "netROP", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getEquilibriumConstants Representation of C++ function kin_getEquilibriumConstants.");
...
defineArgument(kin_getEquilibriumConstantsDefinition, "kc", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getFwdRateConstants Representation of C++ function kin_getFwdRateConstants.");
defineArgument(kin_getFwdRateConstantsDefinition, "n", "int32");
defineArgument(kin_getFwdRateConstantsDefinition, "len", "uint64");
defineArgument(kin_getFwdRateConstantsDefinition, "kfwd", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getRevRateConstants Representation of C++ function kin_getRevRateConstants.");
...
defineArgument(kin_getRevRateConstantsDefinition, "krev", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getDelta Representation of C++ function kin_getDelta.");
...
defineArgument(kin_getDeltaDefinition, "delta", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getCreationRates Representation of C++ function kin_getCreationRates.");
defineArgument(kin_getCreationRatesDefinition, "n", "int32");
defineArgument(kin_getCreationRatesDefinition, "len", "uint64");
defineArgument(kin_getCreationRatesDefinition, "cdot", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getDestructionRates Representation of C++ function kin_getDestructionRates.");
defineArgument(kin_getDestructionRatesDefinition, "n", "int32");
defineArgument(kin_getDestructionRatesDefinition, "len", "uint64");
defineArgument(kin_getDestructionRatesDefinition, "ddot", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getNetProductionRates Representation of C++ function kin_getNetProductionRates.");
defineArgument(kin_getNetProductionRatesDefinition, "n", "int32");
defineArgument(kin_getNetProductionRatesDefinition, "len", "uint64");
defineArgument(kin_getNetProductionRatesDefinition, "wdot", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_getSourceTerms Representation of C++ function kin_getSourceTerms.");
defineArgument(kin_getSourceTermsDefinition, "n", "int32");
defineArgument(kin_getSourceTermsDefinition, "len", "uint64");
defineArgument(kin_getSourceTermsDefinition, "ydot", "double", "output", "len");
...
"Description", "clib.ctMatlab.kin_multiplier Representation of C++ function kin_multiplier.");
...
"Description", "clib.ctMatlab.kin_getReactionString Representation of C++ function kin_getReactionString.");
...
defineArgument(kin_getReactionStringDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.kin_setMultiplier Representation of C++ function kin_setMultiplier.");
...
"Description", "clib.ctMatlab.kin_isReversible Representation of C++ function kin_isReversible.");
...
"Description", "clib.ctMatlab.kin_getType Representation of C++ function kin_getType.");
defineArgument(kin_getTypeDefinition, "n", "int32");
defineArgument(kin_getTypeDefinition, "len", "uint64");
defineArgument(kin_getTypeDefinition, "name", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.kin_start Representation of C++ function kin_start.");
...
"Description", "clib.ctMatlab.kin_speciesIndex Representation of C++ function kin_speciesIndex.");
...
"Description", "clib.ctMatlab.kin_advanceCoverages Representation of C++ function kin_advanceCoverages.");
...
"Description", "clib.ctMatlab.kin_phase Representation of C++ function kin_phase.");
...
"Description", "clib.ctMatlab.trans_parent Representation of C++ function trans_parent.");
...
"Description", "clib.ctMatlab.trans_transportModel Representation of C++ function trans_transportModel.");
defineArgument(trans_transportModelDefinition, "n", "int32");
defineArgument(trans_transportModelDefinition, "lennm", "int32");
defineArgument(trans_transportModelDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.trans_viscosity Representation of C++ function trans_viscosity.");
...
"Description", "clib.ctMatlab.trans_electricalConductivity Representation of C++ function trans_electricalConductivity.");
...
"Description", "clib.ctMatlab.trans_thermalConductivity Representation of C++ function trans_thermalConductivity.");
...
"Description", "clib.ctMatlab.trans_getThermalDiffCoeffs Representation of C++ function trans_getThermalDiffCoeffs.");
defineArgument(trans_getThermalDiffCoeffsDefinition, "n", "int32");
defineArgument(trans_getThermalDiffCoeffsDefinition, "ldt", "int32");
defineArgument(trans_getThermalDiffCoeffsDefinition, "dt", "double", "output", "ldt");
...
"Description", "clib.ctMatlab.trans_getMixDiffCoeffs Representation of C++ function trans_getMixDiffCoeffs.");
defineArgument(trans_getMixDiffCoeffsDefinition, "n", "int32");
defineArgument(trans_getMixDiffCoeffsDefinition, "ld", "int32");
defineArgument(trans_getMixDiffCoeffsDefinition, "d", "double", "output", "ld");
...
"Description", "clib.ctMatlab.trans_getBinDiffCoeffs Representation of C++ function trans_getBinDiffCoeffs.");
defineArgument(trans_getBinDiffCoeffsDefinition, "n", "int32");
defineArgument(trans_getBinDiffCoeffsDefinition, "ld", "int32");
defineArgument(trans_getBinDiffCoeffsDefinition, "d", "double", "output", "ld");
...
"Description", "clib.ctMatlab.trans_getMultiDiffCoeffs Representation of C++ function trans_getMultiDiffCoeffs.");
defineArgument(trans_getMultiDiffCoeffsDefinition, "n", "int32");
defineArgument(trans_getMultiDiffCoeffsDefinition, "ld", "int32");
defineArgument(trans_getMultiDiffCoeffsDefinition, "d", "double", "output", "ld");
...
% defineArgument(trans_getMolarFluxesDefinition, "state1", "clib.array.ctMatlab.Double", "input", 2); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
% defineArgument(trans_getMassFluxesDefinition, "state1", "clib.array.ctMatlab.Double", "input", 2); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
"Description", "clib.ctMatlab.ct_getCanteraError Representation of C++ function ct_getCanteraError.");
defineArgument(ct_getCanteraErrorDefinition, "buflen", "int32");
defineArgument(ct_getCanteraErrorDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "buflen");
...
"Description", "clib.ctMatlab.ct_setLogCallback Representation of C++ function ct_setLogCallback.");
...
"Description", "clib.ctMatlab.ct_addCanteraDirectory Representation of C++ function ct_addCanteraDirectory.");
...
"Description", "clib.ctMatlab.ct_getDataDirectories Representation of C++ function ct_getDataDirectories.");
...
defineArgument(ct_getDataDirectoriesDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "buflen");
...
"Description", "clib.ctMatlab.ct_getCanteraVersion Representation of C++ function ct_getCanteraVersion.");
defineArgument(ct_getCanteraVersionDefinition, "buflen", "int32");
defineArgument(ct_getCanteraVersionDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "buflen");
...
"Description", "clib.ctMatlab.ct_getGitCommit Representation of C++ function ct_getGitCommit.");
defineArgument(ct_getGitCommitDefinition, "buflen", "int32");
defineArgument(ct_getGitCommitDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "buflen");
...
"Description", "clib.ctMatlab.ct_suppress_thermo_warnings Representation of C++ function ct_suppress_thermo_warnings.");
...
"Description", "clib.ctMatlab.ct_use_legacy_rate_constants Representation of C++ function ct_use_legacy_rate_constants.");
...
"Description", "clib.ctMatlab.ct_clearStorage Representation of C++ function ct_clearStorage.");
...
"Description", "clib.ctMatlab.ct_resetStorage Representation of C++ function ct_resetStorage.");
...
func_checkDefinition = addFunction(libDef, ...
    ...
    "Description", "clib.ctMatlab.func_check Representation of C++ function func_check.");
defineArgument(func_checkDefinition, "type", "string", "input", "nullTerminated");
defineArgument(func_checkDefinition, "len", "uint64");
defineArgument(func_checkDefinition, "buf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.func_new_basic Representation of C++ function func_new_basic.");
...
"Description", "clib.ctMatlab.func_new_advanced Representation of C++ function func_new_advanced.");
...
defineArgument(func_new_advancedDefinition, "p", "double", "input", "lenp");
...
"Description", "clib.ctMatlab.func_new_compound Representation of C++ function func_new_compound.");
...
"Description", "clib.ctMatlab.func_new_modified Representation of C++ function func_new_modified.");
...
"Description", "clib.ctMatlab.func_new_sum Representation of C++ function func_new_sum.");
...
"Description", "clib.ctMatlab.func_new_diff Representation of C++ function func_new_diff.");
...
"Description", "clib.ctMatlab.func_new_prod Representation of C++ function func_new_prod.");
...
"Description", "clib.ctMatlab.func_new_ratio Representation of C++ function func_new_ratio.");
...
"Description", "clib.ctMatlab.func_del Representation of C++ function func_del.");
...
"Description", "clib.ctMatlab.func_type Representation of C++ function func_type.");
defineArgument(func_typeDefinition, "i", "int32");
defineArgument(func_typeDefinition, "lennm", "uint64");
defineArgument(func_typeDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.func_value Representation of C++ function func_value.");
...
"Description", "clib.ctMatlab.func_derivative Representation of C++ function func_derivative.");
...
"Description", "clib.ctMatlab.func_duplicate Representation of C++ function func_duplicate.");
...
"Description", "clib.ctMatlab.func_write Representation of C++ function func_write.");
...
defineArgument(func_writeDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.ct_clearFunc Representation of C++ function ct_clearFunc.");
...
"Description", "clib.ctMatlab.mix_new Representation of C++ function mix_new.");
...
"Description", "clib.ctMatlab.mix_del Representation of C++ function mix_del.");
...
"Description", "clib.ctMatlab.ct_clearMix Representation of C++ function ct_clearMix.");
...
"Description", "clib.ctMatlab.mix_addPhase Representation of C++ function mix_addPhase.");
...
"Description", "clib.ctMatlab.mix_init Representation of C++ function mix_init.");
...
"Description", "clib.ctMatlab.mix_updatePhases Representation of C++ function mix_updatePhases.");
...
"Description", "clib.ctMatlab.mix_nElements Representation of C++ function mix_nElements.");
...
"Description", "clib.ctMatlab.mix_elementIndex Representation of C++ function mix_elementIndex.");
...
"Description", "clib.ctMatlab.mix_speciesIndex Representation of C++ function mix_speciesIndex.");
...
"Description", "clib.ctMatlab.mix_nSpecies Representation of C++ function mix_nSpecies.");
...
"Description", "clib.ctMatlab.mix_setTemperature Representation of C++ function mix_setTemperature.");
...
"Description", "clib.ctMatlab.mix_temperature Representation of C++ function mix_temperature.");
...
"Description", "clib.ctMatlab.mix_minTemp Representation of C++ function mix_minTemp.");
...
"Description", "clib.ctMatlab.mix_maxTemp Representation of C++ function mix_maxTemp.");
...
"Description", "clib.ctMatlab.mix_charge Representation of C++ function mix_charge.");
...
"Description", "clib.ctMatlab.mix_phaseCharge Representation of C++ function mix_phaseCharge.");
...
"Description", "clib.ctMatlab.mix_setPressure Representation of C++ function mix_setPressure.");
...
"Description", "clib.ctMatlab.mix_pressure Representation of C++ function mix_pressure.");
...
"Description", "clib.ctMatlab.mix_nAtoms Representation of C++ function mix_nAtoms.");
...
"Description", "clib.ctMatlab.mix_nPhases Representation of C++ function mix_nPhases.");
...
"Description", "clib.ctMatlab.mix_phaseMoles Representation of C++ function mix_phaseMoles.");
...
"Description", "clib.ctMatlab.mix_setPhaseMoles Representation of C++ function mix_setPhaseMoles.");
...
"Description", "clib.ctMatlab.mix_setMoles Representation of C++ function mix_setMoles.");
defineArgument(mix_setMolesDefinition, "i", "int32");
defineArgument(mix_setMolesDefinition, "nlen", "uint64");
defineArgument(mix_setMolesDefinition, "n", "double", "input", "nlen");
...
"Description", "clib.ctMatlab.mix_setMolesByName Representation of C++ function mix_setMolesByName.");
...
"Description", "clib.ctMatlab.mix_speciesMoles Representation of C++ function mix_speciesMoles.");
...
"Description", "clib.ctMatlab.mix_elementMoles Representation of C++ function mix_elementMoles.");
...
"Description", "clib.ctMatlab.mix_equilibrate Representation of C++ function mix_equilibrate.");
...
"Description", "clib.ctMatlab.mix_getChemPotentials Representation of C++ function mix_getChemPotentials.");
defineArgument(mix_getChemPotentialsDefinition, "i", "int32");
defineArgument(mix_getChemPotentialsDefinition, "lenmu", "uint64");
defineArgument(mix_getChemPotentialsDefinition, "mu", "double", "output", "lenmu");
...
"Description", "clib.ctMatlab.mix_enthalpy Representation of C++ function mix_enthalpy.");
...
"Description", "clib.ctMatlab.mix_entropy Representation of C++ function mix_entropy.");
...
"Description", "clib.ctMatlab.mix_gibbs Representation of C++ function mix_gibbs.");
...
"Description", "clib.ctMatlab.mix_cp Representation of C++ function mix_cp.");
...
"Description", "clib.ctMatlab.mix_volume Representation of C++ function mix_volume.");
...
"Description", "clib.ctMatlab.mix_speciesPhaseIndex Representation of C++ function mix_speciesPhaseIndex.");
...
"Description", "clib.ctMatlab.mix_moleFraction Representation of C++ function mix_moleFraction.");
...
"Description", "clib.ctMatlab.ct_clearOneDim Representation of C++ function ct_clearOneDim.");
...
"Description", "clib.ctMatlab.domain_new Representation of C++ function domain_new.");
...
"Description", "clib.ctMatlab.domain_del Representation of C++ function domain_del.");
...
"Description", "clib.ctMatlab.domain_type Representation of C++ function domain_type.");
defineArgument(domain_typeDefinition, "i", "int32");
defineArgument(domain_typeDefinition, "lennm", "uint64");
defineArgument(domain_typeDefinition, "nm", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "lennm");
...
"Description", "clib.ctMatlab.domain_index Representation of C++ function domain_index.");
...
"Description", "clib.ctMatlab.domain_nComponents Representation of C++ function domain_nComponents.");
...
"Description", "clib.ctMatlab.domain_nPoints Representation of C++ function domain_nPoints.");
...
"Description", "clib.ctMatlab.domain_componentName Representation of C++ function domain_componentName.");
...
defineArgument(domain_componentNameDefinition, "nameout", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "sz");
...
"Description", "clib.ctMatlab.domain_componentIndex Representation of C++ function domain_componentIndex.");
...
"Description", "clib.ctMatlab.domain_setBounds Representation of C++ function domain_setBounds.");
...
"Description", "clib.ctMatlab.domain_lowerBound Representation of C++ function domain_lowerBound.");
...
"Description", "clib.ctMatlab.domain_upperBound Representation of C++ function domain_upperBound.");
...
"Description", "clib.ctMatlab.domain_setSteadyTolerances Representation of C++ function domain_setSteadyTolerances.");
...
"Description", "clib.ctMatlab.domain_setTransientTolerances Representation of C++ function domain_setTransientTolerances.");
...
"Description", "clib.ctMatlab.domain_rtol Representation of C++ function domain_rtol.");
...
"Description", "clib.ctMatlab.domain_atol Representation of C++ function domain_atol.");
...
"Description", "clib.ctMatlab.domain_setupGrid Representation of C++ function domain_setupGrid.");
defineArgument(domain_setupGridDefinition, "i", "int32");
defineArgument(domain_setupGridDefinition, "npts", "uint64");
defineArgument(domain_setupGridDefinition, "grid", "double", "input", "npts");
...
"Description", "clib.ctMatlab.domain_setID Representation of C++ function domain_setID.");
...
"Description", "clib.ctMatlab.domain_grid Representation of C++ function domain_grid.");
...
"Description", "clib.ctMatlab.bdry_setMdot Representation of C++ function bdry_setMdot.");
...
"Description", "clib.ctMatlab.bdry_setTemperature Representation of C++ function bdry_setTemperature.");
...
"Description", "clib.ctMatlab.bdry_setSpreadRate Representation of C++ function bdry_setSpreadRate.");
...
"Description", "clib.ctMatlab.bdry_setMoleFractions Representation of C++ function bdry_setMoleFractions.");
...
"Description", "clib.ctMatlab.bdry_temperature Representation of C++ function bdry_temperature.");
...
"Description", "clib.ctMatlab.bdry_spreadRate Representation of C++ function bdry_spreadRate.");
...
"Description", "clib.ctMatlab.bdry_massFraction Representation of C++ function bdry_massFraction.");
...
"Description", "clib.ctMatlab.bdry_mdot Representation of C++ function bdry_mdot.");
...
"Description", "clib.ctMatlab.reactingsurf_enableCoverageEqs Representation of C++ function reactingsurf_enableCoverageEqs.");
...
"Description", "clib.ctMatlab.flow1D_setTransport Representation of C++ function flow1D_setTransport.");
...
"Description", "clib.ctMatlab.flow1D_enableSoret Representation of C++ function flow1D_enableSoret.");
...
"Description", "clib.ctMatlab.flow1D_setPressure Representation of C++ function flow1D_setPressure.");
...
"Description", "clib.ctMatlab.flow1D_pressure Representation of C++ function flow1D_pressure.");
...
"Description", "clib.ctMatlab.flow1D_setFixedTempProfile Representation of C++ function flow1D_setFixedTempProfile.");
defineArgument(flow1D_setFixedTempProfileDefinition, "i", "int32");
defineArgument(flow1D_setFixedTempProfileDefinition, "n", "uint64");
defineArgument(flow1D_setFixedTempProfileDefinition, "pos", "double", "input", "n");
defineArgument(flow1D_setFixedTempProfileDefinition, "m", "uint64");
defineArgument(flow1D_setFixedTempProfileDefinition, "temp", "double", "input", "m");
...
"Description", "clib.ctMatlab.flow1D_solveEnergyEqn Representation of C++ function flow1D_solveEnergyEqn.");
...
"Description", "clib.ctMatlab.sim1D_new Representation of C++ function sim1D_new.");
defineArgument(sim1D_newDefinition, "nd", "uint64");
defineArgument(sim1D_newDefinition, "domains", "clib.array.ctMatlab.Int", "input", "nd");
...
"Description", "clib.ctMatlab.sim1D_del Representation of C++ function sim1D_del.");
...
"Description", "clib.ctMatlab.sim1D_setValue Representation of C++ function sim1D_setValue.");
...
"Description", "clib.ctMatlab.sim1D_setProfile Representation of C++ function sim1D_setProfile.");
...
defineArgument(sim1D_setProfileDefinition, "pos", "double", "input", "np");
defineArgument(sim1D_setProfileDefinition, "nv", "uint64");
defineArgument(sim1D_setProfileDefinition, "v", "double", "input", "nv");
...
"Description", "clib.ctMatlab.sim1D_setFlatProfile Representation of C++ function sim1D_setFlatProfile.");
...
"Description", "clib.ctMatlab.sim1D_show Representation of C++ function sim1D_show.");
...
"Description", "clib.ctMatlab.sim1D_setTimeStep Representation of C++ function sim1D_setTimeStep.");
...
defineArgument(sim1D_setTimeStepDefinition, "nsteps", "clib.array.ctMatlab.Int", "input", "ns");
...
"Description", "clib.ctMatlab.sim1D_getInitialSoln Representation of C++ function sim1D_getInitialSoln.");
...
"Description", "clib.ctMatlab.sim1D_solve Representation of C++ function sim1D_solve.");
...
"Description", "clib.ctMatlab.sim1D_refine Representation of C++ function sim1D_refine.");
...
"Description", "clib.ctMatlab.sim1D_setRefineCriteria Representation of C++ function sim1D_setRefineCriteria.");
...
"Description", "clib.ctMatlab.sim1D_setGridMin Representation of C++ function sim1D_setGridMin.");
...
"Description", "clib.ctMatlab.sim1D_save Representation of C++ function sim1D_save.");
...
"Description", "clib.ctMatlab.sim1D_restore Representation of C++ function sim1D_restore.");
...
"Description", "clib.ctMatlab.sim1D_writeStats Representation of C++ function sim1D_writeStats.");
...
"Description", "clib.ctMatlab.sim1D_domainIndex Representation of C++ function sim1D_domainIndex.");
...
"Description", "clib.ctMatlab.sim1D_value Representation of C++ function sim1D_value.");
...
"Description", "clib.ctMatlab.sim1D_workValue Representation of C++ function sim1D_workValue.");
...
"Description", "clib.ctMatlab.sim1D_eval Representation of C++ function sim1D_eval.");
...
"Description", "clib.ctMatlab.sim1D_setMaxJacAge Representation of C++ function sim1D_setMaxJacAge.");
...
"Description", "clib.ctMatlab.sim1D_setFixedTemperature Representation of C++ function sim1D_setFixedTemperature.");
...
"Description", "clib.ctMatlab.reactor_new Representation of C++ function reactor_new.");
...
"Description", "clib.ctMatlab.reactor_del Representation of C++ function reactor_del.");
...
"Description", "clib.ctMatlab.reactor_type Representation of C++ function reactor_type.");
defineArgument(reactor_typeDefinition, "i", "int32");
defineArgument(reactor_typeDefinition, "len", "int32");
defineArgument(reactor_typeDefinition, "nbuf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.reactor_name Representation of C++ function reactor_name.");
defineArgument(reactor_nameDefinition, "i", "int32");
defineArgument(reactor_nameDefinition, "len", "int32");
defineArgument(reactor_nameDefinition, "nbuf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.reactor_setName Representation of C++ function reactor_setName.");
...
"Description", "clib.ctMatlab.reactor_setInitialVolume Representation of C++ function reactor_setInitialVolume.");
...
"Description", "clib.ctMatlab.reactor_setChemistry Representation of C++ function reactor_setChemistry.");
...
"Description", "clib.ctMatlab.reactor_setEnergy Representation of C++ function reactor_setEnergy.");
...
"Description", "clib.ctMatlab.reactor_mass Representation of C++ function reactor_mass.");
...
"Description", "clib.ctMatlab.reactor_volume Representation of C++ function reactor_volume.");
...
"Description", "clib.ctMatlab.reactor_density Representation of C++ function reactor_density.");
...
"Description", "clib.ctMatlab.reactor_temperature Representation of C++ function reactor_temperature.");
...
"Description", "clib.ctMatlab.reactor_enthalpy_mass Representation of C++ function reactor_enthalpy_mass.");
...
"Description", "clib.ctMatlab.reactor_intEnergy_mass Representation of C++ function reactor_intEnergy_mass.");
...
"Description", "clib.ctMatlab.reactor_pressure Representation of C++ function reactor_pressure.");
...
"Description", "clib.ctMatlab.reactor_massFraction Representation of C++ function reactor_massFraction.");
...
"Description", "clib.ctMatlab.reactor_nSensParams Representation of C++ function reactor_nSensParams.");
...
"Description", "clib.ctMatlab.reactor_addSensitivityReaction Representation of C++ function reactor_addSensitivityReaction.");
...
"Description", "clib.ctMatlab.reactor_setMassFlowRate Representation of C++ function reactor_setMassFlowRate.");
...
"Description", "clib.ctMatlab.reactornet_new Representation of C++ function reactornet_new.");
...
"Description", "clib.ctMatlab.reactornet_del Representation of C++ function reactornet_del.");
...
"Description", "clib.ctMatlab.reactornet_setInitialTime Representation of C++ function reactornet_setInitialTime.");
...
"Description", "clib.ctMatlab.reactornet_setMaxTimeStep Representation of C++ function reactornet_setMaxTimeStep.");
...
"Description", "clib.ctMatlab.reactornet_setTolerances Representation of C++ function reactornet_setTolerances.");
...
"Description", "clib.ctMatlab.reactornet_setSensitivityTolerances Representation of C++ function reactornet_setSensitivityTolerances.");
...
"Description", "clib.ctMatlab.reactornet_addreactor Representation of C++ function reactornet_addreactor.");
...
"Description", "clib.ctMatlab.reactornet_advance Representation of C++ function reactornet_advance.");
...
"Description", "clib.ctMatlab.reactornet_step Representation of C++ function reactornet_step.");
...
"Description", "clib.ctMatlab.reactornet_time Representation of C++ function reactornet_time.");
...
"Description", "clib.ctMatlab.reactornet_rtol Representation of C++ function reactornet_rtol.");
...
"Description", "clib.ctMatlab.reactornet_atol Representation of C++ function reactornet_atol.");
...
"Description", "clib.ctMatlab.reactornet_sensitivity Representation of C++ function reactornet_sensitivity.");
...
"Description", "clib.ctMatlab.connector_new Representation of C++ function connector_new.");
...
"Description", "clib.ctMatlab.connector_del Representation of C++ function connector_del.");
...
"Description", "clib.ctMatlab.connector_type Representation of C++ function connector_type.");
defineArgument(connector_typeDefinition, "i", "int32");
defineArgument(connector_typeDefinition, "len", "int32");
defineArgument(connector_typeDefinition, "nbuf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.connector_name Representation of C++ function connector_name.");
defineArgument(connector_nameDefinition, "i", "int32");
defineArgument(connector_nameDefinition, "len", "int32");
defineArgument(connector_nameDefinition, "nbuf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.connector_setName Representation of C++ function connector_setName.");
...
"Description", "clib.ctMatlab.flowdev_setPrimary Representation of C++ function flowdev_setPrimary.");
...
"Description", "clib.ctMatlab.flowdev_massFlowRate Representation of C++ function flowdev_massFlowRate.");
...
"Description", "clib.ctMatlab.flowdev_setMassFlowCoeff Representation of C++ function flowdev_setMassFlowCoeff.");
...
"Description", "clib.ctMatlab.flowdev_setValveCoeff Representation of C++ function flowdev_setValveCoeff.");
...
"Description", "clib.ctMatlab.flowdev_setPressureCoeff Representation of C++ function flowdev_setPressureCoeff.");
...
"Description", "clib.ctMatlab.flowdev_setPressureFunction Representation of C++ function flowdev_setPressureFunction.");
...
"Description", "clib.ctMatlab.flowdev_setTimeFunction Representation of C++ function flowdev_setTimeFunction.");
...
"Description", "clib.ctMatlab.wall_expansionRate Representation of C++ function wall_expansionRate.");
...
"Description", "clib.ctMatlab.wall_heatRate Representation of C++ function wall_heatRate.");
...
"Description", "clib.ctMatlab.wall_area Representation of C++ function wall_area.");
...
"Description", "clib.ctMatlab.wall_setArea Representation of C++ function wall_setArea.");
...
"Description", "clib.ctMatlab.wall_setThermalResistance Representation of C++ function wall_setThermalResistance.");
...
"Description", "clib.ctMatlab.wall_setHeatTransferCoeff Representation of C++ function wall_setHeatTransferCoeff.");
...
"Description", "clib.ctMatlab.wall_setHeatFlux Representation of C++ function wall_setHeatFlux.");
...
"Description", "clib.ctMatlab.wall_setExpansionRateCoeff Representation of C++ function wall_setExpansionRateCoeff.");
...
"Description", "clib.ctMatlab.wall_setVelocity Representation of C++ function wall_setVelocity.");
...
"Description", "clib.ctMatlab.wall_setEmissivity Representation of C++ function wall_setEmissivity.");
...
"Description", "clib.ctMatlab.reactorsurface_new Representation of C++ function reactorsurface_new.");
...
"Description", "clib.ctMatlab.reactorsurface_del Representation of C++ function reactorsurface_del.");
...
"Description", "clib.ctMatlab.reactorsurface_name Representation of C++ function reactorsurface_name.");
defineArgument(reactorsurface_nameDefinition, "i", "int32");
defineArgument(reactorsurface_nameDefinition, "len", "int32");
defineArgument(reactorsurface_nameDefinition, "nbuf", "string", "output", ...
    "nullTerminated", "NumElementsInBuffer", "len");
...
"Description", "clib.ctMatlab.reactorsurface_setName Representation of C++ function reactorsurface_setName.");
...
"Description", "clib.ctMatlab.reactorsurface_install Representation of C++ function reactorsurface_install.");
...
"Description", "clib.ctMatlab.reactorsurface_setkinetics Representation of C++ function reactorsurface_setkinetics.");
...
"Description", "clib.ctMatlab.reactorsurface_area Representation of C++ function reactorsurface_area.");
...
"Description", "clib.ctMatlab.reactorsurface_setArea Representation of C++ function reactorsurface_setArea.");
...
"Description", "clib.ctMatlab.reactorsurface_addSensitivityReaction Representation of C++ function reactorsurface_addSensitivityReaction.");
...
"Description", "clib.ctMatlab.ct_clearReactors Representation of C++ function ct_clearReactors.");
...
"Description", "clib.ctMatlab.rdiag_new Representation of C++ function rdiag_new.");
...
"Description", "clib.ctMatlab.rdiag_del Representation of C++ function rdiag_del.");
...
"Description", "clib.ctMatlab.rdiag_detailed Representation of C++ function rdiag_detailed.");
...
"Description", "clib.ctMatlab.rdiag_brief Representation of C++ function rdiag_brief.");
...
"Description", "clib.ctMatlab.rdiag_setThreshold Representation of C++ function rdiag_setThreshold.");
...
"Description", "clib.ctMatlab.rdiag_setBoldColor Representation of C++ function rdiag_setBoldColor.");
...
"Description", "clib.ctMatlab.rdiag_setNormalColor Representation of C++ function rdiag_setNormalColor.");
...
"Description", "clib.ctMatlab.rdiag_setDashedColor Representation of C++ function rdiag_setDashedColor.");
...
"Description", "clib.ctMatlab.rdiag_setDotOptions Representation of C++ function rdiag_setDotOptions.");
...
"Description", "clib.ctMatlab.rdiag_setBoldThreshold Representation of C++ function rdiag_setBoldThreshold.");
...
"Description", "clib.ctMatlab.rdiag_setNormalThreshold Representation of C++ function rdiag_setNormalThreshold.");
...
"Description", "clib.ctMatlab.rdiag_setLabelThreshold Representation of C++ function rdiag_setLabelThreshold.");
...
"Description", "clib.ctMatlab.rdiag_setScale Representation of C++ function rdiag_setScale.");
...
"Description", "clib.ctMatlab.rdiag_setFlowType Representation of C++ function rdiag_setFlowType.");
...
"Description", "clib.ctMatlab.rdiag_setArrowWidth Representation of C++ function rdiag_setArrowWidth.");
...
"Description", "clib.ctMatlab.rdiag_setTitle Representation of C++ function rdiag_setTitle.");
...
"Description", "clib.ctMatlab.rdiag_write Representation of C++ function rdiag_write.");
...
"Description", "clib.ctMatlab.rdiag_add Representation of C++ function rdiag_add.");
...
"Description", "clib.ctMatlab.rdiag_findMajor Representation of C++ function rdiag_findMajor.");
...
defineArgument(rdiag_findMajorDefinition, "a", "double", "output", "lda");
...
"Description", "clib.ctMatlab.rdiag_setFont Representation of C++ function rdiag_setFont.");
...
"Description", "clib.ctMatlab.rdiag_displayOnly Representation of C++ function rdiag_displayOnly.");
...
"Description", "clib.ctMatlab.rbuild_new Representation of C++ function rbuild_new.");
...
"Description", "clib.ctMatlab.rbuild_del Representation of C++ function rbuild_del.");
...
"Description", "clib.ctMatlab.rbuild_init Representation of C++ function rbuild_init.");
...
"Description", "clib.ctMatlab.rbuild_build Representation of C++ function rbuild_build.");
...
"Description", "clib.ctMatlab.ct_clearReactionPath Representation of C++ function ct_clearReactionPath.");
...
"Description", "clib.ctMatlab.surf_setCoverages Representation of C++ function surf_setCoverages.");
defineArgument(surf_setCoveragesDefinition, "i", "int32");
defineArgument(surf_setCoveragesDefinition, "c", "double", "input", 1);
...
"Description", "clib.ctMatlab.surf_getCoverages Representation of C++ function surf_getCoverages.");
defineArgument(surf_getCoveragesDefinition, "i", "int32");
defineArgument(surf_getCoveragesDefinition, "c", "double", "input", 1);
...
"Description", "clib.ctMatlab.surf_setConcentrations Representation of C++ function surf_setConcentrations.");
defineArgument(surf_setConcentrationsDefinition, "i", "int32");
defineArgument(surf_setConcentrationsDefinition, "c", "double", "input", 1);
...
"Description", "clib.ctMatlab.surf_getConcentrations Representation of C++ function surf_getConcentrations.");
defineArgument(surf_getConcentrationsDefinition, "i", "int32");
defineArgument(surf_getConcentrationsDefinition, "c", "double", "output", 1);
...
"Description", "clib.ctMatlab.surf_setSiteDensity Representation of C++ function surf_setSiteDensity.");
...
"Description", "clib.ctMatlab.surf_siteDensity Representation of C++ function surf_siteDensity.");
...
"Description", "clib.ctMatlab.surf_setCoveragesByName Representation of C++ function surf_setCoveragesByName.");
