%% About definectMatlab.m
% This file defines the MATLAB interface to the library |ctMatlab|.
%
...
function libDef = definectMatlab()
libDef = clibgen.LibraryDefinition("ctMatlabData.xml");

%% OutputFolder and Libraries 
libDef.OutputFolder = "C:\Users\ssnit\cantera";
libDef.Libraries = [ "C:\Users\ssnit\cantera\build\lib\cantera_shared.dll" "C:\Users\ssnit\cantera\build\lib\cantera_shared.lib" ];

%% C++ function type |using LogCallback = void(*)(LogLevel, char const *, char const *)| with MATLAB name |clib.ctMatlab.LogCallback| 
addFunctionType(libDef, "using LogCallback = void(*)(LogLevel, char const *, char const *)", "MATLABName", "clib.ctMatlab.LogCallback", ...
    "Description", "clib.ctMatlab.LogCallback    C++ function type LogCallback."); % Modify help description values as needed.

%% C++ enumeration |LogLevel| with MATLAB name |clib.ctMatlab.LogLevel| 
addEnumeration(libDef, "LogLevel", "int32",...
    ...
    "MATLABName", "clib.ctMatlab.LogLevel", ...
    "Description", "clib.ctMatlab.LogLevel    Representation of C++ enumeration LogLevel."); % Modify help description values as needed.

%% C++ function |ct_appdelete| with MATLAB name |clib.ctMatlab.ct_appdelete|
% C++ Signature: int ct_appdelete()

ct_appdeleteDefinition = addFunction(libDef, ...
    "int ct_appdelete()", ...
    "MATLABName", "clib.ctMatlab.ct_appdelete", ...
    "Description", "clib.ctMatlab.ct_appdelete Representation of C++ function ct_appdelete."); % Modify help description values as needed.
defineOutput(ct_appdeleteDefinition, "RetVal", "int32");
validate(ct_appdeleteDefinition);

%% C++ function |soln_newSolution| with MATLAB name |clib.ctMatlab.soln_newSolution|
...
soln_newSolutionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.soln_newSolution", ...
    "Description", "clib.ctMatlab.soln_newSolution Representation of C++ function soln_newSolution."); % Modify help description values as needed.
...
%% C++ function |soln_newInterface| with MATLAB name |clib.ctMatlab.soln_newInterface|
...
%    "MATLABName", "clib.ctMatlab.soln_newInterface", ...
%    "Description", "clib.ctMatlab.soln_newInterface Representation of C++ function soln_newInterface."); % Modify help description values as needed.
...
%defineArgument(soln_newInterfaceDefinition, "adjacent", "clib.array.ctMatlab.Int", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Int", or "int32"
%defineOutput(soln_newInterfaceDefinition, "RetVal", "int32");
%validate(soln_newInterfaceDefinition);

%% C++ function |soln_del| with MATLAB name |clib.ctMatlab.soln_del|
% C++ Signature: int soln_del(int n)

soln_delDefinition = addFunction(libDef, ...
    "int soln_del(int n)", ...
    "MATLABName", "clib.ctMatlab.soln_del", ...
    "Description", "clib.ctMatlab.soln_del Representation of C++ function soln_del." + newline + ...
...
%% C++ function |soln_name| with MATLAB name |clib.ctMatlab.soln_name|
...
%    "MATLABName", "clib.ctMatlab.soln_name", ...
%    "Description", "clib.ctMatlab.soln_name Representation of C++ function soln_name."); % Modify help description values as needed.
%defineArgument(soln_nameDefinition, "n", "int32");
%defineArgument(soln_nameDefinition, "buflen", "int32");
%defineArgument(soln_nameDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(soln_nameDefinition, "RetVal", "int32");
%validate(soln_nameDefinition);

%% C++ function |soln_thermo| with MATLAB name |clib.ctMatlab.soln_thermo|
% C++ Signature: int soln_thermo(int n)

soln_thermoDefinition = addFunction(libDef, ...
    "int soln_thermo(int n)", ...
    "MATLABName", "clib.ctMatlab.soln_thermo", ...
    "Description", "clib.ctMatlab.soln_thermo Representation of C++ function soln_thermo."); % Modify help description values as needed.
...
%% C++ function |soln_kinetics| with MATLAB name |clib.ctMatlab.soln_kinetics|
% C++ Signature: int soln_kinetics(int n)

soln_kineticsDefinition = addFunction(libDef, ...
    "int soln_kinetics(int n)", ...
    "MATLABName", "clib.ctMatlab.soln_kinetics", ...
    "Description", "clib.ctMatlab.soln_kinetics Representation of C++ function soln_kinetics."); % Modify help description values as needed.
...
%% C++ function |soln_transport| with MATLAB name |clib.ctMatlab.soln_transport|
% C++ Signature: int soln_transport(int n)

soln_transportDefinition = addFunction(libDef, ...
    "int soln_transport(int n)", ...
    "MATLABName", "clib.ctMatlab.soln_transport", ...
    "Description", "clib.ctMatlab.soln_transport Representation of C++ function soln_transport."); % Modify help description values as needed.
...
%% C++ function |soln_setTransportModel| with MATLAB name |clib.ctMatlab.soln_setTransportModel|
...
soln_setTransportModelDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.soln_setTransportModel", ...
    "Description", "clib.ctMatlab.soln_setTransportModel Representation of C++ function soln_setTransportModel."); % Modify help description values as needed.
...
%% C++ function |soln_nAdjacent| with MATLAB name |clib.ctMatlab.soln_nAdjacent|
% C++ Signature: size_t soln_nAdjacent(int n)

soln_nAdjacentDefinition = addFunction(libDef, ...
    "size_t soln_nAdjacent(int n)", ...
    "MATLABName", "clib.ctMatlab.soln_nAdjacent", ...
    "Description", "clib.ctMatlab.soln_nAdjacent Representation of C++ function soln_nAdjacent."); % Modify help description values as needed.
...
%% C++ function |soln_adjacent| with MATLAB name |clib.ctMatlab.soln_adjacent|
% C++ Signature: int soln_adjacent(int n,int a)

soln_adjacentDefinition = addFunction(libDef, ...
    "int soln_adjacent(int n,int a)", ...
    "MATLABName", "clib.ctMatlab.soln_adjacent", ...
    "Description", "clib.ctMatlab.soln_adjacent Representation of C++ function soln_adjacent."); % Modify help description values as needed.
...
%% C++ function |soln_adjacentName| with MATLAB name |clib.ctMatlab.soln_adjacentName|
...
%    "MATLABName", "clib.ctMatlab.soln_adjacentName", ...
%    "Description", "clib.ctMatlab.soln_adjacentName Representation of C++ function soln_adjacentName."); % Modify help description values as needed.
...
%defineArgument(soln_adjacentNameDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(soln_adjacentNameDefinition, "RetVal", "int32");
%validate(soln_adjacentNameDefinition);

%% C++ function |thermo_parent| with MATLAB name |clib.ctMatlab.thermo_parent|
% C++ Signature: int thermo_parent(int n)

thermo_parentDefinition = addFunction(libDef, ...
    "int thermo_parent(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_parent", ...
    "Description", "clib.ctMatlab.thermo_parent Representation of C++ function thermo_parent."); % Modify help description values as needed.
...
%% C++ function |thermo_size| with MATLAB name |clib.ctMatlab.thermo_size|
% C++ Signature: int thermo_size()

thermo_sizeDefinition = addFunction(libDef, ...
    "int thermo_size()", ...
    "MATLABName", "clib.ctMatlab.thermo_size", ...
    "Description", "clib.ctMatlab.thermo_size Representation of C++ function thermo_size."); % Modify help description values as needed.
defineOutput(thermo_sizeDefinition, "RetVal", "int32");
validate(thermo_sizeDefinition);

%% C++ function |thermo_del| with MATLAB name |clib.ctMatlab.thermo_del|
% C++ Signature: int thermo_del(int n)

thermo_delDefinition = addFunction(libDef, ...
    "int thermo_del(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_del", ...
    "Description", "clib.ctMatlab.thermo_del Representation of C++ function thermo_del." + newline + ...
...
%% C++ function |thermo_nElements| with MATLAB name |clib.ctMatlab.thermo_nElements|
% C++ Signature: size_t thermo_nElements(int n)

thermo_nElementsDefinition = addFunction(libDef, ...
    "size_t thermo_nElements(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_nElements", ...
    "Description", "clib.ctMatlab.thermo_nElements Representation of C++ function thermo_nElements."); % Modify help description values as needed.
...
%% C++ function |thermo_nSpecies| with MATLAB name |clib.ctMatlab.thermo_nSpecies|
% C++ Signature: size_t thermo_nSpecies(int n)

thermo_nSpeciesDefinition = addFunction(libDef, ...
    "size_t thermo_nSpecies(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_nSpecies", ...
    "Description", "clib.ctMatlab.thermo_nSpecies Representation of C++ function thermo_nSpecies."); % Modify help description values as needed.
...
%% C++ function |thermo_temperature| with MATLAB name |clib.ctMatlab.thermo_temperature|
...
thermo_temperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_temperature", ...
    "Description", "clib.ctMatlab.thermo_temperature Representation of C++ function thermo_temperature."); % Modify help description values as needed.
...
%% C++ function |thermo_setTemperature| with MATLAB name |clib.ctMatlab.thermo_setTemperature|
...
thermo_setTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setTemperature", ...
    "Description", "clib.ctMatlab.thermo_setTemperature Representation of C++ function thermo_setTemperature."); % Modify help description values as needed.
...
%% C++ function |thermo_density| with MATLAB name |clib.ctMatlab.thermo_density|
% C++ Signature: double thermo_density(int n)

thermo_densityDefinition = addFunction(libDef, ...
    "double thermo_density(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_density", ...
    "Description", "clib.ctMatlab.thermo_density Representation of C++ function thermo_density."); % Modify help description values as needed.
...
%% C++ function |thermo_setDensity| with MATLAB name |clib.ctMatlab.thermo_setDensity|
...
thermo_setDensityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setDensity", ...
    "Description", "clib.ctMatlab.thermo_setDensity Representation of C++ function thermo_setDensity."); % Modify help description values as needed.
...
%% C++ function |thermo_molarDensity| with MATLAB name |clib.ctMatlab.thermo_molarDensity|
...
thermo_molarDensityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_molarDensity", ...
    "Description", "clib.ctMatlab.thermo_molarDensity Representation of C++ function thermo_molarDensity."); % Modify help description values as needed.
...
%% C++ function |thermo_meanMolecularWeight| with MATLAB name |clib.ctMatlab.thermo_meanMolecularWeight|
...
thermo_meanMolecularWeightDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_meanMolecularWeight", ...
    "Description", "clib.ctMatlab.thermo_meanMolecularWeight Representation of C++ function thermo_meanMolecularWeight."); % Modify help description values as needed.
...
%% C++ function |thermo_moleFraction| with MATLAB name |clib.ctMatlab.thermo_moleFraction|
...
thermo_moleFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_moleFraction", ...
    "Description", "clib.ctMatlab.thermo_moleFraction Representation of C++ function thermo_moleFraction."); % Modify help description values as needed.
...
%% C++ function |thermo_massFraction| with MATLAB name |clib.ctMatlab.thermo_massFraction|
...
thermo_massFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_massFraction", ...
    "Description", "clib.ctMatlab.thermo_massFraction Representation of C++ function thermo_massFraction."); % Modify help description values as needed.
...
%% C++ function |thermo_getMoleFractions| with MATLAB name |clib.ctMatlab.thermo_getMoleFractions|
...
%    "MATLABName", "clib.ctMatlab.thermo_getMoleFractions", ...
%    "Description", "clib.ctMatlab.thermo_getMoleFractions Representation of C++ function thermo_getMoleFractions."); % Modify help description values as needed.
%defineArgument(thermo_getMoleFractionsDefinition, "n", "int32");
%defineArgument(thermo_getMoleFractionsDefinition, "lenx", "uint64");
%defineArgument(thermo_getMoleFractionsDefinition, "x", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getMoleFractionsDefinition, "RetVal", "int32");
%validate(thermo_getMoleFractionsDefinition);

%% C++ function |thermo_getMassFractions| with MATLAB name |clib.ctMatlab.thermo_getMassFractions|
...
%    "MATLABName", "clib.ctMatlab.thermo_getMassFractions", ...
%    "Description", "clib.ctMatlab.thermo_getMassFractions Representation of C++ function thermo_getMassFractions."); % Modify help description values as needed.
%defineArgument(thermo_getMassFractionsDefinition, "n", "int32");
%defineArgument(thermo_getMassFractionsDefinition, "leny", "uint64");
%defineArgument(thermo_getMassFractionsDefinition, "y", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getMassFractionsDefinition, "RetVal", "int32");
%validate(thermo_getMassFractionsDefinition);

%% C++ function |thermo_setMoleFractions| with MATLAB name |clib.ctMatlab.thermo_setMoleFractions|
...
%    "MATLABName", "clib.ctMatlab.thermo_setMoleFractions", ...
%    "Description", "clib.ctMatlab.thermo_setMoleFractions Representation of C++ function thermo_setMoleFractions."); % Modify help description values as needed.
%defineArgument(thermo_setMoleFractionsDefinition, "n", "int32");
%defineArgument(thermo_setMoleFractionsDefinition, "lenx", "uint64");
%defineArgument(thermo_setMoleFractionsDefinition, "x", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
%% C++ function |thermo_setMassFractions| with MATLAB name |clib.ctMatlab.thermo_setMassFractions|
...
%    "MATLABName", "clib.ctMatlab.thermo_setMassFractions", ...
%    "Description", "clib.ctMatlab.thermo_setMassFractions Representation of C++ function thermo_setMassFractions."); % Modify help description values as needed.
%defineArgument(thermo_setMassFractionsDefinition, "n", "int32");
%defineArgument(thermo_setMassFractionsDefinition, "leny", "uint64");
%defineArgument(thermo_setMassFractionsDefinition, "y", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
%% C++ function |thermo_setMoleFractionsByName| with MATLAB name |clib.ctMatlab.thermo_setMoleFractionsByName|
...
thermo_setMoleFractionsByNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setMoleFractionsByName", ...
    "Description", "clib.ctMatlab.thermo_setMoleFractionsByName Representation of C++ function thermo_setMoleFractionsByName."); % Modify help description values as needed.
...
%% C++ function |thermo_setMassFractionsByName| with MATLAB name |clib.ctMatlab.thermo_setMassFractionsByName|
...
thermo_setMassFractionsByNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setMassFractionsByName", ...
    "Description", "clib.ctMatlab.thermo_setMassFractionsByName Representation of C++ function thermo_setMassFractionsByName."); % Modify help description values as needed.
...
%% C++ function |thermo_getAtomicWeights| with MATLAB name |clib.ctMatlab.thermo_getAtomicWeights|
...
%    "MATLABName", "clib.ctMatlab.thermo_getAtomicWeights", ...
%    "Description", "clib.ctMatlab.thermo_getAtomicWeights Representation of C++ function thermo_getAtomicWeights."); % Modify help description values as needed.
%defineArgument(thermo_getAtomicWeightsDefinition, "n", "int32");
%defineArgument(thermo_getAtomicWeightsDefinition, "lenm", "uint64");
%defineArgument(thermo_getAtomicWeightsDefinition, "atw", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getAtomicWeightsDefinition, "RetVal", "int32");
%validate(thermo_getAtomicWeightsDefinition);

%% C++ function |thermo_getMolecularWeights| with MATLAB name |clib.ctMatlab.thermo_getMolecularWeights|
...
%    "MATLABName", "clib.ctMatlab.thermo_getMolecularWeights", ...
%    "Description", "clib.ctMatlab.thermo_getMolecularWeights Representation of C++ function thermo_getMolecularWeights."); % Modify help description values as needed.
...
%defineArgument(thermo_getMolecularWeightsDefinition, "mw", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getMolecularWeightsDefinition, "RetVal", "int32");
%validate(thermo_getMolecularWeightsDefinition);

%% C++ function |thermo_getCharges| with MATLAB name |clib.ctMatlab.thermo_getCharges|
...
%    "MATLABName", "clib.ctMatlab.thermo_getCharges", ...
%    "Description", "clib.ctMatlab.thermo_getCharges Representation of C++ function thermo_getCharges."); % Modify help description values as needed.
%defineArgument(thermo_getChargesDefinition, "n", "int32");
%defineArgument(thermo_getChargesDefinition, "lenm", "uint64");
%defineArgument(thermo_getChargesDefinition, "sc", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getChargesDefinition, "RetVal", "int32");
%validate(thermo_getChargesDefinition);

%% C++ function |thermo_getElementName| with MATLAB name |clib.ctMatlab.thermo_getElementName|
...
%    "MATLABName", "clib.ctMatlab.thermo_getElementName", ...
%    "Description", "clib.ctMatlab.thermo_getElementName Representation of C++ function thermo_getElementName."); % Modify help description values as needed.
...
%defineArgument(thermo_getElementNameDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(thermo_getElementNameDefinition, "RetVal", "int32");
%validate(thermo_getElementNameDefinition);

%% C++ function |thermo_getSpeciesName| with MATLAB name |clib.ctMatlab.thermo_getSpeciesName|
...
%    "MATLABName", "clib.ctMatlab.thermo_getSpeciesName", ...
%    "Description", "clib.ctMatlab.thermo_getSpeciesName Representation of C++ function thermo_getSpeciesName."); % Modify help description values as needed.
...
%defineArgument(thermo_getSpeciesNameDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(thermo_getSpeciesNameDefinition, "RetVal", "int32");
%validate(thermo_getSpeciesNameDefinition);

%% C++ function |thermo_getName| with MATLAB name |clib.ctMatlab.thermo_getName|
...
%    "MATLABName", "clib.ctMatlab.thermo_getName", ...
%    "Description", "clib.ctMatlab.thermo_getName Representation of C++ function thermo_getName."); % Modify help description values as needed.
%defineArgument(thermo_getNameDefinition, "n", "int32");
%defineArgument(thermo_getNameDefinition, "lennm", "uint64");
%defineArgument(thermo_getNameDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(thermo_getNameDefinition, "RetVal", "int32");
%validate(thermo_getNameDefinition);

%% C++ function |thermo_setName| with MATLAB name |clib.ctMatlab.thermo_setName|
...
thermo_setNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setName", ...
    "Description", "clib.ctMatlab.thermo_setName Representation of C++ function thermo_setName."); % Modify help description values as needed.
...
%% C++ function |thermo_elementIndex| with MATLAB name |clib.ctMatlab.thermo_elementIndex|
...
thermo_elementIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_elementIndex", ...
    "Description", "clib.ctMatlab.thermo_elementIndex Representation of C++ function thermo_elementIndex."); % Modify help description values as needed.
...
%% C++ function |thermo_speciesIndex| with MATLAB name |clib.ctMatlab.thermo_speciesIndex|
...
thermo_speciesIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_speciesIndex", ...
    "Description", "clib.ctMatlab.thermo_speciesIndex Representation of C++ function thermo_speciesIndex."); % Modify help description values as needed.
...
%% C++ function |thermo_report| with MATLAB name |clib.ctMatlab.thermo_report|
...
%    "MATLABName", "clib.ctMatlab.thermo_report", ...
%    "Description", "clib.ctMatlab.thermo_report Representation of C++ function thermo_report."); % Modify help description values as needed.
...
%defineArgument(thermo_reportDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(thermo_reportDefinition, "RetVal", "int32");
%validate(thermo_reportDefinition);

%% C++ function |thermo_print| with MATLAB name |clib.ctMatlab.thermo_print|
...
thermo_printDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_print", ...
    "Description", "clib.ctMatlab.thermo_print Representation of C++ function thermo_print."); % Modify help description values as needed.
...
%% C++ function |thermo_nAtoms| with MATLAB name |clib.ctMatlab.thermo_nAtoms|
...
thermo_nAtomsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_nAtoms", ...
    "Description", "clib.ctMatlab.thermo_nAtoms Representation of C++ function thermo_nAtoms."); % Modify help description values as needed.
...
%% C++ function |thermo_addElement| with MATLAB name |clib.ctMatlab.thermo_addElement|
...
thermo_addElementDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_addElement", ...
    "Description", "clib.ctMatlab.thermo_addElement Representation of C++ function thermo_addElement."); % Modify help description values as needed.
...
%% C++ function |thermo_getEosType| with MATLAB name |clib.ctMatlab.thermo_getEosType|
...
%    "MATLABName", "clib.ctMatlab.thermo_getEosType", ...
%    "Description", "clib.ctMatlab.thermo_getEosType Representation of C++ function thermo_getEosType."); % Modify help description values as needed.
%defineArgument(thermo_getEosTypeDefinition, "n", "int32");
%defineArgument(thermo_getEosTypeDefinition, "leneos", "uint64");
%defineArgument(thermo_getEosTypeDefinition, "eos", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(thermo_getEosTypeDefinition, "RetVal", "int32");
%validate(thermo_getEosTypeDefinition);

%% C++ function |thermo_refPressure| with MATLAB name |clib.ctMatlab.thermo_refPressure|
...
thermo_refPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_refPressure", ...
    "Description", "clib.ctMatlab.thermo_refPressure Representation of C++ function thermo_refPressure."); % Modify help description values as needed.
...
%% C++ function |thermo_minTemp| with MATLAB name |clib.ctMatlab.thermo_minTemp|
...
thermo_minTempDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_minTemp", ...
    "Description", "clib.ctMatlab.thermo_minTemp Representation of C++ function thermo_minTemp."); % Modify help description values as needed.
...
%% C++ function |thermo_maxTemp| with MATLAB name |clib.ctMatlab.thermo_maxTemp|
...
thermo_maxTempDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_maxTemp", ...
    "Description", "clib.ctMatlab.thermo_maxTemp Representation of C++ function thermo_maxTemp."); % Modify help description values as needed.
...
%% C++ function |thermo_enthalpy_mole| with MATLAB name |clib.ctMatlab.thermo_enthalpy_mole|
...
thermo_enthalpy_moleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_enthalpy_mole", ...
    "Description", "clib.ctMatlab.thermo_enthalpy_mole Representation of C++ function thermo_enthalpy_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_intEnergy_mole| with MATLAB name |clib.ctMatlab.thermo_intEnergy_mole|
...
thermo_intEnergy_moleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_intEnergy_mole", ...
    "Description", "clib.ctMatlab.thermo_intEnergy_mole Representation of C++ function thermo_intEnergy_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_entropy_mole| with MATLAB name |clib.ctMatlab.thermo_entropy_mole|
...
thermo_entropy_moleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_entropy_mole", ...
    "Description", "clib.ctMatlab.thermo_entropy_mole Representation of C++ function thermo_entropy_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_gibbs_mole| with MATLAB name |clib.ctMatlab.thermo_gibbs_mole|
% C++ Signature: double thermo_gibbs_mole(int n)

thermo_gibbs_moleDefinition = addFunction(libDef, ...
    "double thermo_gibbs_mole(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_gibbs_mole", ...
    "Description", "clib.ctMatlab.thermo_gibbs_mole Representation of C++ function thermo_gibbs_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_cp_mole| with MATLAB name |clib.ctMatlab.thermo_cp_mole|
% C++ Signature: double thermo_cp_mole(int n)

thermo_cp_moleDefinition = addFunction(libDef, ...
    "double thermo_cp_mole(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_cp_mole", ...
    "Description", "clib.ctMatlab.thermo_cp_mole Representation of C++ function thermo_cp_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_cv_mole| with MATLAB name |clib.ctMatlab.thermo_cv_mole|
% C++ Signature: double thermo_cv_mole(int n)

thermo_cv_moleDefinition = addFunction(libDef, ...
    "double thermo_cv_mole(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_cv_mole", ...
    "Description", "clib.ctMatlab.thermo_cv_mole Representation of C++ function thermo_cv_mole."); % Modify help description values as needed.
...
%% C++ function |thermo_pressure| with MATLAB name |clib.ctMatlab.thermo_pressure|
% C++ Signature: double thermo_pressure(int n)

thermo_pressureDefinition = addFunction(libDef, ...
    "double thermo_pressure(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_pressure", ...
    "Description", "clib.ctMatlab.thermo_pressure Representation of C++ function thermo_pressure."); % Modify help description values as needed.
...
%% C++ function |thermo_setPressure| with MATLAB name |clib.ctMatlab.thermo_setPressure|
...
thermo_setPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setPressure", ...
    "Description", "clib.ctMatlab.thermo_setPressure Representation of C++ function thermo_setPressure."); % Modify help description values as needed.
...
%% C++ function |thermo_enthalpy_mass| with MATLAB name |clib.ctMatlab.thermo_enthalpy_mass|
...
thermo_enthalpy_massDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_enthalpy_mass", ...
    "Description", "clib.ctMatlab.thermo_enthalpy_mass Representation of C++ function thermo_enthalpy_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_intEnergy_mass| with MATLAB name |clib.ctMatlab.thermo_intEnergy_mass|
...
thermo_intEnergy_massDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_intEnergy_mass", ...
    "Description", "clib.ctMatlab.thermo_intEnergy_mass Representation of C++ function thermo_intEnergy_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_entropy_mass| with MATLAB name |clib.ctMatlab.thermo_entropy_mass|
...
thermo_entropy_massDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_entropy_mass", ...
    "Description", "clib.ctMatlab.thermo_entropy_mass Representation of C++ function thermo_entropy_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_gibbs_mass| with MATLAB name |clib.ctMatlab.thermo_gibbs_mass|
% C++ Signature: double thermo_gibbs_mass(int n)

thermo_gibbs_massDefinition = addFunction(libDef, ...
    "double thermo_gibbs_mass(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_gibbs_mass", ...
    "Description", "clib.ctMatlab.thermo_gibbs_mass Representation of C++ function thermo_gibbs_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_cp_mass| with MATLAB name |clib.ctMatlab.thermo_cp_mass|
% C++ Signature: double thermo_cp_mass(int n)

thermo_cp_massDefinition = addFunction(libDef, ...
    "double thermo_cp_mass(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_cp_mass", ...
    "Description", "clib.ctMatlab.thermo_cp_mass Representation of C++ function thermo_cp_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_cv_mass| with MATLAB name |clib.ctMatlab.thermo_cv_mass|
% C++ Signature: double thermo_cv_mass(int n)

thermo_cv_massDefinition = addFunction(libDef, ...
    "double thermo_cv_mass(int n)", ...
    "MATLABName", "clib.ctMatlab.thermo_cv_mass", ...
    "Description", "clib.ctMatlab.thermo_cv_mass Representation of C++ function thermo_cv_mass."); % Modify help description values as needed.
...
%% C++ function |thermo_electricPotential| with MATLAB name |clib.ctMatlab.thermo_electricPotential|
...
thermo_electricPotentialDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_electricPotential", ...
    "Description", "clib.ctMatlab.thermo_electricPotential Representation of C++ function thermo_electricPotential."); % Modify help description values as needed.
...
%% C++ function |thermo_thermalExpansionCoeff| with MATLAB name |clib.ctMatlab.thermo_thermalExpansionCoeff|
...
thermo_thermalExpansionCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_thermalExpansionCoeff", ...
    "Description", "clib.ctMatlab.thermo_thermalExpansionCoeff Representation of C++ function thermo_thermalExpansionCoeff."); % Modify help description values as needed.
...
%% C++ function |thermo_isothermalCompressibility| with MATLAB name |clib.ctMatlab.thermo_isothermalCompressibility|
...
thermo_isothermalCompressibilityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_isothermalCompressibility", ...
    "Description", "clib.ctMatlab.thermo_isothermalCompressibility Representation of C++ function thermo_isothermalCompressibility."); % Modify help description values as needed.
...
%% C++ function |thermo_chemPotentials| with MATLAB name |clib.ctMatlab.thermo_chemPotentials|
...
%    "MATLABName", "clib.ctMatlab.thermo_chemPotentials", ...
%    "Description", "clib.ctMatlab.thermo_chemPotentials Representation of C++ function thermo_chemPotentials."); % Modify help description values as needed.
%defineArgument(thermo_chemPotentialsDefinition, "n", "int32");
%defineArgument(thermo_chemPotentialsDefinition, "lenm", "uint64");
%defineArgument(thermo_chemPotentialsDefinition, "murt", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_chemPotentialsDefinition, "RetVal", "int32");
%validate(thermo_chemPotentialsDefinition);

%% C++ function |thermo_electrochemPotentials| with MATLAB name |clib.ctMatlab.thermo_electrochemPotentials|
...
%    "MATLABName", "clib.ctMatlab.thermo_electrochemPotentials", ...
%    "Description", "clib.ctMatlab.thermo_electrochemPotentials Representation of C++ function thermo_electrochemPotentials."); % Modify help description values as needed.
...
%defineArgument(thermo_electrochemPotentialsDefinition, "emu", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_electrochemPotentialsDefinition, "RetVal", "int32");
%validate(thermo_electrochemPotentialsDefinition);

%% C++ function |thermo_getEnthalpies_RT| with MATLAB name |clib.ctMatlab.thermo_getEnthalpies_RT|
...
%    "MATLABName", "clib.ctMatlab.thermo_getEnthalpies_RT", ...
%    "Description", "clib.ctMatlab.thermo_getEnthalpies_RT Representation of C++ function thermo_getEnthalpies_RT."); % Modify help description values as needed.
%defineArgument(thermo_getEnthalpies_RTDefinition, "n", "int32");
%defineArgument(thermo_getEnthalpies_RTDefinition, "lenm", "uint64");
%defineArgument(thermo_getEnthalpies_RTDefinition, "h_rt", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getEnthalpies_RTDefinition, "RetVal", "int32");
%validate(thermo_getEnthalpies_RTDefinition);

%% C++ function |thermo_getEntropies_R| with MATLAB name |clib.ctMatlab.thermo_getEntropies_R|
...
%    "MATLABName", "clib.ctMatlab.thermo_getEntropies_R", ...
%    "Description", "clib.ctMatlab.thermo_getEntropies_R Representation of C++ function thermo_getEntropies_R."); % Modify help description values as needed.
%defineArgument(thermo_getEntropies_RDefinition, "n", "int32");
%defineArgument(thermo_getEntropies_RDefinition, "lenm", "uint64");
%defineArgument(thermo_getEntropies_RDefinition, "s_r", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getEntropies_RDefinition, "RetVal", "int32");
%validate(thermo_getEntropies_RDefinition);

%% C++ function |thermo_getCp_R| with MATLAB name |clib.ctMatlab.thermo_getCp_R|
...
%    "MATLABName", "clib.ctMatlab.thermo_getCp_R", ...
%    "Description", "clib.ctMatlab.thermo_getCp_R Representation of C++ function thermo_getCp_R."); % Modify help description values as needed.
%defineArgument(thermo_getCp_RDefinition, "n", "int32");
%defineArgument(thermo_getCp_RDefinition, "lenm", "uint64");
%defineArgument(thermo_getCp_RDefinition, "cp_r", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getCp_RDefinition, "RetVal", "int32");
%validate(thermo_getCp_RDefinition);

%% C++ function |thermo_setElectricPotential| with MATLAB name |clib.ctMatlab.thermo_setElectricPotential|
...
thermo_setElectricPotentialDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setElectricPotential", ...
    "Description", "clib.ctMatlab.thermo_setElectricPotential Representation of C++ function thermo_setElectricPotential."); % Modify help description values as needed.
...
%% C++ function |thermo_getPartialMolarEnthalpies| with MATLAB name |clib.ctMatlab.thermo_getPartialMolarEnthalpies|
...
%    "MATLABName", "clib.ctMatlab.thermo_getPartialMolarEnthalpies", ...
%    "Description", "clib.ctMatlab.thermo_getPartialMolarEnthalpies Representation of C++ function thermo_getPartialMolarEnthalpies."); % Modify help description values as needed.
...
%defineArgument(thermo_getPartialMolarEnthalpiesDefinition, "pmh", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getPartialMolarEnthalpiesDefinition, "RetVal", "int32");
%validate(thermo_getPartialMolarEnthalpiesDefinition);

%% C++ function |thermo_getPartialMolarEntropies| with MATLAB name |clib.ctMatlab.thermo_getPartialMolarEntropies|
...
%    "MATLABName", "clib.ctMatlab.thermo_getPartialMolarEntropies", ...
%    "Description", "clib.ctMatlab.thermo_getPartialMolarEntropies Representation of C++ function thermo_getPartialMolarEntropies."); % Modify help description values as needed.
...
%defineArgument(thermo_getPartialMolarEntropiesDefinition, "pms", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getPartialMolarEntropiesDefinition, "RetVal", "int32");
%validate(thermo_getPartialMolarEntropiesDefinition);

%% C++ function |thermo_getPartialMolarIntEnergies| with MATLAB name |clib.ctMatlab.thermo_getPartialMolarIntEnergies|
...
%    "MATLABName", "clib.ctMatlab.thermo_getPartialMolarIntEnergies", ...
%    "Description", "clib.ctMatlab.thermo_getPartialMolarIntEnergies Representation of C++ function thermo_getPartialMolarIntEnergies."); % Modify help description values as needed.
...
%defineArgument(thermo_getPartialMolarIntEnergiesDefinition, "pmu", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
%% C++ function |thermo_getPartialMolarCp| with MATLAB name |clib.ctMatlab.thermo_getPartialMolarCp|
...
%    "MATLABName", "clib.ctMatlab.thermo_getPartialMolarCp", ...
%    "Description", "clib.ctMatlab.thermo_getPartialMolarCp Representation of C++ function thermo_getPartialMolarCp."); % Modify help description values as needed.
%defineArgument(thermo_getPartialMolarCpDefinition, "n", "int32");
%defineArgument(thermo_getPartialMolarCpDefinition, "lenm", "uint64");
%defineArgument(thermo_getPartialMolarCpDefinition, "pmcp", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getPartialMolarCpDefinition, "RetVal", "int32");
%validate(thermo_getPartialMolarCpDefinition);

%% C++ function |thermo_getPartialMolarVolumes| with MATLAB name |clib.ctMatlab.thermo_getPartialMolarVolumes|
...
%    "MATLABName", "clib.ctMatlab.thermo_getPartialMolarVolumes", ...
%    "Description", "clib.ctMatlab.thermo_getPartialMolarVolumes Representation of C++ function thermo_getPartialMolarVolumes."); % Modify help description values as needed.
...
%defineArgument(thermo_getPartialMolarVolumesDefinition, "pmv", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_getPartialMolarVolumesDefinition, "RetVal", "int32");
%validate(thermo_getPartialMolarVolumesDefinition);

%% C++ function |thermo_set_TP| with MATLAB name |clib.ctMatlab.thermo_set_TP|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_TP", ...
%    "Description", "clib.ctMatlab.thermo_set_TP Representation of C++ function thermo_set_TP."); % Modify help description values as needed.
%defineArgument(thermo_set_TPDefinition, "n", "int32");
%defineArgument(thermo_set_TPDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_TPDefinition, "RetVal", "int32");
%validate(thermo_set_TPDefinition);

%% C++ function |thermo_set_TD| with MATLAB name |clib.ctMatlab.thermo_set_TD|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_TD", ...
%    "Description", "clib.ctMatlab.thermo_set_TD Representation of C++ function thermo_set_TD."); % Modify help description values as needed.
%defineArgument(thermo_set_TDDefinition, "n", "int32");
%defineArgument(thermo_set_TDDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_TDDefinition, "RetVal", "int32");
%validate(thermo_set_TDDefinition);

%% C++ function |thermo_set_DP| with MATLAB name |clib.ctMatlab.thermo_set_DP|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_DP", ...
%    "Description", "clib.ctMatlab.thermo_set_DP Representation of C++ function thermo_set_DP."); % Modify help description values as needed.
%defineArgument(thermo_set_DPDefinition, "n", "int32");
%defineArgument(thermo_set_DPDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_DPDefinition, "RetVal", "int32");
%validate(thermo_set_DPDefinition);

%% C++ function |thermo_set_HP| with MATLAB name |clib.ctMatlab.thermo_set_HP|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_HP", ...
%    "Description", "clib.ctMatlab.thermo_set_HP Representation of C++ function thermo_set_HP."); % Modify help description values as needed.
%defineArgument(thermo_set_HPDefinition, "n", "int32");
%defineArgument(thermo_set_HPDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_HPDefinition, "RetVal", "int32");
%validate(thermo_set_HPDefinition);

%% C++ function |thermo_set_UV| with MATLAB name |clib.ctMatlab.thermo_set_UV|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_UV", ...
%    "Description", "clib.ctMatlab.thermo_set_UV Representation of C++ function thermo_set_UV."); % Modify help description values as needed.
%defineArgument(thermo_set_UVDefinition, "n", "int32");
%defineArgument(thermo_set_UVDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_UVDefinition, "RetVal", "int32");
%validate(thermo_set_UVDefinition);

%% C++ function |thermo_set_SV| with MATLAB name |clib.ctMatlab.thermo_set_SV|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_SV", ...
%    "Description", "clib.ctMatlab.thermo_set_SV Representation of C++ function thermo_set_SV."); % Modify help description values as needed.
%defineArgument(thermo_set_SVDefinition, "n", "int32");
%defineArgument(thermo_set_SVDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_SVDefinition, "RetVal", "int32");
%validate(thermo_set_SVDefinition);

%% C++ function |thermo_set_SP| with MATLAB name |clib.ctMatlab.thermo_set_SP|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_SP", ...
%    "Description", "clib.ctMatlab.thermo_set_SP Representation of C++ function thermo_set_SP."); % Modify help description values as needed.
%defineArgument(thermo_set_SPDefinition, "n", "int32");
%defineArgument(thermo_set_SPDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_SPDefinition, "RetVal", "int32");
%validate(thermo_set_SPDefinition);

%% C++ function |thermo_set_ST| with MATLAB name |clib.ctMatlab.thermo_set_ST|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_ST", ...
%    "Description", "clib.ctMatlab.thermo_set_ST Representation of C++ function thermo_set_ST."); % Modify help description values as needed.
%defineArgument(thermo_set_STDefinition, "n", "int32");
%defineArgument(thermo_set_STDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_STDefinition, "RetVal", "int32");
%validate(thermo_set_STDefinition);

%% C++ function |thermo_set_TV| with MATLAB name |clib.ctMatlab.thermo_set_TV|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_TV", ...
%    "Description", "clib.ctMatlab.thermo_set_TV Representation of C++ function thermo_set_TV."); % Modify help description values as needed.
%defineArgument(thermo_set_TVDefinition, "n", "int32");
%defineArgument(thermo_set_TVDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_TVDefinition, "RetVal", "int32");
%validate(thermo_set_TVDefinition);

%% C++ function |thermo_set_PV| with MATLAB name |clib.ctMatlab.thermo_set_PV|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_PV", ...
%    "Description", "clib.ctMatlab.thermo_set_PV Representation of C++ function thermo_set_PV."); % Modify help description values as needed.
%defineArgument(thermo_set_PVDefinition, "n", "int32");
%defineArgument(thermo_set_PVDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_PVDefinition, "RetVal", "int32");
%validate(thermo_set_PVDefinition);

%% C++ function |thermo_set_UP| with MATLAB name |clib.ctMatlab.thermo_set_UP|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_UP", ...
%    "Description", "clib.ctMatlab.thermo_set_UP Representation of C++ function thermo_set_UP."); % Modify help description values as needed.
%defineArgument(thermo_set_UPDefinition, "n", "int32");
%defineArgument(thermo_set_UPDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_UPDefinition, "RetVal", "int32");
%validate(thermo_set_UPDefinition);

%% C++ function |thermo_set_VH| with MATLAB name |clib.ctMatlab.thermo_set_VH|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_VH", ...
%    "Description", "clib.ctMatlab.thermo_set_VH Representation of C++ function thermo_set_VH."); % Modify help description values as needed.
%defineArgument(thermo_set_VHDefinition, "n", "int32");
%defineArgument(thermo_set_VHDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_VHDefinition, "RetVal", "int32");
%validate(thermo_set_VHDefinition);

%% C++ function |thermo_set_TH| with MATLAB name |clib.ctMatlab.thermo_set_TH|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_TH", ...
%    "Description", "clib.ctMatlab.thermo_set_TH Representation of C++ function thermo_set_TH."); % Modify help description values as needed.
%defineArgument(thermo_set_THDefinition, "n", "int32");
%defineArgument(thermo_set_THDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_THDefinition, "RetVal", "int32");
%validate(thermo_set_THDefinition);

%% C++ function |thermo_set_SH| with MATLAB name |clib.ctMatlab.thermo_set_SH|
...
%    "MATLABName", "clib.ctMatlab.thermo_set_SH", ...
%    "Description", "clib.ctMatlab.thermo_set_SH Representation of C++ function thermo_set_SH."); % Modify help description values as needed.
%defineArgument(thermo_set_SHDefinition, "n", "int32");
%defineArgument(thermo_set_SHDefinition, "vals", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(thermo_set_SHDefinition, "RetVal", "int32");
%validate(thermo_set_SHDefinition);

%% C++ function |thermo_equilibrate| with MATLAB name |clib.ctMatlab.thermo_equilibrate|
...
thermo_equilibrateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_equilibrate", ...
    "Description", "clib.ctMatlab.thermo_equilibrate Representation of C++ function thermo_equilibrate."); % Modify help description values as needed.
...
%% C++ function |thermo_critTemperature| with MATLAB name |clib.ctMatlab.thermo_critTemperature|
...
thermo_critTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_critTemperature", ...
    "Description", "clib.ctMatlab.thermo_critTemperature Representation of C++ function thermo_critTemperature."); % Modify help description values as needed.
...
%% C++ function |thermo_critPressure| with MATLAB name |clib.ctMatlab.thermo_critPressure|
...
thermo_critPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_critPressure", ...
    "Description", "clib.ctMatlab.thermo_critPressure Representation of C++ function thermo_critPressure."); % Modify help description values as needed.
...
%% C++ function |thermo_critDensity| with MATLAB name |clib.ctMatlab.thermo_critDensity|
...
thermo_critDensityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_critDensity", ...
    "Description", "clib.ctMatlab.thermo_critDensity Representation of C++ function thermo_critDensity."); % Modify help description values as needed.
...
%% C++ function |thermo_vaporFraction| with MATLAB name |clib.ctMatlab.thermo_vaporFraction|
...
thermo_vaporFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_vaporFraction", ...
    "Description", "clib.ctMatlab.thermo_vaporFraction Representation of C++ function thermo_vaporFraction."); % Modify help description values as needed.
...
%% C++ function |thermo_satTemperature| with MATLAB name |clib.ctMatlab.thermo_satTemperature|
...
thermo_satTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_satTemperature", ...
    "Description", "clib.ctMatlab.thermo_satTemperature Representation of C++ function thermo_satTemperature."); % Modify help description values as needed.
...
%% C++ function |thermo_satPressure| with MATLAB name |clib.ctMatlab.thermo_satPressure|
...
thermo_satPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_satPressure", ...
    "Description", "clib.ctMatlab.thermo_satPressure Representation of C++ function thermo_satPressure."); % Modify help description values as needed.
...
%% C++ function |thermo_setState_Psat| with MATLAB name |clib.ctMatlab.thermo_setState_Psat|
...
thermo_setState_PsatDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setState_Psat", ...
    "Description", "clib.ctMatlab.thermo_setState_Psat Representation of C++ function thermo_setState_Psat."); % Modify help description values as needed.
...
%% C++ function |thermo_setState_Tsat| with MATLAB name |clib.ctMatlab.thermo_setState_Tsat|
...
thermo_setState_TsatDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.thermo_setState_Tsat", ...
    "Description", "clib.ctMatlab.thermo_setState_Tsat Representation of C++ function thermo_setState_Tsat."); % Modify help description values as needed.
...
%% C++ function |kin_parent| with MATLAB name |clib.ctMatlab.kin_parent|
% C++ Signature: int kin_parent(int n)

kin_parentDefinition = addFunction(libDef, ...
    "int kin_parent(int n)", ...
    "MATLABName", "clib.ctMatlab.kin_parent", ...
    "Description", "clib.ctMatlab.kin_parent Representation of C++ function kin_parent."); % Modify help description values as needed.
defineArgument(kin_parentDefinition, "n", "int32");
defineOutput(kin_parentDefinition, "RetVal", "int32");
validate(kin_parentDefinition);

%% C++ function |kin_del| with MATLAB name |clib.ctMatlab.kin_del|
% C++ Signature: int kin_del(int n)

kin_delDefinition = addFunction(libDef, ...
    "int kin_del(int n)", ...
    "MATLABName", "clib.ctMatlab.kin_del", ...
    "Description", "clib.ctMatlab.kin_del Representation of C++ function kin_del." + newline + ...
    "no-op; object is managed by Solution"); % Modify help description values as needed.
defineArgument(kin_delDefinition, "n", "int32");
defineOutput(kin_delDefinition, "RetVal", "int32");
validate(kin_delDefinition);

%% C++ function |kin_nSpecies| with MATLAB name |clib.ctMatlab.kin_nSpecies|
% C++ Signature: size_t kin_nSpecies(int n)

kin_nSpeciesDefinition = addFunction(libDef, ...
    "size_t kin_nSpecies(int n)", ...
    "MATLABName", "clib.ctMatlab.kin_nSpecies", ...
    "Description", "clib.ctMatlab.kin_nSpecies Representation of C++ function kin_nSpecies."); % Modify help description values as needed.
...
%% C++ function |kin_nReactions| with MATLAB name |clib.ctMatlab.kin_nReactions|
% C++ Signature: size_t kin_nReactions(int n)

kin_nReactionsDefinition = addFunction(libDef, ...
    "size_t kin_nReactions(int n)", ...
    "MATLABName", "clib.ctMatlab.kin_nReactions", ...
    "Description", "clib.ctMatlab.kin_nReactions Representation of C++ function kin_nReactions."); % Modify help description values as needed.
...
%% C++ function |kin_nPhases| with MATLAB name |clib.ctMatlab.kin_nPhases|
% C++ Signature: size_t kin_nPhases(int n)

kin_nPhasesDefinition = addFunction(libDef, ...
    "size_t kin_nPhases(int n)", ...
    "MATLABName", "clib.ctMatlab.kin_nPhases", ...
    "Description", "clib.ctMatlab.kin_nPhases Representation of C++ function kin_nPhases."); % Modify help description values as needed.
...
%% C++ function |kin_phaseIndex| with MATLAB name |clib.ctMatlab.kin_phaseIndex|
...
kin_phaseIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_phaseIndex", ...
    "Description", "clib.ctMatlab.kin_phaseIndex Representation of C++ function kin_phaseIndex."); % Modify help description values as needed.
...
%% C++ function |kin_reactantStoichCoeff| with MATLAB name |clib.ctMatlab.kin_reactantStoichCoeff|
...
kin_reactantStoichCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_reactantStoichCoeff", ...
    "Description", "clib.ctMatlab.kin_reactantStoichCoeff Representation of C++ function kin_reactantStoichCoeff."); % Modify help description values as needed.
...
%% C++ function |kin_productStoichCoeff| with MATLAB name |clib.ctMatlab.kin_productStoichCoeff|
...
kin_productStoichCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_productStoichCoeff", ...
    "Description", "clib.ctMatlab.kin_productStoichCoeff Representation of C++ function kin_productStoichCoeff."); % Modify help description values as needed.
...
%% C++ function |kin_getReactionType| with MATLAB name |clib.ctMatlab.kin_getReactionType|
...
%    "MATLABName", "clib.ctMatlab.kin_getReactionType", ...
%    "Description", "clib.ctMatlab.kin_getReactionType Representation of C++ function kin_getReactionType."); % Modify help description values as needed.
...
%defineArgument(kin_getReactionTypeDefinition, "name", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(kin_getReactionTypeDefinition, "RetVal", "int32");
%validate(kin_getReactionTypeDefinition);

%% C++ function |kin_getFwdRatesOfProgress| with MATLAB name |clib.ctMatlab.kin_getFwdRatesOfProgress|
...
%    "MATLABName", "clib.ctMatlab.kin_getFwdRatesOfProgress", ...
%    "Description", "clib.ctMatlab.kin_getFwdRatesOfProgress Representation of C++ function kin_getFwdRatesOfProgress."); % Modify help description values as needed.
%defineArgument(kin_getFwdRatesOfProgressDefinition, "n", "int32");
%defineArgument(kin_getFwdRatesOfProgressDefinition, "len", "uint64");
%defineArgument(kin_getFwdRatesOfProgressDefinition, "fwdROP", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getFwdRatesOfProgressDefinition, "RetVal", "int32");
%validate(kin_getFwdRatesOfProgressDefinition);

%% C++ function |kin_getRevRatesOfProgress| with MATLAB name |clib.ctMatlab.kin_getRevRatesOfProgress|
...
%    "MATLABName", "clib.ctMatlab.kin_getRevRatesOfProgress", ...
%    "Description", "clib.ctMatlab.kin_getRevRatesOfProgress Representation of C++ function kin_getRevRatesOfProgress."); % Modify help description values as needed.
%defineArgument(kin_getRevRatesOfProgressDefinition, "n", "int32");
%defineArgument(kin_getRevRatesOfProgressDefinition, "len", "uint64");
%defineArgument(kin_getRevRatesOfProgressDefinition, "revROP", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getRevRatesOfProgressDefinition, "RetVal", "int32");
%validate(kin_getRevRatesOfProgressDefinition);

%% C++ function |kin_getNetRatesOfProgress| with MATLAB name |clib.ctMatlab.kin_getNetRatesOfProgress|
...
%    "MATLABName", "clib.ctMatlab.kin_getNetRatesOfProgress", ...
%    "Description", "clib.ctMatlab.kin_getNetRatesOfProgress Representation of C++ function kin_getNetRatesOfProgress."); % Modify help description values as needed.
%defineArgument(kin_getNetRatesOfProgressDefinition, "n", "int32");
%defineArgument(kin_getNetRatesOfProgressDefinition, "len", "uint64");
%defineArgument(kin_getNetRatesOfProgressDefinition, "netROP", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getNetRatesOfProgressDefinition, "RetVal", "int32");
%validate(kin_getNetRatesOfProgressDefinition);

%% C++ function |kin_getEquilibriumConstants| with MATLAB name |clib.ctMatlab.kin_getEquilibriumConstants|
...
%    "MATLABName", "clib.ctMatlab.kin_getEquilibriumConstants", ...
%    "Description", "clib.ctMatlab.kin_getEquilibriumConstants Representation of C++ function kin_getEquilibriumConstants."); % Modify help description values as needed.
...
%defineArgument(kin_getEquilibriumConstantsDefinition, "kc", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getEquilibriumConstantsDefinition, "RetVal", "int32");
%validate(kin_getEquilibriumConstantsDefinition);

%% C++ function |kin_getFwdRateConstants| with MATLAB name |clib.ctMatlab.kin_getFwdRateConstants|
...
%    "MATLABName", "clib.ctMatlab.kin_getFwdRateConstants", ...
%    "Description", "clib.ctMatlab.kin_getFwdRateConstants Representation of C++ function kin_getFwdRateConstants."); % Modify help description values as needed.
%defineArgument(kin_getFwdRateConstantsDefinition, "n", "int32");
%defineArgument(kin_getFwdRateConstantsDefinition, "len", "uint64");
%defineArgument(kin_getFwdRateConstantsDefinition, "kfwd", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getFwdRateConstantsDefinition, "RetVal", "int32");
%validate(kin_getFwdRateConstantsDefinition);

%% C++ function |kin_getRevRateConstants| with MATLAB name |clib.ctMatlab.kin_getRevRateConstants|
...
%    "MATLABName", "clib.ctMatlab.kin_getRevRateConstants", ...
%    "Description", "clib.ctMatlab.kin_getRevRateConstants Representation of C++ function kin_getRevRateConstants."); % Modify help description values as needed.
...
%defineArgument(kin_getRevRateConstantsDefinition, "krev", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getRevRateConstantsDefinition, "RetVal", "int32");
%validate(kin_getRevRateConstantsDefinition);

%% C++ function |kin_getDelta| with MATLAB name |clib.ctMatlab.kin_getDelta|
...
%    "MATLABName", "clib.ctMatlab.kin_getDelta", ...
%    "Description", "clib.ctMatlab.kin_getDelta Representation of C++ function kin_getDelta."); % Modify help description values as needed.
...
%defineArgument(kin_getDeltaDefinition, "delta", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getDeltaDefinition, "RetVal", "int32");
%validate(kin_getDeltaDefinition);

%% C++ function |kin_getCreationRates| with MATLAB name |clib.ctMatlab.kin_getCreationRates|
...
%    "MATLABName", "clib.ctMatlab.kin_getCreationRates", ...
%    "Description", "clib.ctMatlab.kin_getCreationRates Representation of C++ function kin_getCreationRates."); % Modify help description values as needed.
%defineArgument(kin_getCreationRatesDefinition, "n", "int32");
%defineArgument(kin_getCreationRatesDefinition, "len", "uint64");
%defineArgument(kin_getCreationRatesDefinition, "cdot", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getCreationRatesDefinition, "RetVal", "int32");
%validate(kin_getCreationRatesDefinition);

%% C++ function |kin_getDestructionRates| with MATLAB name |clib.ctMatlab.kin_getDestructionRates|
...
%    "MATLABName", "clib.ctMatlab.kin_getDestructionRates", ...
%    "Description", "clib.ctMatlab.kin_getDestructionRates Representation of C++ function kin_getDestructionRates."); % Modify help description values as needed.
%defineArgument(kin_getDestructionRatesDefinition, "n", "int32");
%defineArgument(kin_getDestructionRatesDefinition, "len", "uint64");
%defineArgument(kin_getDestructionRatesDefinition, "ddot", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getDestructionRatesDefinition, "RetVal", "int32");
%validate(kin_getDestructionRatesDefinition);

%% C++ function |kin_getNetProductionRates| with MATLAB name |clib.ctMatlab.kin_getNetProductionRates|
...
%    "MATLABName", "clib.ctMatlab.kin_getNetProductionRates", ...
%    "Description", "clib.ctMatlab.kin_getNetProductionRates Representation of C++ function kin_getNetProductionRates."); % Modify help description values as needed.
%defineArgument(kin_getNetProductionRatesDefinition, "n", "int32");
%defineArgument(kin_getNetProductionRatesDefinition, "len", "uint64");
%defineArgument(kin_getNetProductionRatesDefinition, "wdot", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getNetProductionRatesDefinition, "RetVal", "int32");
%validate(kin_getNetProductionRatesDefinition);

%% C++ function |kin_getSourceTerms| with MATLAB name |clib.ctMatlab.kin_getSourceTerms|
...
%    "MATLABName", "clib.ctMatlab.kin_getSourceTerms", ...
%    "Description", "clib.ctMatlab.kin_getSourceTerms Representation of C++ function kin_getSourceTerms."); % Modify help description values as needed.
%defineArgument(kin_getSourceTermsDefinition, "n", "int32");
%defineArgument(kin_getSourceTermsDefinition, "len", "uint64");
%defineArgument(kin_getSourceTermsDefinition, "ydot", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(kin_getSourceTermsDefinition, "RetVal", "int32");
%validate(kin_getSourceTermsDefinition);

%% C++ function |kin_multiplier| with MATLAB name |clib.ctMatlab.kin_multiplier|
...
kin_multiplierDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_multiplier", ...
    "Description", "clib.ctMatlab.kin_multiplier Representation of C++ function kin_multiplier."); % Modify help description values as needed.
...
%% C++ function |kin_getReactionString| with MATLAB name |clib.ctMatlab.kin_getReactionString|
...
%    "MATLABName", "clib.ctMatlab.kin_getReactionString", ...
%    "Description", "clib.ctMatlab.kin_getReactionString Representation of C++ function kin_getReactionString."); % Modify help description values as needed.
...
%defineArgument(kin_getReactionStringDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(kin_getReactionStringDefinition, "RetVal", "int32");
%validate(kin_getReactionStringDefinition);

%% C++ function |kin_setMultiplier| with MATLAB name |clib.ctMatlab.kin_setMultiplier|
...
kin_setMultiplierDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_setMultiplier", ...
    "Description", "clib.ctMatlab.kin_setMultiplier Representation of C++ function kin_setMultiplier."); % Modify help description values as needed.
...
%% C++ function |kin_isReversible| with MATLAB name |clib.ctMatlab.kin_isReversible|
...
kin_isReversibleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_isReversible", ...
    "Description", "clib.ctMatlab.kin_isReversible Representation of C++ function kin_isReversible."); % Modify help description values as needed.
...
%% C++ function |kin_getType| with MATLAB name |clib.ctMatlab.kin_getType|
...
%    "MATLABName", "clib.ctMatlab.kin_getType", ...
%    "Description", "clib.ctMatlab.kin_getType Representation of C++ function kin_getType."); % Modify help description values as needed.
%defineArgument(kin_getTypeDefinition, "n", "int32");
%defineArgument(kin_getTypeDefinition, "len", "uint64");
%defineArgument(kin_getTypeDefinition, "name", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(kin_getTypeDefinition, "RetVal", "int32");
%validate(kin_getTypeDefinition);

%% C++ function |kin_start| with MATLAB name |clib.ctMatlab.kin_start|
% C++ Signature: size_t kin_start(int n,int p)

kin_startDefinition = addFunction(libDef, ...
    "size_t kin_start(int n,int p)", ...
    "MATLABName", "clib.ctMatlab.kin_start", ...
    "Description", "clib.ctMatlab.kin_start Representation of C++ function kin_start."); % Modify help description values as needed.
...
%% C++ function |kin_speciesIndex| with MATLAB name |clib.ctMatlab.kin_speciesIndex|
...
kin_speciesIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_speciesIndex", ...
    "Description", "clib.ctMatlab.kin_speciesIndex Representation of C++ function kin_speciesIndex."); % Modify help description values as needed.
...
%% C++ function |kin_advanceCoverages| with MATLAB name |clib.ctMatlab.kin_advanceCoverages|
...
kin_advanceCoveragesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.kin_advanceCoverages", ...
    "Description", "clib.ctMatlab.kin_advanceCoverages Representation of C++ function kin_advanceCoverages."); % Modify help description values as needed.
...
%% C++ function |kin_phase| with MATLAB name |clib.ctMatlab.kin_phase|
% C++ Signature: size_t kin_phase(int n,size_t i)

kin_phaseDefinition = addFunction(libDef, ...
    "size_t kin_phase(int n,size_t i)", ...
    "MATLABName", "clib.ctMatlab.kin_phase", ...
    "Description", "clib.ctMatlab.kin_phase Representation of C++ function kin_phase."); % Modify help description values as needed.
...
%% C++ function |trans_parent| with MATLAB name |clib.ctMatlab.trans_parent|
% C++ Signature: int trans_parent(int n)

trans_parentDefinition = addFunction(libDef, ...
    "int trans_parent(int n)", ...
    "MATLABName", "clib.ctMatlab.trans_parent", ...
    "Description", "clib.ctMatlab.trans_parent Representation of C++ function trans_parent."); % Modify help description values as needed.
...
%% C++ function |trans_del| with MATLAB name |clib.ctMatlab.trans_del|
% C++ Signature: int trans_del(int n)

trans_delDefinition = addFunction(libDef, ...
    "int trans_del(int n)", ...
    "MATLABName", "clib.ctMatlab.trans_del", ...
    "Description", "clib.ctMatlab.trans_del Representation of C++ function trans_del." + newline + ...
    "no-op; object is managed by Solution"); % Modify help description values as needed.
defineArgument(trans_delDefinition, "n", "int32");
defineOutput(trans_delDefinition, "RetVal", "int32");
validate(trans_delDefinition);

%% C++ function |trans_transportModel| with MATLAB name |clib.ctMatlab.trans_transportModel|
...
%    "MATLABName", "clib.ctMatlab.trans_transportModel", ...
%    "Description", "clib.ctMatlab.trans_transportModel Representation of C++ function trans_transportModel."); % Modify help description values as needed.
%defineArgument(trans_transportModelDefinition, "n", "int32");
%defineArgument(trans_transportModelDefinition, "lennm", "int32");
%defineArgument(trans_transportModelDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(trans_transportModelDefinition, "RetVal", "int32");
%validate(trans_transportModelDefinition);

%% C++ function |trans_viscosity| with MATLAB name |clib.ctMatlab.trans_viscosity|
% C++ Signature: double trans_viscosity(int n)

trans_viscosityDefinition = addFunction(libDef, ...
    "double trans_viscosity(int n)", ...
    "MATLABName", "clib.ctMatlab.trans_viscosity", ...
    "Description", "clib.ctMatlab.trans_viscosity Representation of C++ function trans_viscosity."); % Modify help description values as needed.
...
%% C++ function |trans_electricalConductivity| with MATLAB name |clib.ctMatlab.trans_electricalConductivity|
...
trans_electricalConductivityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.trans_electricalConductivity", ...
    "Description", "clib.ctMatlab.trans_electricalConductivity Representation of C++ function trans_electricalConductivity."); % Modify help description values as needed.
...
%% C++ function |trans_thermalConductivity| with MATLAB name |clib.ctMatlab.trans_thermalConductivity|
...
trans_thermalConductivityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.trans_thermalConductivity", ...
    "Description", "clib.ctMatlab.trans_thermalConductivity Representation of C++ function trans_thermalConductivity."); % Modify help description values as needed.
...
%% C++ function |trans_getThermalDiffCoeffs| with MATLAB name |clib.ctMatlab.trans_getThermalDiffCoeffs|
...
%    "MATLABName", "clib.ctMatlab.trans_getThermalDiffCoeffs", ...
%    "Description", "clib.ctMatlab.trans_getThermalDiffCoeffs Representation of C++ function trans_getThermalDiffCoeffs."); % Modify help description values as needed.
%defineArgument(trans_getThermalDiffCoeffsDefinition, "n", "int32");
%defineArgument(trans_getThermalDiffCoeffsDefinition, "ldt", "int32");
%defineArgument(trans_getThermalDiffCoeffsDefinition, "dt", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getThermalDiffCoeffsDefinition, "RetVal", "int32");
%validate(trans_getThermalDiffCoeffsDefinition);

%% C++ function |trans_getMixDiffCoeffs| with MATLAB name |clib.ctMatlab.trans_getMixDiffCoeffs|
...
%    "MATLABName", "clib.ctMatlab.trans_getMixDiffCoeffs", ...
%    "Description", "clib.ctMatlab.trans_getMixDiffCoeffs Representation of C++ function trans_getMixDiffCoeffs."); % Modify help description values as needed.
%defineArgument(trans_getMixDiffCoeffsDefinition, "n", "int32");
%defineArgument(trans_getMixDiffCoeffsDefinition, "ld", "int32");
%defineArgument(trans_getMixDiffCoeffsDefinition, "d", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getMixDiffCoeffsDefinition, "RetVal", "int32");
%validate(trans_getMixDiffCoeffsDefinition);

%% C++ function |trans_getBinDiffCoeffs| with MATLAB name |clib.ctMatlab.trans_getBinDiffCoeffs|
...
%    "MATLABName", "clib.ctMatlab.trans_getBinDiffCoeffs", ...
%    "Description", "clib.ctMatlab.trans_getBinDiffCoeffs Representation of C++ function trans_getBinDiffCoeffs."); % Modify help description values as needed.
%defineArgument(trans_getBinDiffCoeffsDefinition, "n", "int32");
%defineArgument(trans_getBinDiffCoeffsDefinition, "ld", "int32");
%defineArgument(trans_getBinDiffCoeffsDefinition, "d", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getBinDiffCoeffsDefinition, "RetVal", "int32");
%validate(trans_getBinDiffCoeffsDefinition);

%% C++ function |trans_getMultiDiffCoeffs| with MATLAB name |clib.ctMatlab.trans_getMultiDiffCoeffs|
...
%    "MATLABName", "clib.ctMatlab.trans_getMultiDiffCoeffs", ...
%    "Description", "clib.ctMatlab.trans_getMultiDiffCoeffs Representation of C++ function trans_getMultiDiffCoeffs."); % Modify help description values as needed.
%defineArgument(trans_getMultiDiffCoeffsDefinition, "n", "int32");
%defineArgument(trans_getMultiDiffCoeffsDefinition, "ld", "int32");
%defineArgument(trans_getMultiDiffCoeffsDefinition, "d", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getMultiDiffCoeffsDefinition, "RetVal", "int32");
%validate(trans_getMultiDiffCoeffsDefinition);

%% C++ function |trans_getMolarFluxes| with MATLAB name |clib.ctMatlab.trans_getMolarFluxes|
...
%    "MATLABName", "clib.ctMatlab.trans_getMolarFluxes", ...
%    "Description", "clib.ctMatlab.trans_getMolarFluxes Representation of C++ function trans_getMolarFluxes."); % Modify help description values as needed.
%defineArgument(trans_getMolarFluxesDefinition, "n", "int32");
%defineArgument(trans_getMolarFluxesDefinition, "state1", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(trans_getMolarFluxesDefinition, "state2", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(trans_getMolarFluxesDefinition, "delta", "double");
%defineArgument(trans_getMolarFluxesDefinition, "fluxes", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getMolarFluxesDefinition, "RetVal", "int32");
%validate(trans_getMolarFluxesDefinition);

%% C++ function |trans_getMassFluxes| with MATLAB name |clib.ctMatlab.trans_getMassFluxes|
...
%    "MATLABName", "clib.ctMatlab.trans_getMassFluxes", ...
%    "Description", "clib.ctMatlab.trans_getMassFluxes Representation of C++ function trans_getMassFluxes."); % Modify help description values as needed.
%defineArgument(trans_getMassFluxesDefinition, "n", "int32");
%defineArgument(trans_getMassFluxesDefinition, "state1", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(trans_getMassFluxesDefinition, "state2", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(trans_getMassFluxesDefinition, "delta", "double");
%defineArgument(trans_getMassFluxesDefinition, "fluxes", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(trans_getMassFluxesDefinition, "RetVal", "int32");
%validate(trans_getMassFluxesDefinition);

%% C++ function |ct_getCanteraError| with MATLAB name |clib.ctMatlab.ct_getCanteraError|
...
%    "MATLABName", "clib.ctMatlab.ct_getCanteraError", ...
%    "Description", "clib.ctMatlab.ct_getCanteraError Representation of C++ function ct_getCanteraError."); % Modify help description values as needed.
%defineArgument(ct_getCanteraErrorDefinition, "buflen", "int32");
%defineArgument(ct_getCanteraErrorDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(ct_getCanteraErrorDefinition, "RetVal", "int32");
%validate(ct_getCanteraErrorDefinition);

%% C++ function |ct_setLogWriter| with MATLAB name |clib.ctMatlab.ct_setLogWriter|
% C++ Signature: int ct_setLogWriter(void * logger)

%ct_setLogWriterDefinition = addFunction(libDef, ...
%    "int ct_setLogWriter(void * logger)", ...
%    "MATLABName", "clib.ctMatlab.ct_setLogWriter", ...
%    "Description", "clib.ctMatlab.ct_setLogWriter Representation of C++ function ct_setLogWriter."); % Modify help description values as needed.
...
%% C++ function |ct_setLogCallback| with MATLAB name |clib.ctMatlab.ct_setLogCallback|
...
ct_setLogCallbackDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.ct_setLogCallback", ...
    "Description", "clib.ctMatlab.ct_setLogCallback Representation of C++ function ct_setLogCallback."); % Modify help description values as needed.
defineArgument(ct_setLogCallbackDefinition, "writer", "clib.ctMatlab.LogCallback");
defineOutput(ct_setLogCallbackDefinition, "RetVal", "int32");
validate(ct_setLogCallbackDefinition);

%% C++ function |ct_addCanteraDirectory| with MATLAB name |clib.ctMatlab.ct_addCanteraDirectory|
...
ct_addCanteraDirectoryDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.ct_addCanteraDirectory", ...
    "Description", "clib.ctMatlab.ct_addCanteraDirectory Representation of C++ function ct_addCanteraDirectory."); % Modify help description values as needed.
...
%% C++ function |ct_getDataDirectories| with MATLAB name |clib.ctMatlab.ct_getDataDirectories|
...
%    "MATLABName", "clib.ctMatlab.ct_getDataDirectories", ...
%    "Description", "clib.ctMatlab.ct_getDataDirectories Representation of C++ function ct_getDataDirectories."); % Modify help description values as needed.
...
%defineArgument(ct_getDataDirectoriesDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(ct_getDataDirectoriesDefinition, "RetVal", "int32");
%validate(ct_getDataDirectoriesDefinition);

%% C++ function |ct_getCanteraVersion| with MATLAB name |clib.ctMatlab.ct_getCanteraVersion|
...
%    "MATLABName", "clib.ctMatlab.ct_getCanteraVersion", ...
%    "Description", "clib.ctMatlab.ct_getCanteraVersion Representation of C++ function ct_getCanteraVersion."); % Modify help description values as needed.
%defineArgument(ct_getCanteraVersionDefinition, "buflen", "int32");
%defineArgument(ct_getCanteraVersionDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(ct_getCanteraVersionDefinition, "RetVal", "int32");
%validate(ct_getCanteraVersionDefinition);

%% C++ function |ct_getGitCommit| with MATLAB name |clib.ctMatlab.ct_getGitCommit|
...
%    "MATLABName", "clib.ctMatlab.ct_getGitCommit", ...
%    "Description", "clib.ctMatlab.ct_getGitCommit Representation of C++ function ct_getGitCommit."); % Modify help description values as needed.
%defineArgument(ct_getGitCommitDefinition, "buflen", "int32");
%defineArgument(ct_getGitCommitDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(ct_getGitCommitDefinition, "RetVal", "int32");
%validate(ct_getGitCommitDefinition);

%% C++ function |ct_suppress_thermo_warnings| with MATLAB name |clib.ctMatlab.ct_suppress_thermo_warnings|
...
ct_suppress_thermo_warningsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.ct_suppress_thermo_warnings", ...
    "Description", "clib.ctMatlab.ct_suppress_thermo_warnings Representation of C++ function ct_suppress_thermo_warnings."); % Modify help description values as needed.
...
%% C++ function |ct_use_legacy_rate_constants| with MATLAB name |clib.ctMatlab.ct_use_legacy_rate_constants|
...
ct_use_legacy_rate_constantsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.ct_use_legacy_rate_constants", ...
    "Description", "clib.ctMatlab.ct_use_legacy_rate_constants Representation of C++ function ct_use_legacy_rate_constants."); % Modify help description values as needed.
...
%% C++ function |ct_clearStorage| with MATLAB name |clib.ctMatlab.ct_clearStorage|
% C++ Signature: int ct_clearStorage()

ct_clearStorageDefinition = addFunction(libDef, ...
    "int ct_clearStorage()", ...
    "MATLABName", "clib.ctMatlab.ct_clearStorage", ...
    "Description", "clib.ctMatlab.ct_clearStorage Representation of C++ function ct_clearStorage."); % Modify help description values as needed.
defineOutput(ct_clearStorageDefinition, "RetVal", "int32");
validate(ct_clearStorageDefinition);

%% C++ function |ct_resetStorage| with MATLAB name |clib.ctMatlab.ct_resetStorage|
% C++ Signature: int ct_resetStorage()

ct_resetStorageDefinition = addFunction(libDef, ...
    "int ct_resetStorage()", ...
    "MATLABName", "clib.ctMatlab.ct_resetStorage", ...
    "Description", "clib.ctMatlab.ct_resetStorage Representation of C++ function ct_resetStorage."); % Modify help description values as needed.
defineOutput(ct_resetStorageDefinition, "RetVal", "int32");
validate(ct_resetStorageDefinition);

%% C++ function |func_check| with MATLAB name |clib.ctMatlab.func_check|
...
%    "MATLABName", "clib.ctMatlab.func_check", ...
%    "Description", "clib.ctMatlab.func_check Representation of C++ function func_check." + newline + ...
...
%defineArgument(func_checkDefinition, "buf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(func_checkDefinition, "RetVal", "int32");
%validate(func_checkDefinition);

%% C++ function |func_new_basic| with MATLAB name |clib.ctMatlab.func_new_basic|
...
func_new_basicDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.func_new_basic", ...
    "Description", "clib.ctMatlab.func_new_basic Representation of C++ function func_new_basic."); % Modify help description values as needed.
...
%% C++ function |func_new_advanced| with MATLAB name |clib.ctMatlab.func_new_advanced|
...
%    "MATLABName", "clib.ctMatlab.func_new_advanced", ...
%    "Description", "clib.ctMatlab.func_new_advanced Representation of C++ function func_new_advanced."); % Modify help description values as needed.
...
%defineArgument(func_new_advancedDefinition, "p", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(func_new_advancedDefinition, "RetVal", "int32");
%validate(func_new_advancedDefinition);

%% C++ function |func_new_compound| with MATLAB name |clib.ctMatlab.func_new_compound|
...
func_new_compoundDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.func_new_compound", ...
    "Description", "clib.ctMatlab.func_new_compound Representation of C++ function func_new_compound."); % Modify help description values as needed.
...
%% C++ function |func_new_modified| with MATLAB name |clib.ctMatlab.func_new_modified|
...
func_new_modifiedDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.func_new_modified", ...
    "Description", "clib.ctMatlab.func_new_modified Representation of C++ function func_new_modified."); % Modify help description values as needed.
...
%% C++ function |func_new_sum| with MATLAB name |clib.ctMatlab.func_new_sum|
% C++ Signature: int func_new_sum(int a,int b)

func_new_sumDefinition = addFunction(libDef, ...
    "int func_new_sum(int a,int b)", ...
    "MATLABName", "clib.ctMatlab.func_new_sum", ...
    "Description", "clib.ctMatlab.func_new_sum Representation of C++ function func_new_sum."); % Modify help description values as needed.
...
%% C++ function |func_new_diff| with MATLAB name |clib.ctMatlab.func_new_diff|
% C++ Signature: int func_new_diff(int a,int b)

func_new_diffDefinition = addFunction(libDef, ...
    "int func_new_diff(int a,int b)", ...
    "MATLABName", "clib.ctMatlab.func_new_diff", ...
    "Description", "clib.ctMatlab.func_new_diff Representation of C++ function func_new_diff."); % Modify help description values as needed.
...
%% C++ function |func_new_prod| with MATLAB name |clib.ctMatlab.func_new_prod|
% C++ Signature: int func_new_prod(int a,int b)

func_new_prodDefinition = addFunction(libDef, ...
    "int func_new_prod(int a,int b)", ...
    "MATLABName", "clib.ctMatlab.func_new_prod", ...
    "Description", "clib.ctMatlab.func_new_prod Representation of C++ function func_new_prod."); % Modify help description values as needed.
...
%% C++ function |func_new_ratio| with MATLAB name |clib.ctMatlab.func_new_ratio|
% C++ Signature: int func_new_ratio(int a,int b)

func_new_ratioDefinition = addFunction(libDef, ...
    "int func_new_ratio(int a,int b)", ...
    "MATLABName", "clib.ctMatlab.func_new_ratio", ...
    "Description", "clib.ctMatlab.func_new_ratio Representation of C++ function func_new_ratio."); % Modify help description values as needed.
...
%% C++ function |func_del| with MATLAB name |clib.ctMatlab.func_del|
% C++ Signature: int func_del(int i)

func_delDefinition = addFunction(libDef, ...
    "int func_del(int i)", ...
    "MATLABName", "clib.ctMatlab.func_del", ...
    "Description", "clib.ctMatlab.func_del Representation of C++ function func_del."); % Modify help description values as needed.
defineArgument(func_delDefinition, "i", "int32");
defineOutput(func_delDefinition, "RetVal", "int32");
validate(func_delDefinition);

%% C++ function |func_type| with MATLAB name |clib.ctMatlab.func_type|
...
%    "MATLABName", "clib.ctMatlab.func_type", ...
%    "Description", "clib.ctMatlab.func_type Representation of C++ function func_type."); % Modify help description values as needed.
%defineArgument(func_typeDefinition, "i", "int32");
%defineArgument(func_typeDefinition, "lennm", "uint64");
%defineArgument(func_typeDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(func_typeDefinition, "RetVal", "int32");
%validate(func_typeDefinition);

%% C++ function |func_value| with MATLAB name |clib.ctMatlab.func_value|
% C++ Signature: double func_value(int i,double t)

func_valueDefinition = addFunction(libDef, ...
    "double func_value(int i,double t)", ...
    "MATLABName", "clib.ctMatlab.func_value", ...
    "Description", "clib.ctMatlab.func_value Representation of C++ function func_value."); % Modify help description values as needed.
...
%% C++ function |func_derivative| with MATLAB name |clib.ctMatlab.func_derivative|
% C++ Signature: int func_derivative(int i)

func_derivativeDefinition = addFunction(libDef, ...
    "int func_derivative(int i)", ...
    "MATLABName", "clib.ctMatlab.func_derivative", ...
    "Description", "clib.ctMatlab.func_derivative Representation of C++ function func_derivative."); % Modify help description values as needed.
...
%% C++ function |func_duplicate| with MATLAB name |clib.ctMatlab.func_duplicate|
% C++ Signature: int func_duplicate(int i)

func_duplicateDefinition = addFunction(libDef, ...
    "int func_duplicate(int i)", ...
    "MATLABName", "clib.ctMatlab.func_duplicate", ...
    "Description", "clib.ctMatlab.func_duplicate Representation of C++ function func_duplicate."); % Modify help description values as needed.
...
%% C++ function |func_write| with MATLAB name |clib.ctMatlab.func_write|
...
%    "MATLABName", "clib.ctMatlab.func_write", ...
%    "Description", "clib.ctMatlab.func_write Representation of C++ function func_write."); % Modify help description values as needed.
...
%defineArgument(func_writeDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(func_writeDefinition, "RetVal", "int32");
%validate(func_writeDefinition);

%% C++ function |ct_clearFunc| with MATLAB name |clib.ctMatlab.ct_clearFunc|
% C++ Signature: int ct_clearFunc()

ct_clearFuncDefinition = addFunction(libDef, ...
    "int ct_clearFunc()", ...
    "MATLABName", "clib.ctMatlab.ct_clearFunc", ...
    "Description", "clib.ctMatlab.ct_clearFunc Representation of C++ function ct_clearFunc."); % Modify help description values as needed.
defineOutput(ct_clearFuncDefinition, "RetVal", "int32");
validate(ct_clearFuncDefinition);

%% C++ function |mix_new| with MATLAB name |clib.ctMatlab.mix_new|
% C++ Signature: int mix_new()

mix_newDefinition = addFunction(libDef, ...
    "int mix_new()", ...
    "MATLABName", "clib.ctMatlab.mix_new", ...
    "Description", "clib.ctMatlab.mix_new Representation of C++ function mix_new."); % Modify help description values as needed.
defineOutput(mix_newDefinition, "RetVal", "int32");
validate(mix_newDefinition);

%% C++ function |mix_del| with MATLAB name |clib.ctMatlab.mix_del|
% C++ Signature: int mix_del(int i)

mix_delDefinition = addFunction(libDef, ...
    "int mix_del(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_del", ...
    "Description", "clib.ctMatlab.mix_del Representation of C++ function mix_del."); % Modify help description values as needed.
defineArgument(mix_delDefinition, "i", "int32");
defineOutput(mix_delDefinition, "RetVal", "int32");
validate(mix_delDefinition);

%% C++ function |ct_clearMix| with MATLAB name |clib.ctMatlab.ct_clearMix|
% C++ Signature: int ct_clearMix()

ct_clearMixDefinition = addFunction(libDef, ...
    "int ct_clearMix()", ...
    "MATLABName", "clib.ctMatlab.ct_clearMix", ...
    "Description", "clib.ctMatlab.ct_clearMix Representation of C++ function ct_clearMix."); % Modify help description values as needed.
defineOutput(ct_clearMixDefinition, "RetVal", "int32");
validate(ct_clearMixDefinition);

%% C++ function |mix_addPhase| with MATLAB name |clib.ctMatlab.mix_addPhase|
...
mix_addPhaseDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_addPhase", ...
    "Description", "clib.ctMatlab.mix_addPhase Representation of C++ function mix_addPhase."); % Modify help description values as needed.
...
%% C++ function |mix_init| with MATLAB name |clib.ctMatlab.mix_init|
% C++ Signature: int mix_init(int i)

mix_initDefinition = addFunction(libDef, ...
    "int mix_init(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_init", ...
    "Description", "clib.ctMatlab.mix_init Representation of C++ function mix_init."); % Modify help description values as needed.
defineArgument(mix_initDefinition, "i", "int32");
defineOutput(mix_initDefinition, "RetVal", "int32");
validate(mix_initDefinition);

%% C++ function |mix_updatePhases| with MATLAB name |clib.ctMatlab.mix_updatePhases|
% C++ Signature: int mix_updatePhases(int i)

mix_updatePhasesDefinition = addFunction(libDef, ...
    "int mix_updatePhases(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_updatePhases", ...
    "Description", "clib.ctMatlab.mix_updatePhases Representation of C++ function mix_updatePhases."); % Modify help description values as needed.
...
%% C++ function |mix_nElements| with MATLAB name |clib.ctMatlab.mix_nElements|
% C++ Signature: size_t mix_nElements(int i)

mix_nElementsDefinition = addFunction(libDef, ...
    "size_t mix_nElements(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_nElements", ...
    "Description", "clib.ctMatlab.mix_nElements Representation of C++ function mix_nElements."); % Modify help description values as needed.
...
%% C++ function |mix_elementIndex| with MATLAB name |clib.ctMatlab.mix_elementIndex|
...
mix_elementIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_elementIndex", ...
    "Description", "clib.ctMatlab.mix_elementIndex Representation of C++ function mix_elementIndex."); % Modify help description values as needed.
...
%% C++ function |mix_speciesIndex| with MATLAB name |clib.ctMatlab.mix_speciesIndex|
...
mix_speciesIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_speciesIndex", ...
    "Description", "clib.ctMatlab.mix_speciesIndex Representation of C++ function mix_speciesIndex."); % Modify help description values as needed.
...
%% C++ function |mix_nSpecies| with MATLAB name |clib.ctMatlab.mix_nSpecies|
% C++ Signature: size_t mix_nSpecies(int i)

mix_nSpeciesDefinition = addFunction(libDef, ...
    "size_t mix_nSpecies(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_nSpecies", ...
    "Description", "clib.ctMatlab.mix_nSpecies Representation of C++ function mix_nSpecies."); % Modify help description values as needed.
...
%% C++ function |mix_setTemperature| with MATLAB name |clib.ctMatlab.mix_setTemperature|
...
mix_setTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_setTemperature", ...
    "Description", "clib.ctMatlab.mix_setTemperature Representation of C++ function mix_setTemperature."); % Modify help description values as needed.
...
%% C++ function |mix_temperature| with MATLAB name |clib.ctMatlab.mix_temperature|
% C++ Signature: double mix_temperature(int i)

mix_temperatureDefinition = addFunction(libDef, ...
    "double mix_temperature(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_temperature", ...
    "Description", "clib.ctMatlab.mix_temperature Representation of C++ function mix_temperature."); % Modify help description values as needed.
...
%% C++ function |mix_minTemp| with MATLAB name |clib.ctMatlab.mix_minTemp|
% C++ Signature: double mix_minTemp(int i)

mix_minTempDefinition = addFunction(libDef, ...
    "double mix_minTemp(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_minTemp", ...
    "Description", "clib.ctMatlab.mix_minTemp Representation of C++ function mix_minTemp."); % Modify help description values as needed.
...
%% C++ function |mix_maxTemp| with MATLAB name |clib.ctMatlab.mix_maxTemp|
% C++ Signature: double mix_maxTemp(int i)

mix_maxTempDefinition = addFunction(libDef, ...
    "double mix_maxTemp(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_maxTemp", ...
    "Description", "clib.ctMatlab.mix_maxTemp Representation of C++ function mix_maxTemp."); % Modify help description values as needed.
...
%% C++ function |mix_charge| with MATLAB name |clib.ctMatlab.mix_charge|
% C++ Signature: double mix_charge(int i)

mix_chargeDefinition = addFunction(libDef, ...
    "double mix_charge(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_charge", ...
    "Description", "clib.ctMatlab.mix_charge Representation of C++ function mix_charge."); % Modify help description values as needed.
defineArgument(mix_chargeDefinition, "i", "int32");
defineOutput(mix_chargeDefinition, "RetVal", "double");
validate(mix_chargeDefinition);

%% C++ function |mix_phaseCharge| with MATLAB name |clib.ctMatlab.mix_phaseCharge|
...
mix_phaseChargeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_phaseCharge", ...
    "Description", "clib.ctMatlab.mix_phaseCharge Representation of C++ function mix_phaseCharge."); % Modify help description values as needed.
...
%% C++ function |mix_setPressure| with MATLAB name |clib.ctMatlab.mix_setPressure|
...
mix_setPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_setPressure", ...
    "Description", "clib.ctMatlab.mix_setPressure Representation of C++ function mix_setPressure."); % Modify help description values as needed.
...
%% C++ function |mix_pressure| with MATLAB name |clib.ctMatlab.mix_pressure|
% C++ Signature: double mix_pressure(int i)

mix_pressureDefinition = addFunction(libDef, ...
    "double mix_pressure(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_pressure", ...
    "Description", "clib.ctMatlab.mix_pressure Representation of C++ function mix_pressure."); % Modify help description values as needed.
...
%% C++ function |mix_nAtoms| with MATLAB name |clib.ctMatlab.mix_nAtoms|
...
mix_nAtomsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_nAtoms", ...
    "Description", "clib.ctMatlab.mix_nAtoms Representation of C++ function mix_nAtoms."); % Modify help description values as needed.
...
%% C++ function |mix_nPhases| with MATLAB name |clib.ctMatlab.mix_nPhases|
% C++ Signature: size_t mix_nPhases(int i)

mix_nPhasesDefinition = addFunction(libDef, ...
    "size_t mix_nPhases(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_nPhases", ...
    "Description", "clib.ctMatlab.mix_nPhases Representation of C++ function mix_nPhases."); % Modify help description values as needed.
...
%% C++ function |mix_phaseMoles| with MATLAB name |clib.ctMatlab.mix_phaseMoles|
...
mix_phaseMolesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_phaseMoles", ...
    "Description", "clib.ctMatlab.mix_phaseMoles Representation of C++ function mix_phaseMoles."); % Modify help description values as needed.
...
%% C++ function |mix_setPhaseMoles| with MATLAB name |clib.ctMatlab.mix_setPhaseMoles|
...
mix_setPhaseMolesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_setPhaseMoles", ...
    "Description", "clib.ctMatlab.mix_setPhaseMoles Representation of C++ function mix_setPhaseMoles."); % Modify help description values as needed.
...
%% C++ function |mix_setMoles| with MATLAB name |clib.ctMatlab.mix_setMoles|
...
%    "MATLABName", "clib.ctMatlab.mix_setMoles", ...
%    "Description", "clib.ctMatlab.mix_setMoles Representation of C++ function mix_setMoles."); % Modify help description values as needed.
%defineArgument(mix_setMolesDefinition, "i", "int32");
%defineArgument(mix_setMolesDefinition, "nlen", "uint64");
%defineArgument(mix_setMolesDefinition, "n", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(mix_setMolesDefinition, "RetVal", "int32");
%validate(mix_setMolesDefinition);

%% C++ function |mix_setMolesByName| with MATLAB name |clib.ctMatlab.mix_setMolesByName|
...
mix_setMolesByNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_setMolesByName", ...
    "Description", "clib.ctMatlab.mix_setMolesByName Representation of C++ function mix_setMolesByName."); % Modify help description values as needed.
...
%% C++ function |mix_speciesMoles| with MATLAB name |clib.ctMatlab.mix_speciesMoles|
...
mix_speciesMolesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_speciesMoles", ...
    "Description", "clib.ctMatlab.mix_speciesMoles Representation of C++ function mix_speciesMoles."); % Modify help description values as needed.
...
%% C++ function |mix_elementMoles| with MATLAB name |clib.ctMatlab.mix_elementMoles|
...
mix_elementMolesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_elementMoles", ...
    "Description", "clib.ctMatlab.mix_elementMoles Representation of C++ function mix_elementMoles."); % Modify help description values as needed.
...
%% C++ function |mix_equilibrate| with MATLAB name |clib.ctMatlab.mix_equilibrate|
...
mix_equilibrateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_equilibrate", ...
    "Description", "clib.ctMatlab.mix_equilibrate Representation of C++ function mix_equilibrate."); % Modify help description values as needed.
...
%% C++ function |mix_getChemPotentials| with MATLAB name |clib.ctMatlab.mix_getChemPotentials|
...
%    "MATLABName", "clib.ctMatlab.mix_getChemPotentials", ...
%    "Description", "clib.ctMatlab.mix_getChemPotentials Representation of C++ function mix_getChemPotentials."); % Modify help description values as needed.
%defineArgument(mix_getChemPotentialsDefinition, "i", "int32");
%defineArgument(mix_getChemPotentialsDefinition, "lenmu", "uint64");
%defineArgument(mix_getChemPotentialsDefinition, "mu", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(mix_getChemPotentialsDefinition, "RetVal", "int32");
%validate(mix_getChemPotentialsDefinition);

%% C++ function |mix_enthalpy| with MATLAB name |clib.ctMatlab.mix_enthalpy|
% C++ Signature: double mix_enthalpy(int i)

mix_enthalpyDefinition = addFunction(libDef, ...
    "double mix_enthalpy(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_enthalpy", ...
    "Description", "clib.ctMatlab.mix_enthalpy Representation of C++ function mix_enthalpy."); % Modify help description values as needed.
...
%% C++ function |mix_entropy| with MATLAB name |clib.ctMatlab.mix_entropy|
% C++ Signature: double mix_entropy(int i)

mix_entropyDefinition = addFunction(libDef, ...
    "double mix_entropy(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_entropy", ...
    "Description", "clib.ctMatlab.mix_entropy Representation of C++ function mix_entropy."); % Modify help description values as needed.
...
%% C++ function |mix_gibbs| with MATLAB name |clib.ctMatlab.mix_gibbs|
% C++ Signature: double mix_gibbs(int i)

mix_gibbsDefinition = addFunction(libDef, ...
    "double mix_gibbs(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_gibbs", ...
    "Description", "clib.ctMatlab.mix_gibbs Representation of C++ function mix_gibbs."); % Modify help description values as needed.
defineArgument(mix_gibbsDefinition, "i", "int32");
defineOutput(mix_gibbsDefinition, "RetVal", "double");
validate(mix_gibbsDefinition);

%% C++ function |mix_cp| with MATLAB name |clib.ctMatlab.mix_cp|
% C++ Signature: double mix_cp(int i)

mix_cpDefinition = addFunction(libDef, ...
    "double mix_cp(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_cp", ...
    "Description", "clib.ctMatlab.mix_cp Representation of C++ function mix_cp."); % Modify help description values as needed.
defineArgument(mix_cpDefinition, "i", "int32");
defineOutput(mix_cpDefinition, "RetVal", "double");
validate(mix_cpDefinition);

%% C++ function |mix_volume| with MATLAB name |clib.ctMatlab.mix_volume|
% C++ Signature: double mix_volume(int i)

mix_volumeDefinition = addFunction(libDef, ...
    "double mix_volume(int i)", ...
    "MATLABName", "clib.ctMatlab.mix_volume", ...
    "Description", "clib.ctMatlab.mix_volume Representation of C++ function mix_volume."); % Modify help description values as needed.
defineArgument(mix_volumeDefinition, "i", "int32");
defineOutput(mix_volumeDefinition, "RetVal", "double");
validate(mix_volumeDefinition);

%% C++ function |mix_speciesPhaseIndex| with MATLAB name |clib.ctMatlab.mix_speciesPhaseIndex|
...
mix_speciesPhaseIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_speciesPhaseIndex", ...
    "Description", "clib.ctMatlab.mix_speciesPhaseIndex Representation of C++ function mix_speciesPhaseIndex."); % Modify help description values as needed.
...
%% C++ function |mix_moleFraction| with MATLAB name |clib.ctMatlab.mix_moleFraction|
...
mix_moleFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.mix_moleFraction", ...
    "Description", "clib.ctMatlab.mix_moleFraction Representation of C++ function mix_moleFraction."); % Modify help description values as needed.
...
%% C++ function |ct_clearOneDim| with MATLAB name |clib.ctMatlab.ct_clearOneDim|
% C++ Signature: int ct_clearOneDim()

ct_clearOneDimDefinition = addFunction(libDef, ...
    "int ct_clearOneDim()", ...
    "MATLABName", "clib.ctMatlab.ct_clearOneDim", ...
    "Description", "clib.ctMatlab.ct_clearOneDim Representation of C++ function ct_clearOneDim."); % Modify help description values as needed.
defineOutput(ct_clearOneDimDefinition, "RetVal", "int32");
validate(ct_clearOneDimDefinition);

%% C++ function |domain_new| with MATLAB name |clib.ctMatlab.domain_new|
...
domain_newDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_new", ...
    "Description", "clib.ctMatlab.domain_new Representation of C++ function domain_new."); % Modify help description values as needed.
...
%% C++ function |domain_del| with MATLAB name |clib.ctMatlab.domain_del|
% C++ Signature: int domain_del(int i)

domain_delDefinition = addFunction(libDef, ...
    "int domain_del(int i)", ...
    "MATLABName", "clib.ctMatlab.domain_del", ...
    "Description", "clib.ctMatlab.domain_del Representation of C++ function domain_del."); % Modify help description values as needed.
defineArgument(domain_delDefinition, "i", "int32");
defineOutput(domain_delDefinition, "RetVal", "int32");
validate(domain_delDefinition);

%% C++ function |domain_type| with MATLAB name |clib.ctMatlab.domain_type|
...
%    "MATLABName", "clib.ctMatlab.domain_type", ...
%    "Description", "clib.ctMatlab.domain_type Representation of C++ function domain_type."); % Modify help description values as needed.
%defineArgument(domain_typeDefinition, "i", "int32");
%defineArgument(domain_typeDefinition, "lennm", "uint64");
%defineArgument(domain_typeDefinition, "nm", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(domain_typeDefinition, "RetVal", "int32");
%validate(domain_typeDefinition);

%% C++ function |domain_index| with MATLAB name |clib.ctMatlab.domain_index|
% C++ Signature: size_t domain_index(int i)

domain_indexDefinition = addFunction(libDef, ...
    "size_t domain_index(int i)", ...
    "MATLABName", "clib.ctMatlab.domain_index", ...
    "Description", "clib.ctMatlab.domain_index Representation of C++ function domain_index."); % Modify help description values as needed.
...
%% C++ function |domain_nComponents| with MATLAB name |clib.ctMatlab.domain_nComponents|
...
domain_nComponentsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_nComponents", ...
    "Description", "clib.ctMatlab.domain_nComponents Representation of C++ function domain_nComponents."); % Modify help description values as needed.
...
%% C++ function |domain_nPoints| with MATLAB name |clib.ctMatlab.domain_nPoints|
% C++ Signature: size_t domain_nPoints(int i)

domain_nPointsDefinition = addFunction(libDef, ...
    "size_t domain_nPoints(int i)", ...
    "MATLABName", "clib.ctMatlab.domain_nPoints", ...
    "Description", "clib.ctMatlab.domain_nPoints Representation of C++ function domain_nPoints."); % Modify help description values as needed.
...
%% C++ function |domain_componentName| with MATLAB name |clib.ctMatlab.domain_componentName|
...
%    "MATLABName", "clib.ctMatlab.domain_componentName", ...
%    "Description", "clib.ctMatlab.domain_componentName Representation of C++ function domain_componentName."); % Modify help description values as needed.
...
%defineArgument(domain_componentNameDefinition, "nameout", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(domain_componentNameDefinition, "RetVal", "int32");
%validate(domain_componentNameDefinition);

%% C++ function |domain_componentIndex| with MATLAB name |clib.ctMatlab.domain_componentIndex|
...
domain_componentIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_componentIndex", ...
    "Description", "clib.ctMatlab.domain_componentIndex Representation of C++ function domain_componentIndex."); % Modify help description values as needed.
...
%% C++ function |domain_setBounds| with MATLAB name |clib.ctMatlab.domain_setBounds|
...
domain_setBoundsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_setBounds", ...
    "Description", "clib.ctMatlab.domain_setBounds Representation of C++ function domain_setBounds."); % Modify help description values as needed.
...
%% C++ function |domain_lowerBound| with MATLAB name |clib.ctMatlab.domain_lowerBound|
...
domain_lowerBoundDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_lowerBound", ...
    "Description", "clib.ctMatlab.domain_lowerBound Representation of C++ function domain_lowerBound."); % Modify help description values as needed.
...
%% C++ function |domain_upperBound| with MATLAB name |clib.ctMatlab.domain_upperBound|
...
domain_upperBoundDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_upperBound", ...
    "Description", "clib.ctMatlab.domain_upperBound Representation of C++ function domain_upperBound."); % Modify help description values as needed.
...
%% C++ function |domain_setSteadyTolerances| with MATLAB name |clib.ctMatlab.domain_setSteadyTolerances|
...
domain_setSteadyTolerancesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_setSteadyTolerances", ...
    "Description", "clib.ctMatlab.domain_setSteadyTolerances Representation of C++ function domain_setSteadyTolerances."); % Modify help description values as needed.
...
%% C++ function |domain_setTransientTolerances| with MATLAB name |clib.ctMatlab.domain_setTransientTolerances|
...
domain_setTransientTolerancesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_setTransientTolerances", ...
    "Description", "clib.ctMatlab.domain_setTransientTolerances Representation of C++ function domain_setTransientTolerances."); % Modify help description values as needed.
...
%% C++ function |domain_rtol| with MATLAB name |clib.ctMatlab.domain_rtol|
% C++ Signature: double domain_rtol(int i,int n)

domain_rtolDefinition = addFunction(libDef, ...
    "double domain_rtol(int i,int n)", ...
    "MATLABName", "clib.ctMatlab.domain_rtol", ...
    "Description", "clib.ctMatlab.domain_rtol Representation of C++ function domain_rtol."); % Modify help description values as needed.
...
%% C++ function |domain_atol| with MATLAB name |clib.ctMatlab.domain_atol|
% C++ Signature: double domain_atol(int i,int n)

domain_atolDefinition = addFunction(libDef, ...
    "double domain_atol(int i,int n)", ...
    "MATLABName", "clib.ctMatlab.domain_atol", ...
    "Description", "clib.ctMatlab.domain_atol Representation of C++ function domain_atol."); % Modify help description values as needed.
...
%% C++ function |domain_setupGrid| with MATLAB name |clib.ctMatlab.domain_setupGrid|
...
%    "MATLABName", "clib.ctMatlab.domain_setupGrid", ...
%    "Description", "clib.ctMatlab.domain_setupGrid Representation of C++ function domain_setupGrid."); % Modify help description values as needed.
%defineArgument(domain_setupGridDefinition, "i", "int32");
%defineArgument(domain_setupGridDefinition, "npts", "uint64");
%defineArgument(domain_setupGridDefinition, "grid", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(domain_setupGridDefinition, "RetVal", "int32");
%validate(domain_setupGridDefinition);

%% C++ function |domain_setID| with MATLAB name |clib.ctMatlab.domain_setID|
...
domain_setIDDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.domain_setID", ...
    "Description", "clib.ctMatlab.domain_setID Representation of C++ function domain_setID."); % Modify help description values as needed.
...
%% C++ function |domain_grid| with MATLAB name |clib.ctMatlab.domain_grid|
% C++ Signature: double domain_grid(int i,int n)

domain_gridDefinition = addFunction(libDef, ...
    "double domain_grid(int i,int n)", ...
    "MATLABName", "clib.ctMatlab.domain_grid", ...
    "Description", "clib.ctMatlab.domain_grid Representation of C++ function domain_grid."); % Modify help description values as needed.
...
%% C++ function |bdry_setMdot| with MATLAB name |clib.ctMatlab.bdry_setMdot|
...
bdry_setMdotDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.bdry_setMdot", ...
    "Description", "clib.ctMatlab.bdry_setMdot Representation of C++ function bdry_setMdot."); % Modify help description values as needed.
...
%% C++ function |bdry_setTemperature| with MATLAB name |clib.ctMatlab.bdry_setTemperature|
...
bdry_setTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.bdry_setTemperature", ...
    "Description", "clib.ctMatlab.bdry_setTemperature Representation of C++ function bdry_setTemperature."); % Modify help description values as needed.
...
%% C++ function |bdry_setSpreadRate| with MATLAB name |clib.ctMatlab.bdry_setSpreadRate|
...
bdry_setSpreadRateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.bdry_setSpreadRate", ...
    "Description", "clib.ctMatlab.bdry_setSpreadRate Representation of C++ function bdry_setSpreadRate."); % Modify help description values as needed.
...
%% C++ function |bdry_setMoleFractions| with MATLAB name |clib.ctMatlab.bdry_setMoleFractions|
...
bdry_setMoleFractionsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.bdry_setMoleFractions", ...
    "Description", "clib.ctMatlab.bdry_setMoleFractions Representation of C++ function bdry_setMoleFractions."); % Modify help description values as needed.
...
%% C++ function |bdry_temperature| with MATLAB name |clib.ctMatlab.bdry_temperature|
% C++ Signature: double bdry_temperature(int i)

bdry_temperatureDefinition = addFunction(libDef, ...
    "double bdry_temperature(int i)", ...
    "MATLABName", "clib.ctMatlab.bdry_temperature", ...
    "Description", "clib.ctMatlab.bdry_temperature Representation of C++ function bdry_temperature."); % Modify help description values as needed.
...
%% C++ function |bdry_spreadRate| with MATLAB name |clib.ctMatlab.bdry_spreadRate|
% C++ Signature: double bdry_spreadRate(int i)

bdry_spreadRateDefinition = addFunction(libDef, ...
    "double bdry_spreadRate(int i)", ...
    "MATLABName", "clib.ctMatlab.bdry_spreadRate", ...
    "Description", "clib.ctMatlab.bdry_spreadRate Representation of C++ function bdry_spreadRate."); % Modify help description values as needed.
...
%% C++ function |bdry_massFraction| with MATLAB name |clib.ctMatlab.bdry_massFraction|
...
bdry_massFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.bdry_massFraction", ...
    "Description", "clib.ctMatlab.bdry_massFraction Representation of C++ function bdry_massFraction."); % Modify help description values as needed.
...
%% C++ function |bdry_mdot| with MATLAB name |clib.ctMatlab.bdry_mdot|
% C++ Signature: double bdry_mdot(int i)

bdry_mdotDefinition = addFunction(libDef, ...
    "double bdry_mdot(int i)", ...
    "MATLABName", "clib.ctMatlab.bdry_mdot", ...
    "Description", "clib.ctMatlab.bdry_mdot Representation of C++ function bdry_mdot."); % Modify help description values as needed.
defineArgument(bdry_mdotDefinition, "i", "int32");
defineOutput(bdry_mdotDefinition, "RetVal", "double");
validate(bdry_mdotDefinition);

%% C++ function |reactingsurf_enableCoverageEqs| with MATLAB name |clib.ctMatlab.reactingsurf_enableCoverageEqs|
...
reactingsurf_enableCoverageEqsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactingsurf_enableCoverageEqs", ...
    "Description", "clib.ctMatlab.reactingsurf_enableCoverageEqs Representation of C++ function reactingsurf_enableCoverageEqs."); % Modify help description values as needed.
...
%% C++ function |flow1D_setTransport| with MATLAB name |clib.ctMatlab.flow1D_setTransport|
...
flow1D_setTransportDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flow1D_setTransport", ...
    "Description", "clib.ctMatlab.flow1D_setTransport Representation of C++ function flow1D_setTransport."); % Modify help description values as needed.
...
%% C++ function |flow1D_enableSoret| with MATLAB name |clib.ctMatlab.flow1D_enableSoret|
...
flow1D_enableSoretDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flow1D_enableSoret", ...
    "Description", "clib.ctMatlab.flow1D_enableSoret Representation of C++ function flow1D_enableSoret."); % Modify help description values as needed.
...
%% C++ function |flow1D_setPressure| with MATLAB name |clib.ctMatlab.flow1D_setPressure|
...
flow1D_setPressureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flow1D_setPressure", ...
    "Description", "clib.ctMatlab.flow1D_setPressure Representation of C++ function flow1D_setPressure."); % Modify help description values as needed.
...
%% C++ function |flow1D_pressure| with MATLAB name |clib.ctMatlab.flow1D_pressure|
% C++ Signature: double flow1D_pressure(int i)

flow1D_pressureDefinition = addFunction(libDef, ...
    "double flow1D_pressure(int i)", ...
    "MATLABName", "clib.ctMatlab.flow1D_pressure", ...
    "Description", "clib.ctMatlab.flow1D_pressure Representation of C++ function flow1D_pressure."); % Modify help description values as needed.
...
%% C++ function |flow1D_setFixedTempProfile| with MATLAB name |clib.ctMatlab.flow1D_setFixedTempProfile|
...
%    "MATLABName", "clib.ctMatlab.flow1D_setFixedTempProfile", ...
%    "Description", "clib.ctMatlab.flow1D_setFixedTempProfile Representation of C++ function flow1D_setFixedTempProfile."); % Modify help description values as needed.
%defineArgument(flow1D_setFixedTempProfileDefinition, "i", "int32");
%defineArgument(flow1D_setFixedTempProfileDefinition, "n", "uint64");
%defineArgument(flow1D_setFixedTempProfileDefinition, "pos", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(flow1D_setFixedTempProfileDefinition, "m", "uint64");
%defineArgument(flow1D_setFixedTempProfileDefinition, "temp", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(flow1D_setFixedTempProfileDefinition, "RetVal", "int32");
%validate(flow1D_setFixedTempProfileDefinition);

%% C++ function |flow1D_solveEnergyEqn| with MATLAB name |clib.ctMatlab.flow1D_solveEnergyEqn|
...
flow1D_solveEnergyEqnDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flow1D_solveEnergyEqn", ...
    "Description", "clib.ctMatlab.flow1D_solveEnergyEqn Representation of C++ function flow1D_solveEnergyEqn."); % Modify help description values as needed.
...
%% C++ function |sim1D_new| with MATLAB name |clib.ctMatlab.sim1D_new|
...
%    "MATLABName", "clib.ctMatlab.sim1D_new", ...
%    "Description", "clib.ctMatlab.sim1D_new Representation of C++ function sim1D_new."); % Modify help description values as needed.
%defineArgument(sim1D_newDefinition, "nd", "uint64");
%defineArgument(sim1D_newDefinition, "domains", "clib.array.ctMatlab.Int", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Int", or "int32"
%defineOutput(sim1D_newDefinition, "RetVal", "int32");
%validate(sim1D_newDefinition);

%% C++ function |sim1D_del| with MATLAB name |clib.ctMatlab.sim1D_del|
% C++ Signature: int sim1D_del(int i)

sim1D_delDefinition = addFunction(libDef, ...
    "int sim1D_del(int i)", ...
    "MATLABName", "clib.ctMatlab.sim1D_del", ...
    "Description", "clib.ctMatlab.sim1D_del Representation of C++ function sim1D_del."); % Modify help description values as needed.
defineArgument(sim1D_delDefinition, "i", "int32");
defineOutput(sim1D_delDefinition, "RetVal", "int32");
validate(sim1D_delDefinition);

%% C++ function |sim1D_setValue| with MATLAB name |clib.ctMatlab.sim1D_setValue|
...
sim1D_setValueDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setValue", ...
    "Description", "clib.ctMatlab.sim1D_setValue Representation of C++ function sim1D_setValue."); % Modify help description values as needed.
...
%% C++ function |sim1D_setProfile| with MATLAB name |clib.ctMatlab.sim1D_setProfile|
...
%    "MATLABName", "clib.ctMatlab.sim1D_setProfile", ...
%    "Description", "clib.ctMatlab.sim1D_setProfile Representation of C++ function sim1D_setProfile."); % Modify help description values as needed.
...
%defineArgument(sim1D_setProfileDefinition, "pos", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineArgument(sim1D_setProfileDefinition, "nv", "uint64");
%defineArgument(sim1D_setProfileDefinition, "v", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(sim1D_setProfileDefinition, "RetVal", "int32");
%validate(sim1D_setProfileDefinition);

%% C++ function |sim1D_setFlatProfile| with MATLAB name |clib.ctMatlab.sim1D_setFlatProfile|
...
sim1D_setFlatProfileDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setFlatProfile", ...
    "Description", "clib.ctMatlab.sim1D_setFlatProfile Representation of C++ function sim1D_setFlatProfile."); % Modify help description values as needed.
...
%% C++ function |sim1D_show| with MATLAB name |clib.ctMatlab.sim1D_show|
% C++ Signature: int sim1D_show(int i)

sim1D_showDefinition = addFunction(libDef, ...
    "int sim1D_show(int i)", ...
    "MATLABName", "clib.ctMatlab.sim1D_show", ...
    "Description", "clib.ctMatlab.sim1D_show Representation of C++ function sim1D_show."); % Modify help description values as needed.
defineArgument(sim1D_showDefinition, "i", "int32");
defineOutput(sim1D_showDefinition, "RetVal", "int32");
validate(sim1D_showDefinition);

%% C++ function |sim1D_setTimeStep| with MATLAB name |clib.ctMatlab.sim1D_setTimeStep|
...
%    "MATLABName", "clib.ctMatlab.sim1D_setTimeStep", ...
%    "Description", "clib.ctMatlab.sim1D_setTimeStep Representation of C++ function sim1D_setTimeStep."); % Modify help description values as needed.
...
%defineArgument(sim1D_setTimeStepDefinition, "nsteps", "clib.array.ctMatlab.Int", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Int", or "int32"
%defineOutput(sim1D_setTimeStepDefinition, "RetVal", "int32");
%validate(sim1D_setTimeStepDefinition);

%% C++ function |sim1D_getInitialSoln| with MATLAB name |clib.ctMatlab.sim1D_getInitialSoln|
...
sim1D_getInitialSolnDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_getInitialSoln", ...
    "Description", "clib.ctMatlab.sim1D_getInitialSoln Representation of C++ function sim1D_getInitialSoln."); % Modify help description values as needed.
...
%% C++ function |sim1D_solve| with MATLAB name |clib.ctMatlab.sim1D_solve|
...
sim1D_solveDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_solve", ...
    "Description", "clib.ctMatlab.sim1D_solve Representation of C++ function sim1D_solve."); % Modify help description values as needed.
...
%% C++ function |sim1D_refine| with MATLAB name |clib.ctMatlab.sim1D_refine|
...
sim1D_refineDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_refine", ...
    "Description", "clib.ctMatlab.sim1D_refine Representation of C++ function sim1D_refine."); % Modify help description values as needed.
...
%% C++ function |sim1D_setRefineCriteria| with MATLAB name |clib.ctMatlab.sim1D_setRefineCriteria|
...
sim1D_setRefineCriteriaDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setRefineCriteria", ...
    "Description", "clib.ctMatlab.sim1D_setRefineCriteria Representation of C++ function sim1D_setRefineCriteria."); % Modify help description values as needed.
...
%% C++ function |sim1D_setGridMin| with MATLAB name |clib.ctMatlab.sim1D_setGridMin|
...
sim1D_setGridMinDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setGridMin", ...
    "Description", "clib.ctMatlab.sim1D_setGridMin Representation of C++ function sim1D_setGridMin."); % Modify help description values as needed.
...
%% C++ function |sim1D_save| with MATLAB name |clib.ctMatlab.sim1D_save|
...
sim1D_saveDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_save", ...
    "Description", "clib.ctMatlab.sim1D_save Representation of C++ function sim1D_save."); % Modify help description values as needed.
...
%% C++ function |sim1D_restore| with MATLAB name |clib.ctMatlab.sim1D_restore|
...
sim1D_restoreDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_restore", ...
    "Description", "clib.ctMatlab.sim1D_restore Representation of C++ function sim1D_restore."); % Modify help description values as needed.
...
%% C++ function |sim1D_writeStats| with MATLAB name |clib.ctMatlab.sim1D_writeStats|
...
sim1D_writeStatsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_writeStats", ...
    "Description", "clib.ctMatlab.sim1D_writeStats Representation of C++ function sim1D_writeStats."); % Modify help description values as needed.
...
%% C++ function |sim1D_domainIndex| with MATLAB name |clib.ctMatlab.sim1D_domainIndex|
...
sim1D_domainIndexDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_domainIndex", ...
    "Description", "clib.ctMatlab.sim1D_domainIndex Representation of C++ function sim1D_domainIndex."); % Modify help description values as needed.
...
%% C++ function |sim1D_value| with MATLAB name |clib.ctMatlab.sim1D_value|
...
sim1D_valueDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_value", ...
    "Description", "clib.ctMatlab.sim1D_value Representation of C++ function sim1D_value."); % Modify help description values as needed.
...
%% C++ function |sim1D_workValue| with MATLAB name |clib.ctMatlab.sim1D_workValue|
...
sim1D_workValueDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_workValue", ...
    "Description", "clib.ctMatlab.sim1D_workValue Representation of C++ function sim1D_workValue."); % Modify help description values as needed.
...
%% C++ function |sim1D_eval| with MATLAB name |clib.ctMatlab.sim1D_eval|
...
sim1D_evalDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_eval", ...
    "Description", "clib.ctMatlab.sim1D_eval Representation of C++ function sim1D_eval."); % Modify help description values as needed.
...
%% C++ function |sim1D_setMaxJacAge| with MATLAB name |clib.ctMatlab.sim1D_setMaxJacAge|
...
sim1D_setMaxJacAgeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setMaxJacAge", ...
    "Description", "clib.ctMatlab.sim1D_setMaxJacAge Representation of C++ function sim1D_setMaxJacAge."); % Modify help description values as needed.
...
%% C++ function |sim1D_setFixedTemperature| with MATLAB name |clib.ctMatlab.sim1D_setFixedTemperature|
...
sim1D_setFixedTemperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.sim1D_setFixedTemperature", ...
    "Description", "clib.ctMatlab.sim1D_setFixedTemperature Representation of C++ function sim1D_setFixedTemperature."); % Modify help description values as needed.
...
%% C++ function |reactor_new| with MATLAB name |clib.ctMatlab.reactor_new|
...
reactor_newDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_new", ...
    "Description", "clib.ctMatlab.reactor_new Representation of C++ function reactor_new."); % Modify help description values as needed.
...
%% C++ function |reactor_del| with MATLAB name |clib.ctMatlab.reactor_del|
% C++ Signature: int reactor_del(int i)

reactor_delDefinition = addFunction(libDef, ...
    "int reactor_del(int i)", ...
    "MATLABName", "clib.ctMatlab.reactor_del", ...
    "Description", "clib.ctMatlab.reactor_del Representation of C++ function reactor_del."); % Modify help description values as needed.
...
%% C++ function |reactor_type| with MATLAB name |clib.ctMatlab.reactor_type|
...
%    "MATLABName", "clib.ctMatlab.reactor_type", ...
%    "Description", "clib.ctMatlab.reactor_type Representation of C++ function reactor_type."); % Modify help description values as needed.
%defineArgument(reactor_typeDefinition, "i", "int32");
%defineArgument(reactor_typeDefinition, "len", "int32");
%defineArgument(reactor_typeDefinition, "nbuf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(reactor_typeDefinition, "RetVal", "int32");
%validate(reactor_typeDefinition);

%% C++ function |reactor_name| with MATLAB name |clib.ctMatlab.reactor_name|
...
%    "MATLABName", "clib.ctMatlab.reactor_name", ...
%    "Description", "clib.ctMatlab.reactor_name Representation of C++ function reactor_name."); % Modify help description values as needed.
%defineArgument(reactor_nameDefinition, "i", "int32");
%defineArgument(reactor_nameDefinition, "len", "int32");
%defineArgument(reactor_nameDefinition, "nbuf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(reactor_nameDefinition, "RetVal", "int32");
%validate(reactor_nameDefinition);

%% C++ function |reactor_setName| with MATLAB name |clib.ctMatlab.reactor_setName|
...
reactor_setNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_setName", ...
    "Description", "clib.ctMatlab.reactor_setName Representation of C++ function reactor_setName."); % Modify help description values as needed.
...
%% C++ function |reactor_setInitialVolume| with MATLAB name |clib.ctMatlab.reactor_setInitialVolume|
...
reactor_setInitialVolumeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_setInitialVolume", ...
    "Description", "clib.ctMatlab.reactor_setInitialVolume Representation of C++ function reactor_setInitialVolume."); % Modify help description values as needed.
...
%% C++ function |reactor_setChemistry| with MATLAB name |clib.ctMatlab.reactor_setChemistry|
...
reactor_setChemistryDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_setChemistry", ...
    "Description", "clib.ctMatlab.reactor_setChemistry Representation of C++ function reactor_setChemistry."); % Modify help description values as needed.
...
%% C++ function |reactor_setEnergy| with MATLAB name |clib.ctMatlab.reactor_setEnergy|
...
reactor_setEnergyDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_setEnergy", ...
    "Description", "clib.ctMatlab.reactor_setEnergy Representation of C++ function reactor_setEnergy."); % Modify help description values as needed.
...
%% C++ function |reactor_mass| with MATLAB name |clib.ctMatlab.reactor_mass|
% C++ Signature: double reactor_mass(int i)

reactor_massDefinition = addFunction(libDef, ...
    "double reactor_mass(int i)", ...
    "MATLABName", "clib.ctMatlab.reactor_mass", ...
    "Description", "clib.ctMatlab.reactor_mass Representation of C++ function reactor_mass."); % Modify help description values as needed.
...
%% C++ function |reactor_volume| with MATLAB name |clib.ctMatlab.reactor_volume|
% C++ Signature: double reactor_volume(int i)

reactor_volumeDefinition = addFunction(libDef, ...
    "double reactor_volume(int i)", ...
    "MATLABName", "clib.ctMatlab.reactor_volume", ...
    "Description", "clib.ctMatlab.reactor_volume Representation of C++ function reactor_volume."); % Modify help description values as needed.
...
%% C++ function |reactor_density| with MATLAB name |clib.ctMatlab.reactor_density|
% C++ Signature: double reactor_density(int i)

reactor_densityDefinition = addFunction(libDef, ...
    "double reactor_density(int i)", ...
    "MATLABName", "clib.ctMatlab.reactor_density", ...
    "Description", "clib.ctMatlab.reactor_density Representation of C++ function reactor_density."); % Modify help description values as needed.
...
%% C++ function |reactor_temperature| with MATLAB name |clib.ctMatlab.reactor_temperature|
...
reactor_temperatureDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_temperature", ...
    "Description", "clib.ctMatlab.reactor_temperature Representation of C++ function reactor_temperature."); % Modify help description values as needed.
...
%% C++ function |reactor_enthalpy_mass| with MATLAB name |clib.ctMatlab.reactor_enthalpy_mass|
...
reactor_enthalpy_massDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_enthalpy_mass", ...
    "Description", "clib.ctMatlab.reactor_enthalpy_mass Representation of C++ function reactor_enthalpy_mass."); % Modify help description values as needed.
...
%% C++ function |reactor_intEnergy_mass| with MATLAB name |clib.ctMatlab.reactor_intEnergy_mass|
...
reactor_intEnergy_massDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_intEnergy_mass", ...
    "Description", "clib.ctMatlab.reactor_intEnergy_mass Representation of C++ function reactor_intEnergy_mass."); % Modify help description values as needed.
...
%% C++ function |reactor_pressure| with MATLAB name |clib.ctMatlab.reactor_pressure|
% C++ Signature: double reactor_pressure(int i)

reactor_pressureDefinition = addFunction(libDef, ...
    "double reactor_pressure(int i)", ...
    "MATLABName", "clib.ctMatlab.reactor_pressure", ...
    "Description", "clib.ctMatlab.reactor_pressure Representation of C++ function reactor_pressure."); % Modify help description values as needed.
...
%% C++ function |reactor_massFraction| with MATLAB name |clib.ctMatlab.reactor_massFraction|
...
reactor_massFractionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_massFraction", ...
    "Description", "clib.ctMatlab.reactor_massFraction Representation of C++ function reactor_massFraction."); % Modify help description values as needed.
...
%% C++ function |reactor_nSensParams| with MATLAB name |clib.ctMatlab.reactor_nSensParams|
...
reactor_nSensParamsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_nSensParams", ...
    "Description", "clib.ctMatlab.reactor_nSensParams Representation of C++ function reactor_nSensParams."); % Modify help description values as needed.
...
%% C++ function |reactor_addSensitivityReaction| with MATLAB name |clib.ctMatlab.reactor_addSensitivityReaction|
...
reactor_addSensitivityReactionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_addSensitivityReaction", ...
    "Description", "clib.ctMatlab.reactor_addSensitivityReaction Representation of C++ function reactor_addSensitivityReaction."); % Modify help description values as needed.
...
%% C++ function |reactor_setMassFlowRate| with MATLAB name |clib.ctMatlab.reactor_setMassFlowRate|
...
reactor_setMassFlowRateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactor_setMassFlowRate", ...
    "Description", "clib.ctMatlab.reactor_setMassFlowRate Representation of C++ function reactor_setMassFlowRate."); % Modify help description values as needed.
...
%% C++ function |reactornet_new| with MATLAB name |clib.ctMatlab.reactornet_new|
% C++ Signature: int reactornet_new()

reactornet_newDefinition = addFunction(libDef, ...
    "int reactornet_new()", ...
    "MATLABName", "clib.ctMatlab.reactornet_new", ...
    "Description", "clib.ctMatlab.reactornet_new Representation of C++ function reactornet_new."); % Modify help description values as needed.
defineOutput(reactornet_newDefinition, "RetVal", "int32");
validate(reactornet_newDefinition);

%% C++ function |reactornet_del| with MATLAB name |clib.ctMatlab.reactornet_del|
% C++ Signature: int reactornet_del(int i)

reactornet_delDefinition = addFunction(libDef, ...
    "int reactornet_del(int i)", ...
    "MATLABName", "clib.ctMatlab.reactornet_del", ...
    "Description", "clib.ctMatlab.reactornet_del Representation of C++ function reactornet_del."); % Modify help description values as needed.
...
%% C++ function |reactornet_setInitialTime| with MATLAB name |clib.ctMatlab.reactornet_setInitialTime|
...
reactornet_setInitialTimeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_setInitialTime", ...
    "Description", "clib.ctMatlab.reactornet_setInitialTime Representation of C++ function reactornet_setInitialTime."); % Modify help description values as needed.
...
%% C++ function |reactornet_setMaxTimeStep| with MATLAB name |clib.ctMatlab.reactornet_setMaxTimeStep|
...
reactornet_setMaxTimeStepDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_setMaxTimeStep", ...
    "Description", "clib.ctMatlab.reactornet_setMaxTimeStep Representation of C++ function reactornet_setMaxTimeStep."); % Modify help description values as needed.
...
%% C++ function |reactornet_setTolerances| with MATLAB name |clib.ctMatlab.reactornet_setTolerances|
...
reactornet_setTolerancesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_setTolerances", ...
    "Description", "clib.ctMatlab.reactornet_setTolerances Representation of C++ function reactornet_setTolerances."); % Modify help description values as needed.
...
%% C++ function |reactornet_setSensitivityTolerances| with MATLAB name |clib.ctMatlab.reactornet_setSensitivityTolerances|
...
reactornet_setSensitivityTolerancesDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_setSensitivityTolerances", ...
    "Description", "clib.ctMatlab.reactornet_setSensitivityTolerances Representation of C++ function reactornet_setSensitivityTolerances."); % Modify help description values as needed.
...
%% C++ function |reactornet_addreactor| with MATLAB name |clib.ctMatlab.reactornet_addreactor|
...
reactornet_addreactorDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_addreactor", ...
    "Description", "clib.ctMatlab.reactornet_addreactor Representation of C++ function reactornet_addreactor."); % Modify help description values as needed.
...
%% C++ function |reactornet_advance| with MATLAB name |clib.ctMatlab.reactornet_advance|
...
reactornet_advanceDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_advance", ...
    "Description", "clib.ctMatlab.reactornet_advance Representation of C++ function reactornet_advance."); % Modify help description values as needed.
...
%% C++ function |reactornet_step| with MATLAB name |clib.ctMatlab.reactornet_step|
% C++ Signature: double reactornet_step(int i)

reactornet_stepDefinition = addFunction(libDef, ...
    "double reactornet_step(int i)", ...
    "MATLABName", "clib.ctMatlab.reactornet_step", ...
    "Description", "clib.ctMatlab.reactornet_step Representation of C++ function reactornet_step."); % Modify help description values as needed.
...
%% C++ function |reactornet_time| with MATLAB name |clib.ctMatlab.reactornet_time|
% C++ Signature: double reactornet_time(int i)

reactornet_timeDefinition = addFunction(libDef, ...
    "double reactornet_time(int i)", ...
    "MATLABName", "clib.ctMatlab.reactornet_time", ...
    "Description", "clib.ctMatlab.reactornet_time Representation of C++ function reactornet_time."); % Modify help description values as needed.
...
%% C++ function |reactornet_rtol| with MATLAB name |clib.ctMatlab.reactornet_rtol|
% C++ Signature: double reactornet_rtol(int i)

reactornet_rtolDefinition = addFunction(libDef, ...
    "double reactornet_rtol(int i)", ...
    "MATLABName", "clib.ctMatlab.reactornet_rtol", ...
    "Description", "clib.ctMatlab.reactornet_rtol Representation of C++ function reactornet_rtol."); % Modify help description values as needed.
...
%% C++ function |reactornet_atol| with MATLAB name |clib.ctMatlab.reactornet_atol|
% C++ Signature: double reactornet_atol(int i)

reactornet_atolDefinition = addFunction(libDef, ...
    "double reactornet_atol(int i)", ...
    "MATLABName", "clib.ctMatlab.reactornet_atol", ...
    "Description", "clib.ctMatlab.reactornet_atol Representation of C++ function reactornet_atol."); % Modify help description values as needed.
...
%% C++ function |reactornet_sensitivity| with MATLAB name |clib.ctMatlab.reactornet_sensitivity|
...
reactornet_sensitivityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactornet_sensitivity", ...
    "Description", "clib.ctMatlab.reactornet_sensitivity Representation of C++ function reactornet_sensitivity."); % Modify help description values as needed.
...
%% C++ function |connector_new| with MATLAB name |clib.ctMatlab.connector_new|
...
connector_newDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.connector_new", ...
    "Description", "clib.ctMatlab.connector_new Representation of C++ function connector_new."); % Modify help description values as needed.
...
%% C++ function |connector_del| with MATLAB name |clib.ctMatlab.connector_del|
% C++ Signature: int connector_del(int i)

connector_delDefinition = addFunction(libDef, ...
    "int connector_del(int i)", ...
    "MATLABName", "clib.ctMatlab.connector_del", ...
    "Description", "clib.ctMatlab.connector_del Representation of C++ function connector_del."); % Modify help description values as needed.
...
%% C++ function |connector_type| with MATLAB name |clib.ctMatlab.connector_type|
...
%    "MATLABName", "clib.ctMatlab.connector_type", ...
%    "Description", "clib.ctMatlab.connector_type Representation of C++ function connector_type."); % Modify help description values as needed.
%defineArgument(connector_typeDefinition, "i", "int32");
%defineArgument(connector_typeDefinition, "len", "int32");
%defineArgument(connector_typeDefinition, "nbuf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(connector_typeDefinition, "RetVal", "int32");
%validate(connector_typeDefinition);

%% C++ function |connector_name| with MATLAB name |clib.ctMatlab.connector_name|
...
%    "MATLABName", "clib.ctMatlab.connector_name", ...
%    "Description", "clib.ctMatlab.connector_name Representation of C++ function connector_name."); % Modify help description values as needed.
%defineArgument(connector_nameDefinition, "i", "int32");
%defineArgument(connector_nameDefinition, "len", "int32");
%defineArgument(connector_nameDefinition, "nbuf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(connector_nameDefinition, "RetVal", "int32");
%validate(connector_nameDefinition);

%% C++ function |connector_setName| with MATLAB name |clib.ctMatlab.connector_setName|
...
connector_setNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.connector_setName", ...
    "Description", "clib.ctMatlab.connector_setName Representation of C++ function connector_setName."); % Modify help description values as needed.
...
%% C++ function |flowdev_setPrimary| with MATLAB name |clib.ctMatlab.flowdev_setPrimary|
...
flowdev_setPrimaryDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setPrimary", ...
    "Description", "clib.ctMatlab.flowdev_setPrimary Representation of C++ function flowdev_setPrimary."); % Modify help description values as needed.
...
%% C++ function |flowdev_massFlowRate| with MATLAB name |clib.ctMatlab.flowdev_massFlowRate|
...
flowdev_massFlowRateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_massFlowRate", ...
    "Description", "clib.ctMatlab.flowdev_massFlowRate Representation of C++ function flowdev_massFlowRate."); % Modify help description values as needed.
...
%% C++ function |flowdev_setMassFlowCoeff| with MATLAB name |clib.ctMatlab.flowdev_setMassFlowCoeff|
...
flowdev_setMassFlowCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setMassFlowCoeff", ...
    "Description", "clib.ctMatlab.flowdev_setMassFlowCoeff Representation of C++ function flowdev_setMassFlowCoeff."); % Modify help description values as needed.
...
%% C++ function |flowdev_setValveCoeff| with MATLAB name |clib.ctMatlab.flowdev_setValveCoeff|
...
flowdev_setValveCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setValveCoeff", ...
    "Description", "clib.ctMatlab.flowdev_setValveCoeff Representation of C++ function flowdev_setValveCoeff."); % Modify help description values as needed.
...
%% C++ function |flowdev_setPressureCoeff| with MATLAB name |clib.ctMatlab.flowdev_setPressureCoeff|
...
flowdev_setPressureCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setPressureCoeff", ...
    "Description", "clib.ctMatlab.flowdev_setPressureCoeff Representation of C++ function flowdev_setPressureCoeff."); % Modify help description values as needed.
...
%% C++ function |flowdev_setPressureFunction| with MATLAB name |clib.ctMatlab.flowdev_setPressureFunction|
...
flowdev_setPressureFunctionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setPressureFunction", ...
    "Description", "clib.ctMatlab.flowdev_setPressureFunction Representation of C++ function flowdev_setPressureFunction."); % Modify help description values as needed.
...
%% C++ function |flowdev_setTimeFunction| with MATLAB name |clib.ctMatlab.flowdev_setTimeFunction|
...
flowdev_setTimeFunctionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.flowdev_setTimeFunction", ...
    "Description", "clib.ctMatlab.flowdev_setTimeFunction Representation of C++ function flowdev_setTimeFunction."); % Modify help description values as needed.
...
%% C++ function |wall_expansionRate| with MATLAB name |clib.ctMatlab.wall_expansionRate|
...
wall_expansionRateDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_expansionRate", ...
    "Description", "clib.ctMatlab.wall_expansionRate Representation of C++ function wall_expansionRate."); % Modify help description values as needed.
...
%% C++ function |wall_heatRate| with MATLAB name |clib.ctMatlab.wall_heatRate|
% C++ Signature: double wall_heatRate(int i)

wall_heatRateDefinition = addFunction(libDef, ...
    "double wall_heatRate(int i)", ...
    "MATLABName", "clib.ctMatlab.wall_heatRate", ...
    "Description", "clib.ctMatlab.wall_heatRate Representation of C++ function wall_heatRate."); % Modify help description values as needed.
...
%% C++ function |wall_area| with MATLAB name |clib.ctMatlab.wall_area|
% C++ Signature: double wall_area(int i)

wall_areaDefinition = addFunction(libDef, ...
    "double wall_area(int i)", ...
    "MATLABName", "clib.ctMatlab.wall_area", ...
    "Description", "clib.ctMatlab.wall_area Representation of C++ function wall_area."); % Modify help description values as needed.
defineArgument(wall_areaDefinition, "i", "int32");
defineOutput(wall_areaDefinition, "RetVal", "double");
validate(wall_areaDefinition);

%% C++ function |wall_setArea| with MATLAB name |clib.ctMatlab.wall_setArea|
% C++ Signature: int wall_setArea(int i,double v)

wall_setAreaDefinition = addFunction(libDef, ...
    "int wall_setArea(int i,double v)", ...
    "MATLABName", "clib.ctMatlab.wall_setArea", ...
    "Description", "clib.ctMatlab.wall_setArea Representation of C++ function wall_setArea."); % Modify help description values as needed.
...
%% C++ function |wall_setThermalResistance| with MATLAB name |clib.ctMatlab.wall_setThermalResistance|
...
wall_setThermalResistanceDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setThermalResistance", ...
    "Description", "clib.ctMatlab.wall_setThermalResistance Representation of C++ function wall_setThermalResistance."); % Modify help description values as needed.
...
%% C++ function |wall_setHeatTransferCoeff| with MATLAB name |clib.ctMatlab.wall_setHeatTransferCoeff|
...
wall_setHeatTransferCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setHeatTransferCoeff", ...
    "Description", "clib.ctMatlab.wall_setHeatTransferCoeff Representation of C++ function wall_setHeatTransferCoeff."); % Modify help description values as needed.
...
%% C++ function |wall_setHeatFlux| with MATLAB name |clib.ctMatlab.wall_setHeatFlux|
...
wall_setHeatFluxDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setHeatFlux", ...
    "Description", "clib.ctMatlab.wall_setHeatFlux Representation of C++ function wall_setHeatFlux."); % Modify help description values as needed.
...
%% C++ function |wall_setExpansionRateCoeff| with MATLAB name |clib.ctMatlab.wall_setExpansionRateCoeff|
...
wall_setExpansionRateCoeffDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setExpansionRateCoeff", ...
    "Description", "clib.ctMatlab.wall_setExpansionRateCoeff Representation of C++ function wall_setExpansionRateCoeff."); % Modify help description values as needed.
...
%% C++ function |wall_setVelocity| with MATLAB name |clib.ctMatlab.wall_setVelocity|
...
wall_setVelocityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setVelocity", ...
    "Description", "clib.ctMatlab.wall_setVelocity Representation of C++ function wall_setVelocity."); % Modify help description values as needed.
...
%% C++ function |wall_setEmissivity| with MATLAB name |clib.ctMatlab.wall_setEmissivity|
...
wall_setEmissivityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.wall_setEmissivity", ...
    "Description", "clib.ctMatlab.wall_setEmissivity Representation of C++ function wall_setEmissivity."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_new| with MATLAB name |clib.ctMatlab.reactorsurface_new|
...
reactorsurface_newDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_new", ...
    "Description", "clib.ctMatlab.reactorsurface_new Representation of C++ function reactorsurface_new."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_del| with MATLAB name |clib.ctMatlab.reactorsurface_del|
% C++ Signature: int reactorsurface_del(int i)

reactorsurface_delDefinition = addFunction(libDef, ...
    "int reactorsurface_del(int i)", ...
    "MATLABName", "clib.ctMatlab.reactorsurface_del", ...
    "Description", "clib.ctMatlab.reactorsurface_del Representation of C++ function reactorsurface_del."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_name| with MATLAB name |clib.ctMatlab.reactorsurface_name|
...
%    "MATLABName", "clib.ctMatlab.reactorsurface_name", ...
%    "Description", "clib.ctMatlab.reactorsurface_name Representation of C++ function reactorsurface_name."); % Modify help description values as needed.
%defineArgument(reactorsurface_nameDefinition, "i", "int32");
%defineArgument(reactorsurface_nameDefinition, "len", "int32");
%defineArgument(reactorsurface_nameDefinition, "nbuf", "clib.array.ctMatlab.Char", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Char","int8","string", or "char"
%defineOutput(reactorsurface_nameDefinition, "RetVal", "int32");
%validate(reactorsurface_nameDefinition);

%% C++ function |reactorsurface_setName| with MATLAB name |clib.ctMatlab.reactorsurface_setName|
...
reactorsurface_setNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_setName", ...
    "Description", "clib.ctMatlab.reactorsurface_setName Representation of C++ function reactorsurface_setName."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_install| with MATLAB name |clib.ctMatlab.reactorsurface_install|
...
reactorsurface_installDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_install", ...
    "Description", "clib.ctMatlab.reactorsurface_install Representation of C++ function reactorsurface_install."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_setkinetics| with MATLAB name |clib.ctMatlab.reactorsurface_setkinetics|
...
reactorsurface_setkineticsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_setkinetics", ...
    "Description", "clib.ctMatlab.reactorsurface_setkinetics Representation of C++ function reactorsurface_setkinetics."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_area| with MATLAB name |clib.ctMatlab.reactorsurface_area|
...
reactorsurface_areaDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_area", ...
    "Description", "clib.ctMatlab.reactorsurface_area Representation of C++ function reactorsurface_area."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_setArea| with MATLAB name |clib.ctMatlab.reactorsurface_setArea|
...
reactorsurface_setAreaDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_setArea", ...
    "Description", "clib.ctMatlab.reactorsurface_setArea Representation of C++ function reactorsurface_setArea."); % Modify help description values as needed.
...
%% C++ function |reactorsurface_addSensitivityReaction| with MATLAB name |clib.ctMatlab.reactorsurface_addSensitivityReaction|
...
reactorsurface_addSensitivityReactionDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.reactorsurface_addSensitivityReaction", ...
    "Description", "clib.ctMatlab.reactorsurface_addSensitivityReaction Representation of C++ function reactorsurface_addSensitivityReaction."); % Modify help description values as needed.
...
%% C++ function |ct_clearReactors| with MATLAB name |clib.ctMatlab.ct_clearReactors|
% C++ Signature: int ct_clearReactors()

ct_clearReactorsDefinition = addFunction(libDef, ...
    "int ct_clearReactors()", ...
    "MATLABName", "clib.ctMatlab.ct_clearReactors", ...
    "Description", "clib.ctMatlab.ct_clearReactors Representation of C++ function ct_clearReactors."); % Modify help description values as needed.
defineOutput(ct_clearReactorsDefinition, "RetVal", "int32");
validate(ct_clearReactorsDefinition);

%% C++ function |rdiag_new| with MATLAB name |clib.ctMatlab.rdiag_new|
% C++ Signature: int rdiag_new()

rdiag_newDefinition = addFunction(libDef, ...
    "int rdiag_new()", ...
    "MATLABName", "clib.ctMatlab.rdiag_new", ...
    "Description", "clib.ctMatlab.rdiag_new Representation of C++ function rdiag_new."); % Modify help description values as needed.
defineOutput(rdiag_newDefinition, "RetVal", "int32");
validate(rdiag_newDefinition);

%% C++ function |rdiag_del| with MATLAB name |clib.ctMatlab.rdiag_del|
% C++ Signature: int rdiag_del(int i)

rdiag_delDefinition = addFunction(libDef, ...
    "int rdiag_del(int i)", ...
    "MATLABName", "clib.ctMatlab.rdiag_del", ...
    "Description", "clib.ctMatlab.rdiag_del Representation of C++ function rdiag_del."); % Modify help description values as needed.
defineArgument(rdiag_delDefinition, "i", "int32");
defineOutput(rdiag_delDefinition, "RetVal", "int32");
validate(rdiag_delDefinition);

%% C++ function |rdiag_detailed| with MATLAB name |clib.ctMatlab.rdiag_detailed|
% C++ Signature: int rdiag_detailed(int i)

rdiag_detailedDefinition = addFunction(libDef, ...
    "int rdiag_detailed(int i)", ...
    "MATLABName", "clib.ctMatlab.rdiag_detailed", ...
    "Description", "clib.ctMatlab.rdiag_detailed Representation of C++ function rdiag_detailed."); % Modify help description values as needed.
...
%% C++ function |rdiag_brief| with MATLAB name |clib.ctMatlab.rdiag_brief|
% C++ Signature: int rdiag_brief(int i)

rdiag_briefDefinition = addFunction(libDef, ...
    "int rdiag_brief(int i)", ...
    "MATLABName", "clib.ctMatlab.rdiag_brief", ...
    "Description", "clib.ctMatlab.rdiag_brief Representation of C++ function rdiag_brief."); % Modify help description values as needed.
...
%% C++ function |rdiag_setThreshold| with MATLAB name |clib.ctMatlab.rdiag_setThreshold|
...
rdiag_setThresholdDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setThreshold", ...
    "Description", "clib.ctMatlab.rdiag_setThreshold Representation of C++ function rdiag_setThreshold."); % Modify help description values as needed.
...
%% C++ function |rdiag_setBoldColor| with MATLAB name |clib.ctMatlab.rdiag_setBoldColor|
...
rdiag_setBoldColorDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setBoldColor", ...
    "Description", "clib.ctMatlab.rdiag_setBoldColor Representation of C++ function rdiag_setBoldColor."); % Modify help description values as needed.
...
%% C++ function |rdiag_setNormalColor| with MATLAB name |clib.ctMatlab.rdiag_setNormalColor|
...
rdiag_setNormalColorDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setNormalColor", ...
    "Description", "clib.ctMatlab.rdiag_setNormalColor Representation of C++ function rdiag_setNormalColor."); % Modify help description values as needed.
...
%% C++ function |rdiag_setDashedColor| with MATLAB name |clib.ctMatlab.rdiag_setDashedColor|
...
rdiag_setDashedColorDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setDashedColor", ...
    "Description", "clib.ctMatlab.rdiag_setDashedColor Representation of C++ function rdiag_setDashedColor."); % Modify help description values as needed.
...
%% C++ function |rdiag_setDotOptions| with MATLAB name |clib.ctMatlab.rdiag_setDotOptions|
...
rdiag_setDotOptionsDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setDotOptions", ...
    "Description", "clib.ctMatlab.rdiag_setDotOptions Representation of C++ function rdiag_setDotOptions."); % Modify help description values as needed.
...
%% C++ function |rdiag_setBoldThreshold| with MATLAB name |clib.ctMatlab.rdiag_setBoldThreshold|
...
rdiag_setBoldThresholdDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setBoldThreshold", ...
    "Description", "clib.ctMatlab.rdiag_setBoldThreshold Representation of C++ function rdiag_setBoldThreshold."); % Modify help description values as needed.
...
%% C++ function |rdiag_setNormalThreshold| with MATLAB name |clib.ctMatlab.rdiag_setNormalThreshold|
...
rdiag_setNormalThresholdDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setNormalThreshold", ...
    "Description", "clib.ctMatlab.rdiag_setNormalThreshold Representation of C++ function rdiag_setNormalThreshold."); % Modify help description values as needed.
...
%% C++ function |rdiag_setLabelThreshold| with MATLAB name |clib.ctMatlab.rdiag_setLabelThreshold|
...
rdiag_setLabelThresholdDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setLabelThreshold", ...
    "Description", "clib.ctMatlab.rdiag_setLabelThreshold Representation of C++ function rdiag_setLabelThreshold."); % Modify help description values as needed.
...
%% C++ function |rdiag_setScale| with MATLAB name |clib.ctMatlab.rdiag_setScale|
...
rdiag_setScaleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setScale", ...
    "Description", "clib.ctMatlab.rdiag_setScale Representation of C++ function rdiag_setScale."); % Modify help description values as needed.
...
%% C++ function |rdiag_setFlowType| with MATLAB name |clib.ctMatlab.rdiag_setFlowType|
...
rdiag_setFlowTypeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setFlowType", ...
    "Description", "clib.ctMatlab.rdiag_setFlowType Representation of C++ function rdiag_setFlowType."); % Modify help description values as needed.
...
%% C++ function |rdiag_setArrowWidth| with MATLAB name |clib.ctMatlab.rdiag_setArrowWidth|
...
rdiag_setArrowWidthDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setArrowWidth", ...
    "Description", "clib.ctMatlab.rdiag_setArrowWidth Representation of C++ function rdiag_setArrowWidth."); % Modify help description values as needed.
...
%% C++ function |rdiag_setTitle| with MATLAB name |clib.ctMatlab.rdiag_setTitle|
...
rdiag_setTitleDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setTitle", ...
    "Description", "clib.ctMatlab.rdiag_setTitle Representation of C++ function rdiag_setTitle."); % Modify help description values as needed.
...
%% C++ function |rdiag_write| with MATLAB name |clib.ctMatlab.rdiag_write|
...
rdiag_writeDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_write", ...
    "Description", "clib.ctMatlab.rdiag_write Representation of C++ function rdiag_write."); % Modify help description values as needed.
...
%% C++ function |rdiag_add| with MATLAB name |clib.ctMatlab.rdiag_add|
% C++ Signature: int rdiag_add(int i,int n)

rdiag_addDefinition = addFunction(libDef, ...
    "int rdiag_add(int i,int n)", ...
    "MATLABName", "clib.ctMatlab.rdiag_add", ...
    "Description", "clib.ctMatlab.rdiag_add Representation of C++ function rdiag_add."); % Modify help description values as needed.
...
%% C++ function |rdiag_findMajor| with MATLAB name |clib.ctMatlab.rdiag_findMajor|
...
%    "MATLABName", "clib.ctMatlab.rdiag_findMajor", ...
%    "Description", "clib.ctMatlab.rdiag_findMajor Representation of C++ function rdiag_findMajor."); % Modify help description values as needed.
...
%defineArgument(rdiag_findMajorDefinition, "a", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(rdiag_findMajorDefinition, "RetVal", "int32");
%validate(rdiag_findMajorDefinition);

%% C++ function |rdiag_setFont| with MATLAB name |clib.ctMatlab.rdiag_setFont|
...
rdiag_setFontDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_setFont", ...
    "Description", "clib.ctMatlab.rdiag_setFont Representation of C++ function rdiag_setFont."); % Modify help description values as needed.
...
%% C++ function |rdiag_displayOnly| with MATLAB name |clib.ctMatlab.rdiag_displayOnly|
...
rdiag_displayOnlyDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rdiag_displayOnly", ...
    "Description", "clib.ctMatlab.rdiag_displayOnly Representation of C++ function rdiag_displayOnly."); % Modify help description values as needed.
...
%% C++ function |rbuild_new| with MATLAB name |clib.ctMatlab.rbuild_new|
% C++ Signature: int rbuild_new()

rbuild_newDefinition = addFunction(libDef, ...
    "int rbuild_new()", ...
    "MATLABName", "clib.ctMatlab.rbuild_new", ...
    "Description", "clib.ctMatlab.rbuild_new Representation of C++ function rbuild_new."); % Modify help description values as needed.
defineOutput(rbuild_newDefinition, "RetVal", "int32");
validate(rbuild_newDefinition);

%% C++ function |rbuild_del| with MATLAB name |clib.ctMatlab.rbuild_del|
% C++ Signature: int rbuild_del(int i)

rbuild_delDefinition = addFunction(libDef, ...
    "int rbuild_del(int i)", ...
    "MATLABName", "clib.ctMatlab.rbuild_del", ...
    "Description", "clib.ctMatlab.rbuild_del Representation of C++ function rbuild_del."); % Modify help description values as needed.
defineArgument(rbuild_delDefinition, "i", "int32");
defineOutput(rbuild_delDefinition, "RetVal", "int32");
validate(rbuild_delDefinition);

%% C++ function |rbuild_init| with MATLAB name |clib.ctMatlab.rbuild_init|
...
rbuild_initDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rbuild_init", ...
    "Description", "clib.ctMatlab.rbuild_init Representation of C++ function rbuild_init."); % Modify help description values as needed.
...
%% C++ function |rbuild_build| with MATLAB name |clib.ctMatlab.rbuild_build|
...
rbuild_buildDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.rbuild_build", ...
    "Description", "clib.ctMatlab.rbuild_build Representation of C++ function rbuild_build."); % Modify help description values as needed.
...
%% C++ function |ct_clearReactionPath| with MATLAB name |clib.ctMatlab.ct_clearReactionPath|
% C++ Signature: int ct_clearReactionPath()

ct_clearReactionPathDefinition = addFunction(libDef, ...
    "int ct_clearReactionPath()", ...
    "MATLABName", "clib.ctMatlab.ct_clearReactionPath", ...
    "Description", "clib.ctMatlab.ct_clearReactionPath Representation of C++ function ct_clearReactionPath."); % Modify help description values as needed.
defineOutput(ct_clearReactionPathDefinition, "RetVal", "int32");
validate(ct_clearReactionPathDefinition);

%% C++ function |surf_setCoverages| with MATLAB name |clib.ctMatlab.surf_setCoverages|
...
%    "MATLABName", "clib.ctMatlab.surf_setCoverages", ...
%    "Description", "clib.ctMatlab.surf_setCoverages Representation of C++ function surf_setCoverages."); % Modify help description values as needed.
%defineArgument(surf_setCoveragesDefinition, "i", "int32");
%defineArgument(surf_setCoveragesDefinition, "c", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
...
%% C++ function |surf_getCoverages| with MATLAB name |clib.ctMatlab.surf_getCoverages|
...
%    "MATLABName", "clib.ctMatlab.surf_getCoverages", ...
%    "Description", "clib.ctMatlab.surf_getCoverages Representation of C++ function surf_getCoverages."); % Modify help description values as needed.
%defineArgument(surf_getCoveragesDefinition, "i", "int32");
%defineArgument(surf_getCoveragesDefinition, "c", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(surf_getCoveragesDefinition, "RetVal", "int32");
%validate(surf_getCoveragesDefinition);

%% C++ function |surf_setConcentrations| with MATLAB name |clib.ctMatlab.surf_setConcentrations|
...
%    "MATLABName", "clib.ctMatlab.surf_setConcentrations", ...
%    "Description", "clib.ctMatlab.surf_setConcentrations Representation of C++ function surf_setConcentrations."); % Modify help description values as needed.
%defineArgument(surf_setConcentrationsDefinition, "i", "int32");
%defineArgument(surf_setConcentrationsDefinition, "c", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(surf_setConcentrationsDefinition, "RetVal", "int32");
%validate(surf_setConcentrationsDefinition);

%% C++ function |surf_getConcentrations| with MATLAB name |clib.ctMatlab.surf_getConcentrations|
...
%    "MATLABName", "clib.ctMatlab.surf_getConcentrations", ...
%    "Description", "clib.ctMatlab.surf_getConcentrations Representation of C++ function surf_getConcentrations."); % Modify help description values as needed.
%defineArgument(surf_getConcentrationsDefinition, "i", "int32");
%defineArgument(surf_getConcentrationsDefinition, "c", "clib.array.ctMatlab.Double", "input", <SHAPE>); % <MLTYPE> can be "clib.array.ctMatlab.Double", or "double"
%defineOutput(surf_getConcentrationsDefinition, "RetVal", "int32");
%validate(surf_getConcentrationsDefinition);

%% C++ function |surf_setSiteDensity| with MATLAB name |clib.ctMatlab.surf_setSiteDensity|
...
surf_setSiteDensityDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.surf_setSiteDensity", ...
    "Description", "clib.ctMatlab.surf_setSiteDensity Representation of C++ function surf_setSiteDensity."); % Modify help description values as needed.
...
%% C++ function |surf_siteDensity| with MATLAB name |clib.ctMatlab.surf_siteDensity|
% C++ Signature: double surf_siteDensity(int i)

surf_siteDensityDefinition = addFunction(libDef, ...
    "double surf_siteDensity(int i)", ...
    "MATLABName", "clib.ctMatlab.surf_siteDensity", ...
    "Description", "clib.ctMatlab.surf_siteDensity Representation of C++ function surf_siteDensity."); % Modify help description values as needed.
...
%% C++ function |surf_setCoveragesByName| with MATLAB name |clib.ctMatlab.surf_setCoveragesByName|
...
surf_setCoveragesByNameDefinition = addFunction(libDef, ...
    ...
    "MATLABName", "clib.ctMatlab.surf_setCoveragesByName", ...
    "Description", "clib.ctMatlab.surf_setCoveragesByName Representation of C++ function surf_setCoveragesByName."); % Modify help description values as needed.
