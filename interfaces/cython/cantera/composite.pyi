from typing import Any, Literal, Never, Sequence, Unpack, overload, override
...
from cantera.thermo import InterfacePhase, Species, ThermoPhase, ThermoType
...
class SolutionArray(SolutionArrayBase):
    ...
    def __getitem__(self, index: Index) -> SolutionArray: ...
    def __call__(self, *species: str) -> SolutionArray: ...
    @property
    def ndim(self) -> int: ...
    @property
