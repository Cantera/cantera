...
class Quantity:
    ...
    @property
    def partial_molar_int_energies_TV(self) -> Array: ...
    @property
    ...
    @property
    def partial_molar_cv_TV(self) -> Array: ...
    @property
    ...
    @property
    def electron_mobility(self) -> float: ...
    def set_electron_energy_distribution_parameters(self, params: dict[str, Any]) -> None: ...
    @property
...
class SolutionArray(SolutionArrayBase, Generic[_P]):
    ...
    @property
    def internal_pressure(self) -> Array: ...
    @property
