...
class SolutionArray(SolutionArrayBase, Generic[P]):
    _phase: P
    def __init__(
        self,
        phase: P,
    ...
    def __getitem__(self, index: Index) -> SolutionArray[P]: ...
    def __call__(self, *species: str) -> SolutionArray[P]: ...
    @property
    def ndim(self) -> int: ...
    @property
    ...
    def Te(self) -> Array: ...
    @Te.setter
    def Te(self, value: ArrayLike) -> None: ...
    @property
    ...
    def Y(self) -> Array: ...
    @Y.setter
    def Y(self, Y: ArrayCompositionLike) -> None: ...
    @property
    def X(self) -> Array: ...
    @X.setter
    def X(self, X: ArrayCompositionLike) -> None: ...
    @property
    def concentrations(self) -> Array: ...
    @property
    def partial_molar_enthalpies(self) -> Array: ...
    ...
    def modify_reaction(self: SolutionArray[Kinetics], irxn: int, rxn: Reaction) -> None: ...
    def multiplier(self: SolutionArray[Kinetics], i_reaction: int) -> float: ...
    def set_multiplier(self: SolutionArray[Kinetics], value: float, i_reaction: int = -1) -> None: ...
    def reaction_equations(self: SolutionArray[Kinetics], indices: Sequence[int] | None = None) -> list[str]: ...
    def reactant_stoich_coeff(
    ...
    @coverages.setter
    def coverages(
        self: SolutionArray[Interface], theta: ArrayCompositionLike
    ) -> None: ...
    ...
    @Q.setter
    def Q(self: SolutionArray[PureFluid], Q: Array) -> None: ...
