...
class FlameBase(Sim1D):
    ...
    def set_radiation_models(self, property_model: str, solver_model: str = ...) -> None: ...
    def set_radlib_options(
        self, fvsoot: float | None = ..., ngray: int | None = ...,
        Tref: float | None = ..., Pref: float | None = ...
    ) -> None: ...
    @property
    def radlib_options(self) -> dict[str, float | int]: ...
    @property
    def grid(self) -> Array: ...
    @property
    def P(self) -> float: ...
