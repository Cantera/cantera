...
cdef class _SolutionBase:
    ...
    def update_user_header(self, dict data):
        ...
        """
        self.base.input().update(dict_to_anymap(data), False)
    ...
    def write_yaml(self, filename, phases=None, units=None, precision=None,
        ...
        :param header:
            ...
            note that ``generator``, ``cantera-version``, ``git-commit`` and ``date``
            will be replaced.
        """
        Y = YamlWriter()
        if header:
