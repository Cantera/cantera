...
class Parser:
    ...
    def read_NASA9_entry(self, entry: list[str], comments: list[str]) -> tuple[str, Nasa9, dict[str, float]]: ...
    def read_kinetics_entry(self, entry: list[str], surface: bool) -> tuple[Reaction, Reaction | None]: ...
