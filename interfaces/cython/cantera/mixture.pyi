...
class Mixture:
    ...
    def n_atoms(self, k: int, m: int) -> int: ...
    @property
    def n_phases(self) -> int: ...
    def phase(self, n: int) -> ThermoPhase: ...
    def phase_index(self, p: str) -> int: ...
    @property
    ...
    def phase_charge(self, p: str) -> float: ...
    def phase_moles(self, p: str | None = None) -> list[float] | float: ...
    def set_phase_moles(self, p: str, moles: float) -> None: ...
    @property
