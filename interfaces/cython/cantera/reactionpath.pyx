...
cdef class ReactionPathDiagram:
    ...
    property show_details:
        ...
        def __set__(self, pybool value) -> None:
    ...
    property threshold:
        ...
        def __set__(self, double value) -> None:
    ...
    property bold_color:
        ...
        def __set__(self, str value) -> None:
    ...
    property flow_type:
        ...
        def __get__(self) -> Literal["NetFlow", "OneWayFlow"]:
    ...
    def add(self, ReactionPathDiagram other) -> None:
        """ Add fluxes from `other` to this diagram """
        self.diagram.add(other._diagram)

    def display_only(self, int k) -> None:
        """
