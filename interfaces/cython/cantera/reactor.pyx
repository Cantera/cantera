...
cdef class DelegatedReactor(Reactor):
    ...
    delegatable_methods = {'initialize', 'sync_state', 'get_state',
        'update_state', 'update_surface_state', 'get_surface_initial_conditions',
    ...
    def __init__(self, *args, **kwargs):
        ...
        if 'get_surface_initial_conditions' in delegates:
            self.delegator.setGetSurfaceInitialConditions(
                pyOverride(<PyObject*>delegates['get_surface_initial_conditions'][1], callback_v_dp),
                stringify(delegates['get_surface_initial_conditions'][0])
            )
