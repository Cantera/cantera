...
class ElectronCollisionPlasmaRate(ReactionRate):
    ...
    def _from_parameters(self, energy_levels: ArrayLike, cross_sections: ArrayLike) -> None: ...
    @property
...
class FalloffRate(ReactionRate):
    ...
    def __call__(self, temperature: float, concm: float) -> float: ...
    @property
...
class PlogRate(ReactionRate):
    def __init__(
        self,
        rates: list[tuple[float, Arrhenius]] | None = None,
        input_data: PlogRateInput | None = None,
        init: bool = True,
    ) -> None: ...
    def __call__(self, temperature: float, pressure: float) -> float: ...
    @property
    def rates(self) -> list[tuple[float, Arrhenius]]: ...
    @rates.setter
    def rates(self, data: Iterable[tuple[float, Arrhenius]]) -> None: ...
...
class InterfaceRateBase(ArrheniusRateBase):
    def __call__(self, temperature: float, coverages: Array) -> float: ...
    @property
