...
class Sim1D:
    ...
    @property
    def solver_stats(self) -> dict[str, list[float]]: ...
    @property
    def grid_size_stats(self) -> list[int]: ...  # deprecated
    @property
    def jacobian_time_stats(self) -> list[float]: ...  # deprecated
    @property
    def jacobian_count_stats(self) -> list[int]: ...  # deprecated
    @property
    def eval_time_stats(self) -> list[float]: ...  # deprecated
    @property
    def eval_count_stats(self) -> list[int]: ...  # deprecated
    @property
    def time_step_stats(self) -> list[int]: ...  # deprecated
