...
class ThermoPhase(_SolutionBase):
    ...
    @overload
    def species(self, k: None) -> list[Species]: ...
    @overload
...
class PureFluid(ThermoPhase):
    ...
    @TQ.setter
    def TQ(self, values: Sequence[float]) -> None: ...
    @property
    def PQ(self) -> tuple[float, float]: ...
    @PQ.setter
    def PQ(self, values: Sequence[float]) -> None: ...
    @property
    def ST(self) -> tuple[float, float]: ...
    @ST.setter
    def ST(self, values: Sequence[float]) -> None: ...
    @property
    def TV(self) -> tuple[float, float]: ...
    @TV.setter
    def TV(self, values: Sequence[float]) -> None: ...
    @property
    def PV(self) -> tuple[float, float]: ...
    @PV.setter
    def PV(self, values: Sequence[float]) -> None: ...
    @property
    def UP(self) -> tuple[float, float]: ...
    @UP.setter
    def UP(self, values: Sequence[float]) -> None: ...
    @property
    def VH(self) -> tuple[float, float]: ...
    @VH.setter
    def VH(self, values: Sequence[float]) -> None: ...
    @property
    def TH(self) -> tuple[float, float]: ...
    @TH.setter
    def TH(self, values: Sequence[float]) -> None: ...
    @property
    def SH(self) -> tuple[float, float]: ...
    @SH.setter
    def SH(self, values: Sequence[float]) -> None: ...
    @property
    def TDQ(self) -> tuple[float, float, float]: ...
    @property
    def TPQ(self) -> tuple[float, float, float]: ...
    @TPQ.setter
    def TPQ(self, values: Sequence[float]) -> None: ...
    @property
