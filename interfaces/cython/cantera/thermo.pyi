...
class PureFluid(ThermoPhase):
    ...
    @TQ.setter
    def TQ(self, values: tuple[float, float]) -> None: ...
    @property
    def PQ(self) -> tuple[float, float]: ...
    @PQ.setter
    def PQ(self, values: tuple[float, float]) -> None: ...
    @property
    def ST(self) -> tuple[float, float]: ...
    @ST.setter
    def ST(self, values: tuple[float, float]) -> None: ...
    @property
    def TV(self) -> tuple[float, float]: ...
    @TV.setter
    def TV(self, values: tuple[float, float]) -> None: ...
    @property
    def PV(self) -> tuple[float, float]: ...
    @PV.setter
    def PV(self, values: tuple[float, float]) -> None: ...
    @property
    def UP(self) -> tuple[float, float]: ...
    @UP.setter
    def UP(self, values: tuple[float, float]) -> None: ...
    @property
    def VH(self) -> tuple[float, float]: ...
    @VH.setter
    def VH(self, values: tuple[float, float]) -> None: ...
    @property
    def TH(self) -> tuple[float, float]: ...
    @TH.setter
    def TH(self, values: tuple[float, float]) -> None: ...
    @property
    def SH(self) -> tuple[float, float]: ...
    @SH.setter
    def SH(self, values: tuple[float, float]) -> None: ...
    @property
    def TDQ(self) -> tuple[float, float, float]: ...
    @property
    def TPQ(self) -> tuple[float, float, float]: ...
    @TPQ.setter
    def TPQ(self, values: tuple[float, float, float]) -> None: ...
    @property
...
class Element:
    ...
    def __init__(self, arg: str | bytes | int) -> None: ...
    @property
    def name(self) -> str: ...
    @property
