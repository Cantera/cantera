...
class ReactorBase:
    ...
    def get_state_dae(self) -> tuple[Array, Array]: ...
    @property
    def atol(self) -> Array | None: ...
    @atol.setter
    def atol(self, values: ArrayLike | None) -> None: ...
...
class ExtensibleReactor(Reactor):
    ...
    surface_production_rates: Array
...
class FlowReactorSurface(ReactorSurface):
    ...
    def initial_max_steps(self, max_steps: int) -> None: ...
    @property
    def initial_max_error_failures(self) -> int: ...
    @initial_max_error_failures.setter
    def initial_max_error_failures(self, n: int) -> None: ...
