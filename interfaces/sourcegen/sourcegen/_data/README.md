...
The *sourcegen* utility implements logic to automatically detect types CLib functions
...
- `destructor`: A CLib destructor removes a C++ object from CLib. Constructor names
