 ...
 *      Header file for an ideal semiconductor model
 *
...
#ifndef CT_SEMICONDUCTOR_H
#define CT_SEMICONDUCTOR_H
...
namespace Cantera {
   ...
   */
  //@{
  const int cSemiconductorPhase = 6010;
  //@}
  ...
  public:
    ...
    /**
     * Constructor for SemiconductorPhase.
     ...
     *               is a value of 0.
     */
    SemiconductorPhase(int formCG=0);
     ...
     *               is a value of 0.
     */
    SemiconductorPhase(XML_Node& root, std::string id="");

    /*!
     * Copy Constructor
     */
    SemiconductorPhase(const SemiconductorPhase &);

    /*!
     * Assignment operator
     */
    SemiconductorPhase& operator=(const SemiconductorPhase &);
     ...
     * related to the chemical potential (quasi-Fermi level) by 
     * \f[
     *  \mu_k(T,P,X_k) = \mu_k^0(T,P)
     * + \hat R T \log a_k.
     *  \f] 
     * The quantity \f$\mu_k^0(T,P)\f$ is
     * the standard state chemical potential at unit activity, also known as "ec" for
     * electrons and "ev" for holes.
     *
     ...
     *
     *  For EOS types other than cSemiconductorPhase0, the default
     *  kmol/m3 holds for standard concentration units. For
     *  cSemiconductorPhase0 type, the standard concentrtion is
     *  unitless.
     */
    ...
    /**
     * Initialization of an SemiconductorPhase phase using an
     * xml file 
     *
    ...
    /**
     *   Import and initialize an SemiconductorPhase phase 
    ...
    /**
     *  Initialization of an SemiconductorPhase phase:
