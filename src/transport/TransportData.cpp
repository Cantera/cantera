        ...
        double quadrupole_polarizability_, double acentric)
{
    ...
    dispersion = 1e-50 * dispersion_;// convert from Angstroms^5 to m^5 unit:[m^5/e^2]
    quadrupole_polarizability = 1e-50 * quadrupole_polarizability_;// convert from Angstroms^5 to m^5
}
