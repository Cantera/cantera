...
>>>>>>> 6a88472a9... Moved setToEquil function to the parent class, 'MixtureFugacityTP".
=======
//! @file RedlichKwongMFTP.cpp
...
int RedlichKwongMFTP::CubicCall(double T, double pres, double a, double b, double Vroot[3]) const
{
    ...
    int nSolnValues = solveCubic(T, pres, a, b, a, Vroot, an, bn, cn, dn, tc, pc);
    
    return nSolnValues;
}

}
>>>>>>> a933404b7... Removing dependancy of EoS specific omega_a, omega_b parameters from solveCubic
=======
//! @file RedlichKwongMFTP.cpp
