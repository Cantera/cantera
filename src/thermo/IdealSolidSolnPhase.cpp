...
void IdealSolidSolnPhase::setDensity(const double rho)
{
...
void IdealSolidSolnPhase::setMolarDensity(const double n)
{
...
void IdealSolidSolnPhase::setToEquilState(const double* lambda_RT)
{
