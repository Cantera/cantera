...
class TestFreeFlame:
    ...
    def test_adjoint_sensitivities2(self):
        ...
        adjoint_sensitivities = self.flame.get_species_reaction_sensitivities(species, distance)
        reaction_equations = self.gas.reaction_equations()
        adjoint_sens = [(reaction, sensitivity) for reaction, sensitivity in zip(reaction_equations, adjoint_sensitivities)]
