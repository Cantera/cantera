...
{
    double omega = 2.;
    int fcn = func1_newBasic("cos", omega);
    ASSERT_GE(fcn, 0);
...
{
    double omega = 2.;
    int fcn = func1_newBasic("exp", omega);
    ASSERT_GE(fcn, 0);
...
{
    double omega = 2.;
    int fcn = func1_newBasic("log", omega);
    ASSERT_GE(fcn, 0);
...
{
    double exp = .5;
    int fcn = func1_newBasic("pow", exp);
    ASSERT_GE(fcn, 0);
...
{
    double a = .5;
    int fcn = func1_newBasic("constant", a);
    ASSERT_GE(fcn, 0);
...
TEST(ctfunc, tabulated_linear)
{
    ...
    int fcn = func1_newAdvanced("tabulated-linear", params.size(), params.data());
    ASSERT_GE(fcn, 0);
...
TEST(ctfunc, tabulated_previous)
{
    ...
    int fcn = func1_newAdvanced("tabulated-previous", params.size(), params.data());
    ASSERT_GE(fcn, 0);
...
TEST(ctfunc, poly)
{
    ...
    int fcn = func1_newAdvanced("polynomial3", params.size(), params.data());
    ASSERT_GE(fcn, 0);
...
TEST(ctfunc, Fourier)
{
    ...
    int fcn = func1_newAdvanced("Fourier", params.size(), params.data());
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(
...
TEST(ctfunc, Gaussian)
{
    ...
    int fcn = func1_newAdvanced("Gaussian", params.size(), params.data());
    ASSERT_GE(fcn, 0);
...
TEST(ctfunc, Arrhenius)
{
    ...
    int fcn = func1_newAdvanced("Arrhenius", params.size(), params.data());
    ASSERT_GE(fcn, 0);
...
{
    // exceptions return -1
    int fcn0 = func1_newBasic("sin", 1.);
    int fcn1 = func1_newBasic("cos", 1.);
...
{
    double omega = 2.;
    int fcn0 = func1_newBasic("sin", omega);
    int fcn1 = func1_newBasic("cos", omega);
    int fcn = func1_newCompound("sum", fcn0, fcn1);
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), sin(omega * 0.5) + cos(omega * 0.5));
    int fcn2 = func1_newSumFunction(fcn0, fcn1);
...
TEST(ctmath, diff)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    int fcn1 = func1_newBasic("cos", omega);
    int fcn = func1_newCompound("diff", fcn0, fcn1);
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), sin(omega * 0.5) - cos(omega * 0.5));
    int fcn2 = func1_newDiffFunction(fcn0, fcn1);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), func1_eval(fcn2, 0.5));
}
...
TEST(ctmath, prod)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    int fcn1 = func1_newBasic("cos", omega);
    int fcn = func1_newCompound("product", fcn0, fcn1);
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), sin(omega * 0.5) * cos(omega * 0.5));
    int fcn2 = func1_newProdFunction(fcn0, fcn1);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), func1_eval(fcn2, 0.5));
}
...
TEST(ctmath, ratio)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    int fcn1 = func1_newBasic("cos", omega);
    int fcn = func1_newCompound("ratio", fcn0, fcn1);
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), sin(omega * 0.5) / cos(omega * 0.5));
    int fcn2 = func1_newRatioFunction(fcn0, fcn1);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), func1_eval(fcn2, 0.5));
}
...
TEST(ctmath, composite)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    int fcn1 = func1_newBasic("cos", omega);
    int fcn = func1_newCompound("composite", fcn0, fcn1);
    ASSERT_GE(fcn, 0);
...
TEST(ctmath, times_constant)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    double A = 1.234;
    int fcn = func1_newModified("times-constant", fcn0, A);
    ASSERT_GE(fcn, 0);
...
TEST(ctmath, plus_constant)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    double A = 1.234;
    int fcn = func1_newModified("plus-constant", fcn0, A);
    ASSERT_GE(fcn, 0);
    EXPECT_DOUBLE_EQ(func1_eval(fcn, 0.5), sin(omega * 0.5) + A);
}
...
TEST(ctmath, periodic)
{
    ...
    int fcn0 = func1_newBasic("sin", omega);
    double A = 1.234;
    int fcn = func1_newModified("periodic", fcn0, A);
    ASSERT_GE(fcn, 0);
...
TEST(ctmath, generic)
{
    ...
    int fs2_1 = func1_newCompound("diff", fs1, fs2);  // 1-(sin(x))^2
    ...
    int fs3 = func1_newAdvanced("Arrhenius", 3, p_arr.data());  // sqrt function
    auto func1_s3 = newFunc1("Arrhenius", p_arr);
    EXPECT_DOUBLE_EQ(func1_eval(fs3, 0.5), func1_s3->eval(0.5));

    // overall composite function
    int fs4 = func1_newCompound("composite", fs3, fs2_1);  // sqrt(1-(sin(x))^2)
