...
public:
  ...
  void check_dlnActCoeffdlnX(const double expected_result[9])
    {
      double xmin = 0.6;
      double xmax = 0.9;
      int numSteps = 9;
...
TEST_F(RedlichKister_Test, dlnActivities)
{
    ...
    const double expected_result_0[9] = {0.0907127, 0.200612, 0.229316, 0.193278, 0.142257, 0.0766133, -0.0712113, -0.309379, -0.492206};
    check_dlnActCoeffdlnX(expected_result_0);
